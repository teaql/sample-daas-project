...
<tr><td class='th'>标题</td><td >${result.title}</td><td class='th'>安全用户</td><td >${result.secUser.displayName}</td></tr><tr><td class='th'>应用程序图标</td><td >${result.appIcon}</td><td class='th'>完全访问</td><td >${result.fullAccess}</td></tr><tr><td class='th'>许可</td><td >${result.permission}</td><td class='th'>应用程序类型</td><td >${result.appType}</td></tr><tr><td class='th'>应用程序Id</td><td >${result.appId}</td><td class='th'>Ctx类型</td><td >${result.ctxType}</td></tr><tr><td class='th'>Ctx Id</td><td >${result.ctxId}</td><td class='th'>位置</td><td >${result.location}</td></tr></table>
</section>
