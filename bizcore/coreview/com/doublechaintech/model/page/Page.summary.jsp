...
<tr><td class='th'>编码</td><td >${item.code}</td><td class='th'>图标</td><td >${item.icon}</td></tr><tr><td class='th'>标题</td><td >${item.title}</td><td class='th'>顺序</td><td >${item.displayOrder}</td></tr><tr><td class='th'>短暂的</td><td >${item.brief}</td><td class='th'>图片链接</td><td >${item.imageUrl}</td></tr><tr><td class='th'>链接网址</td><td >${item.linkToUrl}</td><td class='th'>额外的数据</td><td >${item.extraData}</td></tr><tr><td class='th'>页面</td><td >${item.page.displayName}</td><td class='th'></td><td ></td></tr></table>
</section>
...
<tr><td class='th'>标题</td><td >${item.title}</td><td class='th'>短暂的</td><td >${item.brief}</td></tr><tr><td class='th'>图标</td><td >${item.icon}</td><td class='th'>顺序</td><td >${item.displayOrder}</td></tr><tr><td class='th'>视图组</td><td >${item.viewGroup}</td><td class='th'>链接网址</td><td >${item.linkToUrl}</td></tr><tr><td class='th'>页面</td><td >${item.page.displayName}</td><td class='th'></td><td ></td></tr></table>
</section>
