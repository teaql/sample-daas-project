package com.doublechaintech.model.services;
...
import com.doublechaintech.model.iamservice.BaseIamService;
...
public class IamService extends BaseIamService{
    ...
    public String getKPToken(ModelUserContext userContext){
        String kpid = userContext.getRequestHeader("kpid");
        if (kpid == null) {
            return null;
        }
    ...
    private String getKPTokenById(ModelUserContext userContext, String pKpid) {
        try {
    ...
    public void checkKPToken(ModelUserContext userContext)  {
        String kpid = userContext.getRequestHeader("kpid");
        if (kpid == null) {
            return;
        }
    ...
    public KeyPairIdentity loadKeyPairIdentity(ModelUserContext userContext, String pKpid, Map<String, Object> options) throws Exception {
