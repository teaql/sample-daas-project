...
import com.doublechaintech.model.userapp.*;
import com.doublechaintech.model.listaccess.*;
...
import com.doublechaintech.model.search.Q;
...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements
   ...
   public void setBlockChainAdvancer(BlockChainAdvancer pBlockChainAdvancer){
    ...
    public String confirmSession(ModelUserContext userContext){
    ...
    public Object resetPassword(ModelUserContext userContext, String mobile, int verifycationCode, String newPassword) {
    ...
    public Object resetPasswordWithoutLogin(ModelUserContext userContext, String loginType, String loginKey, int verifycationCode, String newPassword) {
        SecUser user;
        try {
    ...
    public SecUser manage(ModelUserContext userContext) throws Exception{
        SecUser user = cachedUser(userContext);
    ...
    protected SecUser cachedUser(ModelUserContext userContext)
    {
        return (SecUser)userContext.getCachedObject(this.getUserKey(userContext), SecUser.class);
    }

    public SecUser getCachedSecUser(ModelUserContext userContext) {
    ...
    public Object accessUserApp(ModelUserContext userContext,String targetUserAppId) throws Exception{
    ...
    protected Object gotoApp(ModelUserContext userContext, UserApp app) throws Exception {
    ...
    public String getVerificationCode(ModelUserContext userContext,String mobile){
    ...
    protected void sendVerificationCode(ModelUserContext userContext, String mobile,String code) throws Exception{
    ...
    protected int getRandomVerificationCode(ModelUserContext userContex, int length){
    ...
    protected String getBeanName(ModelUserContext userContext, UserApp app){
    ...
    protected String getTargetObjectId(ModelUserContext userContext, UserApp app){

        return  app.getAppId();

    }
    protected String getServiceType(ModelUserContext userContext, UserApp app){

        return app.getAppType();
    }
    protected String getMethodName(ModelUserContext userContext, UserApp app){
    ...
    public Object home(ModelUserContext userContext) {
    ...
    public Object loginWithEmail(ModelUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"email",email, password);

    }
    public Object login(ModelUserContext userContext, String email,
            Password password) {
    ...
    public Object loginWithLogin(ModelUserContext userContext, String email,
            Password password) {

        return loginInternal(userContext,"login",email, password);

    }
    public Object loginWithMobile(ModelUserContext userContext, String email,
            Password password) {
        return loginInternal(userContext,"mobile",email, password);

    }
    protected SecUser loadUserWith(ModelUserContext userContext, String type, String userId)
    throws Exception {
    ...
    protected Object loginInternal(ModelUserContext userContext, String type, String userId,
            Password password) {
     ...
     */
    protected Object loginTheSecUserInternal(ModelUserContext userContext, SecUser user, String loginComments) throws Exception {
		...
		IamService iamService = (IamService) userContext.getBean("iamService");
		iamService.onLoginSecUserInternalSuccess((ModelUserContextImpl) userContext, user);
    ...
    public Object showlogin(ModelUserContext userContext) {
    ...
    protected LoginForm showSessionExpired(ModelUserContext userContext) {
    ...
    public BaseUserContext loadUserConext(HttpServletRequest request)
        ...
        ModelUserContextImpl uc = createNewConext(path);
        init(uc, request);
        return uc;
    }
    ...
    protected ModelObjectChecker checker;
    ...
    protected void init(UserContextImpl userContext, HttpServletRequest request) {
        ...
        userContext.setChecker((ModelObjectChecker)beanFactory.getBean(getCheckerBeanName()));
        ...
        try {
          handleFormResubmit((ModelUserContextImpl)userContext, request);
        } catch (Exception e) {
          e.printStackTrace();
        }
    }
    ...
    protected ModelUserContextImpl createNewConext(String path) {
        return new CustomModelUserContextImpl();
    }

    protected void handleFormResubmit(ModelUserContextImpl ctx, HttpServletRequest request) throws Exception {
        ...
        if (existedPostMd5 != null && existedPostMd5.equals(md5)) {
            ...
            ctx.putIntoContextLocalStorage(ModelBaseConstants.KEY_RE_SUBMIT, true);
            return;
        }
    ...
    public static String getPostMd5Key(ModelUserContextImpl ctx) {
        return ctx.tokenId()+":postMd5Key";
    }

    protected String calcPostBodyMd5(ModelUserContextImpl ctx, HttpServletRequest request, byte[] bytes) throws Exception {
        try {
    ...
    public Object checkOtherLogin(ModelUserContext userContext) throws Exception {
	...
	protected void checkUserHasManagementAccess(ModelUserContext userContext, String appType, String appId)
	...
	public UserApp updateAppPermission(ModelUserContext userContext, String secUserId, String userAppId, int version,
	...
	public UserApp updateListAccess(ModelUserContext userContext, String secUserId, String userAppId, String displayName,
	...
	public UserApp loadUserAppWithUser(ModelUserContext userContext, String secUserId, String appType,
    ...
    public Object changeCurUserPassword(ModelUserContext userContext, String currentPassword, String newPassword)
			throws Exception {
	...
	public String testIfHasManagementAccess(ModelUserContext userContext,String appType,String appId) {
		try {
			this.checkUserHasManagementAccess(userContext, appType, appId);
			return "OK";
		}catch(Exception e){
    ...
    public Map<String, Object> testoss(ModelUserContext userContext) throws SecUserManagerException {
