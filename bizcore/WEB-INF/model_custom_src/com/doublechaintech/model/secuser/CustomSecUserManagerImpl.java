...
public class CustomSecUserManagerImpl extends SecUserManagerImpl implements UserContextProvider {
  ...
  public Object resetPassword(
      ModelUserContext userContext, String mobile, int verifycationCode, String newPassword) {
  ...
  public Object accessUserApp(ModelUserContext userContext, String targetUserAppId)
      throws Exception {
  ...
  protected void sendVerificationCode(ModelUserContext userContext, String mobile, String code)
      throws Exception {
  ...
  public Object loginWithEmail(ModelUserContext userContext, String email, Password password) {

    return loginInternal(userContext, "email", email, password);
  }

  public Object login(ModelUserContext userContext, String email, Password password) {
  ...
  public Object loginWithLogin(ModelUserContext userContext, String email, Password password) {

    return loginInternal(userContext, "login", email, password);
  }

  public Object loginWithMobile(ModelUserContext userContext, String email, Password password) {
  ...
  protected Object loginInternal(
      ModelUserContext userContext, String type, String userId, Password password) {
  ...
  protected Object loginTheSecUserInternal(
      ModelUserContext userContext, SecUser user, String loginComments) throws Exception {
  ...
  protected void handleFormResubmit(ModelUserContextImpl ctx, HttpServletRequest request)
      throws Exception {
  ...
  protected String calcPostBodyMd5(
      ModelUserContextImpl ctx, HttpServletRequest request, byte[] bytes) throws Exception {
    try {
  ...
  protected void checkUserHasManagementAccess(
      ModelUserContext userContext, String appType, String appId) throws SecUserManagerException {
  ...
  public Object changeCurUserPassword(
      ModelUserContext userContext, String currentPassword, String newPassword) throws Exception {
  ...
  public String testIfHasManagementAccess(
      ModelUserContext userContext, String appType, String appId) {
    try {
      this.checkUserHasManagementAccess(userContext, appType, appId);
      return "OK";
    } catch (Exception e) {
