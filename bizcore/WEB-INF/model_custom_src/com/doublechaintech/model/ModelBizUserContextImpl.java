...
import com.doublechaintech.model.community.CommunityJDBCTemplateDAO;

public class ModelBizUserContextImpl extends ModelUserContextImpl {
  ...
  public String getPostMd5Key(ModelBizUserContextImpl ctx) {
  ...
  public CommunityJDBCTemplateDAO dao() {
    return (CommunityJDBCTemplateDAO) this.getDAOGroup().getCommunityDAO();
  }
  ...
  public void sendMessage(
    ...
    if (!isProductEnvironment()) {
      ...
      sendEmail(
          ...
          getEnvironmentName() + " MODEL: 模拟短信发送 to " + dest,
  ...
  protected String getExceptionMonitorEmails() {
    return "env:MODEL_EXCEPTION_MONITOR";
  }
  ...
  public <T extends BaseEntity> List<T> enhanceUpStream(Object data, Class<T> clazz)
    ...
    if (data instanceof SmartList) {
      List list = ModelBaseUtils.collectReferencedObjectWithType(this, (SmartList) data, clazz);
      this.getDAOGroup().enhanceList(list, clazz);
      return list;
    }
    if (data instanceof List) {
      List list = ModelBaseUtils.collectReferencedObjectWithType(this, (List) data, clazz);
      this.getDAOGroup().enhanceList(list, clazz);
      return list;
    }
    if (data instanceof BaseEntity) {
      List<T> list = ModelBaseUtils.collectReferencedObjectWithType(this, (BaseEntity) data, clazz);
      this.getDAOGroup().enhanceList(list, clazz);
      return list;
    }
