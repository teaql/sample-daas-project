...
import static com.doublechaintech.model.pagetype.PageType.*;

public class PageTypeRequest extends BaseRequest<PageType> {
    public static PageTypeRequest newInstance() {
        return new PageTypeRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public PageTypeRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public PageTypeRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NAME_PROPERTY,CODE_PROPERTY,MOBILE_APP_PROPERTY,FOOTER_TAB_PROPERTY,VERSION_PROPERTY};
