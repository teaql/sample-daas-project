...
return getId();
	...
	public PageType updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public PageType updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getCode();
	...
	public PageType updateCode(String code){String oldCode = this.code;String newCode = trimString(code);if(!shouldReplaceBy(newCode, oldCode)){return this;}this.code = newCode;if (cn.hutool.core.util.ObjectUtil.equals(newCode, oldCode)){
        return this;
...
return getMobileApp();
	...
	public PageType updateMobileApp(MobileApp mobileApp){MobileApp oldMobileApp = this.mobileApp;MobileApp newMobileApp = mobileApp;if(!shouldReplaceBy(newMobileApp, oldMobileApp)){return this;}this.mobileApp = newMobileApp;if (cn.hutool.core.util.ObjectUtil.equals(newMobileApp, oldMobileApp)){
        return this;
...
return this;
  ...
  public  PageType updateMobileAppByReferenceId(String mobileAppId){ updateMobileApp(MobileApp.refById(mobileAppId)); return this;}
...
return getFooterTab();
	...
	public PageType updateFooterTab(boolean footerTab){boolean oldFooterTab = this.footerTab;boolean newFooterTab = footerTab;if(!shouldReplaceBy(newFooterTab, oldFooterTab)){return this;}this.footerTab = newFooterTab;if (cn.hutool.core.util.ObjectUtil.equals(newFooterTab, oldFooterTab)){
        return this;
      }addPropertyChange(FOOTER_TAB_PROPERTY, oldFooterTab, newFooterTab);this.changed = true;setChecked(false);return this;}
...
return getVersion();
	...
	public PageType updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
