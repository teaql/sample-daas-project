...
public class PageTypeManagerImpl extends CustomModelCheckerManager implements PageTypeManager, BusinessHandler{
	...
	@Override
	public PageTypeDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageTypeManagerException{
 	...
 	protected PageType savePageType(ModelUserContext userContext, PageType pageType, String [] tokensExpr) throws Exception{
 	...
 	protected PageType savePageTypeDetail(ModelUserContext userContext, PageType pageType) throws Exception{


 		return savePageType(userContext, pageType, allTokens());
 	}

 	public PageType loadPageType(ModelUserContext userContext, String pageTypeId, String [] tokensExpr) throws Exception{
 	 ...
 	 public PageType searchPageType(ModelUserContext userContext, String pageTypeId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected PageType present(ModelUserContext userContext, PageType pageType, Map<String, Object> tokens) throws Exception {
 	...
 	public PageType loadPageTypeDetail(ModelUserContext userContext, String pageTypeId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String pageTypeId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String pageTypeId) throws Exception{
		PageType pageType = loadPageType( userContext, pageTypeId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String pageTypeId) throws Exception{
		PageType pageType = loadPageType( userContext, pageTypeId, analyzeTokens());
		markVisited(userContext, pageType);
		return present(userContext,pageType, analyzeTokens());

	}
 	protected PageType savePageType(ModelUserContext userContext, PageType pageType, Map<String,Object>tokens) throws Exception{
    ...
    if (pageType.getId() == null) {
 	...
 	protected PageType loadPageType(ModelUserContext userContext, String pageTypeId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfPageType(pageTypeId);
	...
	public PageType loadPageTypeWithCode(ModelUserContext userContext, String code, Map<String,Object>tokens) throws Exception{
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, PageType pageType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, PageType pageType, Map<String, Object> tokens){
  ...
  @Override
  public List<PageType> searchPageTypeList(ModelUserContext ctx, PageTypeRequest pRequest){
  ...
  @Override
  public PageType searchPageType(ModelUserContext ctx, PageTypeRequest pRequest){
    pRequest.limit(0, 1);
	...
	public PageType createPageType(ModelUserContext userContext, String name,String code,String mobileAppId,boolean footerTab) throws Exception
	{
	...
	protected void checkParamsForUpdatingPageType(ModelUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PageType clone(ModelUserContext userContext, String fromPageTypeId) throws Exception{

		return pageTypeDaoOf(userContext).clone(fromPageTypeId, this.allTokens());
	}

	public PageType internalSavePageType(ModelUserContext userContext, PageType pageType) throws Exception
	{
		return internalSavePageType(userContext, pageType, allTokens());

	}
	public PageType internalSavePageType(ModelUserContext userContext, PageType pageType, Map<String,Object> options) throws Exception
	{
	...
	public PageType updatePageType(ModelUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageType(userContext, pageTypeId, pageTypeVersion, property, newValueExpr, tokensExpr);
	...
	public PageType updatePageTypeProperty(ModelUserContext userContext,String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPageType(userContext, pageTypeId, pageTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherMobileApp(ModelUserContext userContext, String pageTypeId, String anotherMobileAppId) throws Exception
 	{
 	...
 	public PageType transferToAnotherMobileApp(ModelUserContext userContext, String pageTypeId, String anotherMobileAppId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public PageType forgetByAll(ModelUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, pageTypeId, pageTypeVersion);
	}
	protected PageType forgetByAllInternal(ModelUserContext userContext,
	...
	public void onNewInstanceCreated(ModelUserContext userContext, PageType newCreated) throws Exception{
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<PageType> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String pageTypeId) throws Exception{
