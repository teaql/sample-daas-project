...
public class PageTypeManagerImpl extends CustomModelCheckerManager
  ...
  protected PageType savePageType(
      ModelUserContext userContext, PageType pageType, String[] tokensExpr) throws Exception {
  ...
  protected PageType savePageTypeDetail(ModelUserContext userContext, PageType pageType)
      throws Exception {
  ...
  public PageType searchPageType(
      ModelUserContext userContext, String pageTypeId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected PageType present(
      ModelUserContext userContext, PageType pageType, Map<String, Object> tokens)
      throws Exception {
  ...
  public PageType loadPageTypeDetail(ModelUserContext userContext, String pageTypeId)
      throws Exception {
  ...
  protected PageType loadPageType(
      ModelUserContext userContext, String pageTypeId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfPageType(pageTypeId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // PageType pageType, Map<String, Object> tokens){
  ...
  public PageType internalSavePageType(
      ModelUserContext userContext, PageType pageType, Map<String, Object> options)
      throws Exception {
  ...
  public PageType forgetByAll(ModelUserContext userContext, String pageTypeId, int pageTypeVersion)
      throws Exception {
    return forgetByAllInternal(userContext, pageTypeId, pageTypeVersion);
  }

  protected PageType forgetByAllInternal(
      ModelUserContext userContext, String pageTypeId, int pageTypeVersion) throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<PageType> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
