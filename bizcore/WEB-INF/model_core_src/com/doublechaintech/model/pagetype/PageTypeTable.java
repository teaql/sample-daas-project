...
public class PageTypeTable{
	...
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_CODE,COLUMN_MOBILE_APP,COLUMN_FOOTER_TAB};
	  ...
	  public static void ensureTable(ModelUserContext userContext, Map<String, Object> result) throws Exception {
        ModelBaseUtils.ensureTable(userContext, result, "page_type_data", new String[][]{
                new String[]{"id","varchar(48)"," not null","ID","",""},
                new String[]{"name","varchar(40)","","名称","",""},
                new String[]{"code","varchar(40)","","编码","",""},
    ...
    public static void ensureData(ModelUserContext userContext, Map<String, Object> result) throws Exception {
        ModelBaseUtils.ensureDataByCode(userContext, result, "page_type_data", new String[][]{
