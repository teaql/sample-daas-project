...
public class PageTypeJDBCTemplateDAO extends ModelBaseDAOImpl implements PageTypeDAO{
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitPageTypeList(List<PageType> pageTypeList){
      ...
      if(pageType.isToRecover()){
		...
		return new Object[]{pageTypeCreateList,
      pageTypeUpdateList,
      pageTypeRemoveList,
      pageTypeRecoverList
    };
   ...
   savePageType(pageType);
    ...
    public SmartList<PageType> requestCandidatePageTypeForPage(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
