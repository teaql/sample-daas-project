...
public class FamilyRequest extends BaseRequest<Family> {
  ...
  public FamilyRequest addDynamicProperty(
  ...
  public FamilyRequest selectAll() {
    return this.selectId().selectName().selectCommunity().selectVersion();
  }

  public FamilyRequest selectAny() {
    return selectAll().selectKidList(Q.kid().selectSelf());
  }
  ...
  protected static final String[] ALL_SELF_FIELDS = {
    ID_PROPERTY, NAME_PROPERTY, COMMUNITY_PROPERTY, VERSION_PROPERTY
  };
  ...
  public SearchCriteria createCommunityCriteria(
      CommunityRequest community, IDRefine<Community> idRefine) {
  ...
  public FamilyRequest hasKid(KidRequest kid) {
    return hasKid(
        kid,
        $kid -> java.util.Optional.of($kid).map(Kid::getFamily).map(Family::getId).orElse(null));
  }
  ...
  public FamilyRequest hasKid(KidRequest kid, QueryOperator queryOperator, Object value) {
    return addSearchCriteria(
        new AggregationCriteria(kid, Kid.FAMILY_PROPERTY, queryOperator, value));
  }
