...
public interface FamilyManager extends BaseManager{
  ...
  Family searchFamily(ModelUserContext ctx, FamilyRequest pRequest);
	...
	public Family internalSaveFamily(ModelUserContext userContext, Family family,Map<String,Object>option) throws Exception;
	...
	public default void onUpdated(ModelUserContext userContext, Family updated, Object actor, String methodName) throws Exception {};


	/*======================================================DATA MAINTENANCE===========================================================*/


	//public  KidManager getKidManager(ModelUserContext userContext, String familyId, String name ,String [] tokensExpr)  throws Exception;

	public  Family addKid(ModelUserContext userContext, String familyId, String name , String [] tokensExpr)  throws Exception;
	public  Family removeKid(ModelUserContext userContext, String familyId, String kidId, int kidVersion,String [] tokensExpr)  throws Exception;
	public  Family updateKid(ModelUserContext userContext, String familyId, String kidId, int kidVersion, String property, String newValueExpr,String [] tokensExpr)  throws Exception;
