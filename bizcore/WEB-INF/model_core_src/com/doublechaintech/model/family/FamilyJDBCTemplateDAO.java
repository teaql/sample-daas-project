...
public class FamilyJDBCTemplateDAO extends ModelBaseDAOImpl implements FamilyDAO {
  ...
  public CommunityDAO getCommunityDAO() {
    if (this.communityDAO == null) {
      throw new IllegalStateException(
          "The communityDAO is not configured yet, please config it some where.");
    }
  ...
  public KidDAO getKidDAO() {
    if (this.kidDAO == null) {
      throw new IllegalStateException(
          "The kidDAO is not configured yet, please config it some where.");
    }
  ...
  */
  ...
  protected Family extractFamily(AccessKey accessKey, Map<String, Object> loadOptions)
      throws Exception {
    try {
  ...
  protected Family loadInternalFamily(AccessKey accessKey, Map<String, Object> loadOptions)
      throws Exception {
  ...
  public SmartList<Family> findFamilyByCommunity(String communityId, Map<String, Object> options) {
    ...
    SmartList<Family> resultList =
        queryWith(FamilyTable.COLUMN_COMMUNITY, communityId, options, getFamilyMapper());
  ...
  public SmartList<Family> findFamilyByCommunity(
    ...
    SmartList<Family> resultList =
        queryWithRange(
            FamilyTable.COLUMN_COMMUNITY, communityId, options, getFamilyMapper(), start, count);
    // analyzeFamilyByCommunity(resultList, communityId, options);
    return resultList;
  }
  ...
  protected Object[] splitFamilyList(List<Family> familyList) {
    ...
    return new Object[] {familyCreateList, familyUpdateList, familyRemoveList, familyRecoverList};
  }
  ...
  public Family planToRemoveKidList(Family family, String kidIds[], Map<String, Object> options)
    ...
    SmartList<Kid> externalKidList = getKidDAO().findKidWithKey(key, options);
  ...
  protected Family presentKidList(Family family, Map<String, Object> options) {

    SmartList<Kid> kidList = family.getKidList();
    SmartList<Kid> newList =
        presentSubList(
            family.getId(),
            kidList,
            options,
  ...
  public SmartList<Family> requestCandidateFamilyForKid(
    ...
    return findAllCandidateByFilter(
        FamilyTable.COLUMN_NAME,
        FamilyTable.COLUMN_COMMUNITY,
        filterKey,
        pageNo,
        pageSize,
        getFamilyMapper());
