...
import com.doublechaintech.model.community.CandidateCommunity;
...
public class FamilyManagerImpl extends CustomModelCheckerManager
    implements FamilyManager, BusinessHandler {
  ...
  protected Family saveFamily(ModelUserContext userContext, Family family, String[] tokensExpr)
      throws Exception {
  ...
  public Family searchFamily(
      ModelUserContext userContext, String familyId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected Family present(ModelUserContext userContext, Family family, Map<String, Object> tokens)
      throws Exception {
  ...
  protected Family saveFamily(
      ModelUserContext userContext, Family family, Map<String, Object> tokens) throws Exception {

    return familyDaoOf(userContext).save(family, tokens);
  }

  protected Family loadFamily(
      ModelUserContext userContext, String familyId, Map<String, Object> tokens) throws Exception {
    checkerOf(userContext).checkIdOfFamily(familyId);
  ...
  protected <T extends BaseEntity> void addActions(
      ModelUserContext userContext, Family family, Map<String, Object> tokens) {
    ...
    // Family family, Map<String, Object> tokens){
  ...
  public Family internalSaveFamily(
      ModelUserContext userContext, Family family, Map<String, Object> options) throws Exception {
    // checkParamsForUpdatingFamily(userContext, familyId, familyVersion, property, newValueExpr,
    // tokensExpr);
  ...
  public Family updateFamily(
    ...
    checkParamsForUpdatingFamily(
        userContext, familyId, familyVersion, property, newValueExpr, tokensExpr);
  ...
  public Family updateFamilyProperty(
      ModelUserContext userContext,
      String familyId,
      int familyVersion,
      String property,
  ...
  protected Map<String, Object> viewTokens() {
    return tokens().allTokens().sortKidListWith(Kid.ID_PROPERTY, sortDesc()).done();
  }
  ...
  protected void checkParamsForTransferingAnotherCommunity(
  ...
  public CandidateCommunity requestCandidateCommunity(
    ...
    SmartList<Community> candidateList =
        communityDaoOf(userContext)
            .requestCandidateCommunityForFamily(
  ...
  protected Community loadCommunity(
      ModelUserContext userContext, String newCommunityId, Map<String, Object> options)
      throws Exception {
  ...
  public Family forgetByAll(ModelUserContext userContext, String familyId, int familyVersion)
      throws Exception {
    return forgetByAllInternal(userContext, familyId, familyVersion);
  }

  protected Family forgetByAllInternal(
      ModelUserContext userContext, String familyId, int familyVersion) throws Exception {
  ...
  protected void checkParamsForAddingKid(
  ...
  public Family addKid(
      ModelUserContext userContext, String familyId, String name, int age, String[] tokensExpr)
      throws Exception {
    checkParamsForAddingKid(userContext, familyId, name, age, tokensExpr);

    Kid kid = createKid(userContext, name, age);
  ...
  protected void checkParamsForUpdatingKidProperties(
      ModelUserContext userContext,
      String familyId,
      String id,
      String name,
  ...
  public Family updateKidProperties(
      ModelUserContext userContext,
      String familyId,
      String id,
      String name,
      ...
      String[] tokensExpr)
      throws Exception {
    checkParamsForUpdatingKidProperties(userContext, familyId, id, name, age, tokensExpr);

    Map<String, Object> options =
        tokens()
            .allTokens()
            // .withKidListList()
            .searchKidListWith(Kid.ID_PROPERTY, tokens().is(), id)
            .done();
    ...
    beforeUpdateKidProperties(userContext, item, familyId, id, name, age, tokensExpr);
  ...
  protected void beforeUpdateKidProperties(
      ModelUserContext userContext,
      Kid item,
      String familyId,
      String id,
  ...
  protected Kid createKid(ModelUserContext userContext, String name, int age) throws Exception {
  ...
  protected void checkParamsForRemovingKidList(
      ModelUserContext userContext, String familyId, String kidIds[], String[] tokensExpr)
      throws Exception {
  ...
  protected void checkParamsForRemovingKid(
      ModelUserContext userContext,
      String familyId,
      String kidId,
      int kidVersion,
  ...
  protected void checkParamsForCopyingKid(
      ModelUserContext userContext,
      String familyId,
      String kidId,
      int kidVersion,
  ...
  public Family copyKidFrom(
    ...
    synchronized (family) {
      ...
      kidManagerOf(userContext)
          .onNewInstanceCreated(
              userContext, (Kid) family.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
      return present(userContext, family, mergedAllTokens(tokensExpr));
    }
  }
  ...
  public Family updateKid(
    ...
    checkParamsForUpdatingKid(
        userContext, familyId, kidId, kidVersion, property, newValueExpr, tokensExpr);

    Map<String, Object> loadTokens =
        this.tokens()
            .withKidList()
            .searchKidListWith(Kid.ID_PROPERTY, tokens().equals(), kidId)
            .done();
    ...
    synchronized (family) {
      ...
      beforeUpdateKid(
          userContext, kid, familyId, kidId, kidVersion, property, newValueExpr, tokensExpr);
  ...
  protected void beforeUpdateKid(
      ModelUserContext userContext,
      Kid existed,
      String familyId,
      String kidId,
  ...
  */
  ...
  public void sendAllItems(ModelUserContext ctx) throws Exception {
    familyDaoOf(ctx).loadAllAsStream().forEach(event -> sendInitEvent(ctx, event));
  }
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<Family> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<Community> communityList =
        ModelBaseUtils.collectReferencedObjectWithType(userContext, list, Community.class);
  ...
  public Object listPageByCommunity(
    ...
    SmartList<Family> list =
        familyDaoOf(userContext).findFamilyByCommunity(communityId, start, count, new HashMap<>());
    ...
    page.setLinkToUrl(
        TextUtil.encodeUrl(String.format("%s/listByCommunity/%s/", getBeanName(), communityId)));
  ...
  public Object wxappview(ModelUserContext userContext, String familyId) throws Exception {
    ...
    propList.add(
        MapUtil.put("id", "3-community")
            ...
            .put(
                "displayMode",
                "{\"brief\":\"address\",\"imageUrl\":\"\",\"name\":\"auto\",\"title\":\"name\",\"imageList\":\"\"}")
            .into_map());
