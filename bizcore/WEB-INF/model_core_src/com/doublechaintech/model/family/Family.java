...
public class Family extends BaseEntity implements java.io.Serializable {
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(COMMUNITY_PROPERTY, "community", "社区")
            .withType("community", Community.class));
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(VERSION_PROPERTY, "version", "版本").withType("version", "int"));

    memberMetaInfoList.add(
        MemberMetaInfo.referBy(KID_LIST, "family", "孩子列表").withType("kid", Kid.class));
  }
  ...
  public Family updateId(String id) {
    String oldId = this.id;
    String newId = trimString(id);
  ...
  public Family ignoreIdCriteria() {
  ...
  public Family updateName(String name) {
    String oldName = this.name;
    String newName = trimString(name);
  ...
  public Family ignoreNameCriteria() {
  ...
  public void setCommunity(Community community) {
    Community oldCommunity = this.community;
  ...
  public Family updateCommunity(Community community) {
    Community oldCommunity = this.community;
    Community newCommunity = community;
    if (!shouldReplaceBy(newCommunity, oldCommunity)) {
      return this;
    }
    this.community = newCommunity;
    if (cn.hutool.core.util.ObjectUtil.equals(newCommunity, oldCommunity)) {
      return this;
    }
    addPropertyChange(COMMUNITY_PROPERTY, oldCommunity, newCommunity);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public Family ignoreCommunityCriteria() {
    super.ignoreSearchProperty(COMMUNITY_PROPERTY);
    return this;
  }
  ...
  public Family updateCommunityByReferenceId(String communityId) {
    updateCommunity(Community.refById(communityId));
    return this;
  }
  ...
  public Family updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public Family ignoreVersionCriteria() {
  ...
  public Kid removeKid(Kid kidIndex) {
    ...
    if (index < 0) {
      String message =
          "Kid(" + kidIndex.getId() + ") with version='" + kidIndex.getVersion() + "' NOT found!";
  ...
  public Kid findTheKid(Kid kid) {
    ...
    if (index < 0) {
      String message =
          "Kid(" + kid.getId() + ") with version='" + kid.getVersion() + "' NOT found!";
      throw new IllegalStateException(message);
    }
