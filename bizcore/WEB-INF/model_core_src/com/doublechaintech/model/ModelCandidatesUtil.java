...
public class ModelCandidatesUtil extends BaseCandidatesUtil {
  ...
  protected Object wrapperCandidates(
      ModelUserContext userContext, BaseCandidateEntity<? extends BaseEntity> candidates)
      throws Exception {
  ...
  protected String getDisplayNameColumn(String typeName) {
    String displayNameColumn =
        ModelNamingServiceDAO.getDisplayNameColumnName(getJavaClassName(typeName));
    return displayNameColumn;
  }

  protected BaseCandidateEntity<? extends BaseEntity> executeQuery(
      ModelUserContext userContext, CandidateQuery query, String sql, List<Object> params)
      throws Exception {
