...
import static com.doublechaintech.model.section.Section.*;

public class SectionRequest extends BaseRequest<Section> {
    public static SectionRequest newInstance() {
        return new SectionRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public SectionRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public SectionRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,TITLE_PROPERTY,BRIEF_PROPERTY,ICON_PROPERTY,DISPLAY_ORDER_PROPERTY,VIEW_GROUP_PROPERTY,LINK_TO_URL_PROPERTY,PAGE_PROPERTY,VERSION_PROPERTY};
   ...
   public SectionRequest count(){
    ...
    public SectionRequest whereDisplayOrderIsNotNull() {
      ...
      public SectionRequest whereDisplayOrderBetween(Integer displayOrderStart, Integer displayOrderEnd) {
