...
public class SectionManagerImpl extends CustomModelCheckerManager implements SectionManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws SectionManagerException{
 	...
 	protected Section saveSection(ModelUserContext userContext, Section section, String [] tokensExpr) throws Exception{
 	...
 	protected Section saveSectionDetail(ModelUserContext userContext, Section section) throws Exception{
 	...
 	public Section loadSection(ModelUserContext userContext, String sectionId, String [] tokensExpr) throws Exception{
 	 ...
 	 public Section searchSection(ModelUserContext userContext, String sectionId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected Section present(ModelUserContext userContext, Section section, Map<String, Object> tokens) throws Exception {
 	...
 	public Section loadSectionDetail(ModelUserContext userContext, String sectionId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	protected Section saveSection(ModelUserContext userContext, Section section, Map<String,Object>tokens) throws Exception{
 	
 		return sectionDaoOf(userContext).save(section, tokens);
 	}
 	protected Section loadSection(ModelUserContext userContext, String sectionId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfSection(sectionId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Section section, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Section section, Map<String, Object> tokens){
  ...
  public Section searchSection(ModelUserContext ctx, SectionRequest pRequest){
	...
	protected void checkParamsForUpdatingSection(ModelUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Section internalSaveSection(ModelUserContext userContext, Section section, Map<String,Object> options) throws Exception
	{
	...
	public Section updateSectionProperty(ModelUserContext userContext,String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingSection(userContext, sectionId, sectionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(ModelUserContext userContext, String sectionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public Section forgetByAll(ModelUserContext userContext, String sectionId, int sectionVersion) throws Exception {
		return forgetByAllInternal(userContext, sectionId, sectionVersion);
	}
	protected Section forgetByAllInternal(ModelUserContext userContext,
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<Section> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
