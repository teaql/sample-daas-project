...
return getId();
	...
	public Section updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getTitle();
	...
	public Section updateTitle(String title){String oldTitle = this.title;String newTitle = trimString(title);if(!shouldReplaceBy(newTitle, oldTitle)){return this;}this.title = newTitle;if (cn.hutool.core.util.ObjectUtil.equals(newTitle, oldTitle)){
        return this;
...
return getBrief();
	...
	public Section updateBrief(String brief){String oldBrief = this.brief;String newBrief = trimString(brief);if(!shouldReplaceBy(newBrief, oldBrief)){return this;}this.brief = newBrief;if (cn.hutool.core.util.ObjectUtil.equals(newBrief, oldBrief)){
        return this;
...
return getIcon();
	...
	public Section updateIcon(String icon){String oldIcon = this.icon;String newIcon = trimString(encodeUrl(icon));;if(!shouldReplaceBy(newIcon, oldIcon)){return this;}this.icon = newIcon;if (cn.hutool.core.util.ObjectUtil.equals(newIcon, oldIcon)){
        return this;
...
return getDisplayOrder();
	...
	public Section updateDisplayOrder(int displayOrder){int oldDisplayOrder = this.displayOrder;int newDisplayOrder = displayOrder;if(!shouldReplaceBy(newDisplayOrder, oldDisplayOrder)){return this;}this.displayOrder = newDisplayOrder;if (cn.hutool.core.util.ObjectUtil.equals(newDisplayOrder, oldDisplayOrder)){
        return this;
...
return getViewGroup();
	...
	public Section updateViewGroup(String viewGroup){String oldViewGroup = this.viewGroup;String newViewGroup = trimString(viewGroup);if(!shouldReplaceBy(newViewGroup, oldViewGroup)){return this;}this.viewGroup = newViewGroup;if (cn.hutool.core.util.ObjectUtil.equals(newViewGroup, oldViewGroup)){
        return this;
      }addPropertyChange(VIEW_GROUP_PROPERTY, oldViewGroup, newViewGroup);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeViewGroup(String viewGroup){
		if(viewGroup != null) { updateViewGroup(viewGroup);}
	}
...
return getLinkToUrl();
	...
	public Section updateLinkToUrl(String linkToUrl){String oldLinkToUrl = this.linkToUrl;String newLinkToUrl = trimString(linkToUrl);if(!shouldReplaceBy(newLinkToUrl, oldLinkToUrl)){return this;}this.linkToUrl = newLinkToUrl;if (cn.hutool.core.util.ObjectUtil.equals(newLinkToUrl, oldLinkToUrl)){
        return this;
...
return getPage();
	...
	public Section updatePage(Page page){Page oldPage = this.page;Page newPage = page;if(!shouldReplaceBy(newPage, oldPage)){return this;}this.page = newPage;if (cn.hutool.core.util.ObjectUtil.equals(newPage, oldPage)){
        return this;
...
return this;
  ...
  public  Section updatePageByReferenceId(String pageId){ updatePage(Page.refById(pageId)); return this;}
...
return getVersion();
	...
	public Section updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
