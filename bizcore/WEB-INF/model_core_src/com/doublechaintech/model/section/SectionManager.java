...
public interface SectionManager extends BaseManager {
  ...
  public Section internalSaveSection(
      ModelUserContext userContext, Section section, Map<String, Object> option) throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, Section updated, Object actor, String methodName)
      throws Exception {};
