...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.candidatecontainer.CandidateContainer;import com.doublechaintech.model.candidateelement.CandidateElement;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class CandidateContainerManagerImpl extends CustomModelCheckerManager implements CandidateContainerManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws CandidateContainerManagerException{
 	...
 	protected CandidateContainer saveCandidateContainer(ModelUserContext userContext, CandidateContainer candidateContainer, String [] tokensExpr) throws Exception{
 	...
 	protected CandidateContainer saveCandidateContainerDetail(ModelUserContext userContext, CandidateContainer candidateContainer) throws Exception{
 	...
 	public CandidateContainer loadCandidateContainer(ModelUserContext userContext, String candidateContainerId, String [] tokensExpr) throws Exception{
 	 ...
 	 public CandidateContainer searchCandidateContainer(ModelUserContext userContext, String candidateContainerId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected CandidateContainer present(ModelUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateContainer loadCandidateContainerDetail(ModelUserContext userContext, String candidateContainerId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String candidateContainerId) throws Exception{
		CandidateContainer candidateContainer = loadCandidateContainer( userContext, candidateContainerId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String candidateContainerId) throws Exception{
 	...
 	protected CandidateContainer saveCandidateContainer(ModelUserContext userContext, CandidateContainer candidateContainer, Map<String,Object>tokens) throws Exception{
 	
 		return candidateContainerDaoOf(userContext).save(candidateContainer, tokens);
 	}
 	protected CandidateContainer loadCandidateContainer(ModelUserContext userContext, String candidateContainerId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfCandidateContainer(candidateContainerId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, CandidateContainer candidateContainer, Map<String, Object> tokens){
  ...
  @Override
  public List<CandidateContainer> searchCandidateContainerList(ModelUserContext ctx, CandidateContainerRequest pRequest){
  ...
  @Override
  public CandidateContainer searchCandidateContainer(ModelUserContext ctx, CandidateContainerRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingCandidateContainer(ModelUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateContainer clone(ModelUserContext userContext, String fromCandidateContainerId) throws Exception{
	...
	public CandidateContainer internalSaveCandidateContainer(ModelUserContext userContext, CandidateContainer candidateContainer, Map<String,Object> options) throws Exception
	{
	...
	public CandidateContainer updateCandidateContainerProperty(ModelUserContext userContext,String candidateContainerId, int candidateContainerVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateContainer(userContext, candidateContainerId, candidateContainerVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public CandidateContainer forgetByAll(ModelUserContext userContext, String candidateContainerId, int candidateContainerVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateContainerId, candidateContainerVersion);
	}
	protected CandidateContainer forgetByAllInternal(ModelUserContext userContext,
	...
	protected void checkParamsForAddingCandidateElement(ModelUserContext userContext, String candidateContainerId, String name, String type, String image,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElementProperties(ModelUserContext userContext, String candidateContainerId,String id,String name,String type,String image,String [] tokensExpr) throws Exception {
	...
	public  CandidateContainer updateCandidateElementProperties(ModelUserContext userContext, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdateCandidateElementProperties(ModelUserContext userContext, CandidateElement item, String candidateContainerId, String id,String name,String type,String image, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected CandidateElement createCandidateElement(ModelUserContext userContext, String name, String type, String image) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElementList(ModelUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElementList(ModelUserContext userContext, String candidateContainerId,
			String candidateElementIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingCandidateElement(ModelUserContext userContext, String candidateContainerId,
	...
	public  CandidateContainer removeCandidateElement(ModelUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingCandidateElement(ModelUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer copyCandidateElementFrom(ModelUserContext userContext, String candidateContainerId,
		String candidateElementId, int candidateElementVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingCandidateElement(ModelUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  CandidateContainer updateCandidateElement(ModelUserContext userContext, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	protected void beforeUpdateCandidateElement(ModelUserContext userContext, CandidateElement existed, String candidateContainerId, String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<CandidateContainer> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String candidateContainerId) throws Exception{
