...
public interface CandidateContainerManager extends BaseManager {
  ...
  public default void onUpdated(
      ModelUserContext userContext, CandidateContainer updated, Object actor, String methodName)
      throws Exception {};

  /*======================================================DATA MAINTENANCE===========================================================*/

  // public  CandidateElementManager getCandidateElementManager(ModelUserContext userContext, String
  // candidateContainerId, String name, String type, String image ,String [] tokensExpr)  throws
  // Exception;
