...
import com.doublechaintech.model.candidateelement.CandidateElementRequest;



import java.util.stream.Collectors;
import static com.doublechaintech.model.candidatecontainer.CandidateContainer.*;
...
public class CandidateContainerRequest extends BaseRequest<CandidateContainer> {
    public static CandidateContainerRequest newInstance() {
        return new CandidateContainerRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public CandidateContainerRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public CandidateContainerRequest selectAny() {return selectAll().selectCandidateElementList(Q.candidateElement().selectSelf());
        }
   ...
   public CandidateContainerRequest count(){
    ...
    public CandidateContainerRequest hasCandidateElement(CandidateElement... candidateElement) {
       if (isEmptyParam(candidateElement)){
          throw new IllegalArgumentException("hasCandidateElement(CandidateElement... candidateElement)参数不能为空!");
        }
        return hasCandidateElement(Q.candidateElement().select(CandidateElement.CONTAINER_PROPERTY).filterById(QueryOperator.IN, (Object[])candidateElement));
    }

    public CandidateContainerRequest hasCandidateElement(String... candidateElement) {
        return hasCandidateElement(Q.candidateElement().select(CandidateElement.CONTAINER_PROPERTY).filterById(candidateElement));
    }

    public CandidateContainerRequest hasCandidateElement(CandidateElementRequest candidateElement) {
        return hasCandidateElement(candidateElement, $candidateElement -> java.util.Optional.of($candidateElement).map(CandidateElement::getContainer).map(CandidateContainer::getId).orElse(null));
    }
    ...
    public SearchCriteria createCandidateElementCriteria(CandidateElementRequest candidateElement, IDRefine<CandidateElement> idRefine){
       return new RefinedIdInCriteria(candidateElement, ID_PROPERTY, idRefine, CandidateElement.CONTAINER_PROPERTY);
    }
  ...
  public CandidateContainerRequest aggregateCandidateElementList(CandidateElementRequest candidateElement){
  ...
  public CandidateContainerRequest countCandidateElement(String retName, CandidateElementRequest candidateElement){
    candidateElement.count();
    return statsFromCandidateElement(retName, candidateElement);
  }

  public CandidateContainerRequest statsFromCandidateElement(String retName, CandidateElementRequest candidateElement){
