...
public class CandidateContainerJDBCTemplateDAO extends ModelBaseDAOImpl implements CandidateContainerDAO{
  ...
  public Stream<CandidateContainer> loadAllAsStream() {
	...
	protected List<Object[]> prepareCandidateContainerBatchRecoverArgs(List<CandidateContainer> candidateContainerList){
	...
	protected List<Object[]> prepareCandidateContainerBatchRemoveArgs(List<CandidateContainer> candidateContainerList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitCandidateContainerList(List<CandidateContainer> candidateContainerList){
      ...
      if(candidateContainer.isToRecover()){
		...
		return new Object[]{candidateContainerCreateList,
    ...
    if(candidateContainer.isToRecover() ){
 	...
 	protected Object[] prepareCandidateContainerRemoveParameters(CandidateContainer candidateContainer){
