package com.doublechaintech.model.controller;
...
import com.doublechaintech.model.search.BaseRequest;
...
private void renderAsList(
  ...
  private Object getEnhancedProperty(Object data, String[] vpath) {
    ...
    if (data instanceof BaseEntity) {
      data = ModelBaseUtils.itemView((BaseEntity) data);
    }
  ...
  private String getCandidateProperty(
      CustomModelUserContextImpl ctx, PropertyMeta meta, String property) {
    return getCandidateProperty(ctx, meta, property, property);
  }

  private String getCandidateProperty(
      CustomModelUserContextImpl ctx, PropertyMeta meta, String property, String defaultProperty) {
    return meta.getStr(UI_CANDIDATE_ATTRIBUTE_PREFIX + property, defaultProperty);
  }

  private Object getCandidateValue(CustomModelUserContextImpl ctx, Object value, String property) {
  ...
  private List prepareCandidates(
      CustomModelUserContextImpl pCtx, EntityMeta pMeta, PropertyMeta pFieldMeta, Object pData) {
  ...
  public String defaultFormFieldType(
      CustomModelUserContextImpl pCtx, PropertyMeta pFieldMeta, Object pCurrentFieldValue) {
    if (pFieldMeta.isObj() && pFieldMeta.isConstant()) {
  ...
  public Object format(CustomModelUserContextImpl ctx, PropertyMeta meta, Object value) {
    String idProp = getCandidateProperty(ctx, meta, "id");
  ...
  public Map<String, Object> buildSelectAction(
      CustomModelUserContextImpl ctx, Object data, String action, String fieldName, Object id) {
    String[] actionDes = action.split(":");
    String title, code;
    title = actionDes[0];
    if (actionDes.length > 1) {
  ...
  public void addFormClass(CustomModelUserContextImpl ctx, Object page, Object meta, Object data) {
