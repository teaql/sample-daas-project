...
public class UserDomainManagerImpl extends CustomModelCheckerManager
  ...
  protected UserDomain saveUserDomain(
      ModelUserContext userContext, UserDomain userDomain, String[] tokensExpr) throws Exception {
  ...
  protected UserDomain saveUserDomainDetail(ModelUserContext userContext, UserDomain userDomain)
      throws Exception {
  ...
  public UserDomain loadUserDomain(
      ModelUserContext userContext, String userDomainId, String[] tokensExpr) throws Exception {
  ...
  public UserDomain searchUserDomain(
      ModelUserContext userContext, String userDomainId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected UserDomain present(
      ModelUserContext userContext, UserDomain userDomain, Map<String, Object> tokens)
      throws Exception {
  ...
  public UserDomain loadUserDomainDetail(ModelUserContext userContext, String userDomainId)
      throws Exception {
  ...
  protected UserDomain loadUserDomain(
      ModelUserContext userContext, String userDomainId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfUserDomain(userDomainId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // UserDomain userDomain, Map<String, Object> tokens){
  ...
  public UserDomain internalSaveUserDomain(ModelUserContext userContext, UserDomain userDomain)
      throws Exception {
    return internalSaveUserDomain(userContext, userDomain, allTokens());
  }

  public UserDomain internalSaveUserDomain(
      ModelUserContext userContext, UserDomain userDomain, Map<String, Object> options)
      throws Exception {
  ...
  public UserDomain forgetByAll(
      ModelUserContext userContext, String userDomainId, int userDomainVersion) throws Exception {
  ...
  protected UserAllowList createUserAllowList(
      ModelUserContext userContext, String userIdentity, String userSpecialFunctions)
      throws Exception {
  ...
  */
  ...
  protected void checkParamsForRemovingSecUserList(
      ModelUserContext userContext, String userDomainId, String secUserIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected PublicKeyType createPublicKeyType(
      ModelUserContext userContext, String keyAlg, String signAlg) throws Exception {
  ...
  */
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, UserDomain newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<UserDomain> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
