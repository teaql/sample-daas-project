...
public void transferAllRelationshipsTo(UserDomain target){
     ...
     target.addUserAllowListList(this.getUserAllowListList());target.addSecUserList(this.getSecUserList());target.addPublicKeyTypeList(this.getPublicKeyTypeList());
 }
...
return getId();
	...
	public UserDomain updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public UserDomain updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getVersion();
	...
	public UserDomain updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
