...
public abstract class UserDomainExpression<T> implements Expression<T, UserDomain> {
   ...
   public com.doublechaintech.model.userallowlist.UserAllowListSmartListExpression<T> getUserAllowListList() {
   ...
   public com.doublechaintech.model.publickeytype.PublicKeyTypeSmartListExpression<T> getPublicKeyTypeList() {
