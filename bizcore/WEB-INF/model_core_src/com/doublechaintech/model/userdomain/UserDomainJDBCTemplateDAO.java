...
public class UserDomainJDBCTemplateDAO extends ModelBaseDAOImpl implements UserDomainDAO{
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitUserDomainList(List<UserDomain> userDomainList){
      ...
      if(userDomain.isToRecover()){
		...
		return new Object[]{userDomainCreateList,
      userDomainUpdateList,
      userDomainRemoveList,
      userDomainRecoverList
    };
	}
   ...
   saveUserDomain(userDomain);
    ...
    public SmartList<UserDomain> requestCandidateUserDomainForUserAllowList(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<UserDomain> requestCandidateUserDomainForSecUser(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserDomainTable.COLUMN_NAME, null, filterKey, pageNo, pageSize, getUserDomainMapper());
    }
		
    public SmartList<UserDomain> requestCandidateUserDomainForPublicKeyType(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(UserDomainTable.COLUMN_NAME, null, filterKey, pageNo, pageSize, getUserDomainMapper());
    }
