...
public interface UserDomainManager extends BaseManager {
  ...
  public UserDomain internalSaveUserDomain(
      ModelUserContext userContext, UserDomain userDomain, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, UserDomain updated, Object actor, String methodName)
      throws Exception {};

  /*======================================================DATA MAINTENANCE===========================================================*/

  // public  UserAllowListManager getUserAllowListManager(ModelUserContext userContext, String
  ...
  */
  ...
  // public  SecUserManager getSecUserManager(ModelUserContext userContext, String userDomainId,
  ...
  */
  ...
  // public  PublicKeyTypeManager getPublicKeyTypeManager(ModelUserContext userContext, String
