...
public class CandidateElementJDBCTemplateDAO extends ModelBaseDAOImpl implements CandidateElementDAO{
  ...
  public Stream<CandidateElement> loadAllAsStream() {
	...
	protected List<Object[]> prepareCandidateElementBatchRecoverArgs(List<CandidateElement> candidateElementList){
	...
	protected List<Object[]> prepareCandidateElementBatchRemoveArgs(List<CandidateElement> candidateElementList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitCandidateElementList(List<CandidateElement> candidateElementList){
      ...
      if(candidateElement.isToRecover()){
		...
		return new Object[]{candidateElementCreateList,
