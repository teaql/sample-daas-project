...
public interface CandidateElementManager extends BaseManager {
  ...
  public CandidateElement internalSaveCandidateElement(
      ModelUserContext userContext, CandidateElement candidateElement, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, CandidateElement updated, Object actor, String methodName)
      throws Exception {};
