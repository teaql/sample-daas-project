...
public void transferAllRelationshipsTo(CandidateElement target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(TYPE_PROPERTY, "type", "类型")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(IMAGE_PROPERTY, "image", "图片")
...
return getId();
	...
	public CandidateElement updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public CandidateElement updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getType();
	...
	public CandidateElement updateType(String type){String oldType = this.type;String newType = trimString(type);if(!shouldReplaceBy(newType, oldType)){return this;}this.type = newType;if (cn.hutool.core.util.ObjectUtil.equals(newType, oldType)){
        return this;
      }addPropertyChange(TYPE_PROPERTY, oldType, newType);this.changed = true;setChecked(false);return this;}
...
return getImage();
	...
	public CandidateElement updateImage(String image){String oldImage = this.image;String newImage = trimString(encodeUrl(image));;if(!shouldReplaceBy(newImage, oldImage)){return this;}this.image = newImage;if (cn.hutool.core.util.ObjectUtil.equals(newImage, oldImage)){
        return this;
      }addPropertyChange(IMAGE_PROPERTY, oldImage, newImage);this.changed = true;setChecked(false);return this;}
...
return getContainer();
	...
	public CandidateElement updateContainer(CandidateContainer container){CandidateContainer oldContainer = this.container;CandidateContainer newContainer = container;if(!shouldReplaceBy(newContainer, oldContainer)){return this;}this.container = newContainer;if (cn.hutool.core.util.ObjectUtil.equals(newContainer, oldContainer)){
        return this;
      }addPropertyChange(CONTAINER_PROPERTY, oldContainer, newContainer);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeContainer(CandidateContainer container){
		if(container != null) { updateContainer(container);}
	}

	
  public  CandidateElement updateContainerByReferenceId(String containerId){ updateContainer(CandidateContainer.refById(containerId)); return this;}
...
return getVersion();
	...
	public CandidateElement updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
