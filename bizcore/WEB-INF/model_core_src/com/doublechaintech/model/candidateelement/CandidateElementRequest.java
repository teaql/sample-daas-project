...
import com.doublechaintech.model.candidatecontainer.CandidateContainerRequest;



import java.util.stream.Collectors;
import static com.doublechaintech.model.candidateelement.CandidateElement.*;
...
public class CandidateElementRequest extends BaseRequest<CandidateElement> {
    public static CandidateElementRequest newInstance() {
        return new CandidateElementRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public CandidateElementRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public CandidateElementRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NAME_PROPERTY,TYPE_PROPERTY,IMAGE_PROPERTY,CONTAINER_PROPERTY,VERSION_PROPERTY};
   ...
   public CandidateElementRequest count(){
    ...
    public CandidateElementRequest filterByContainer(CandidateContainer... container){
        if(isEmptyParam(container)){
          throw new IllegalArgumentException("filterByContainer(CandidateContainer... container)参数不能为空!");
        }
    ...
    public CandidateContainerRequest endAtContainer(String retName, CandidateContainerRequest container){
    ...
    public SearchCriteria createContainerCriteria(CandidateContainerRequest container, IDRefine<CandidateContainer> idRefine) {
        return new RefinedIdInCriteria(container, CONTAINER_PROPERTY, idRefine, CandidateContainer.ID_PROPERTY);
    }
