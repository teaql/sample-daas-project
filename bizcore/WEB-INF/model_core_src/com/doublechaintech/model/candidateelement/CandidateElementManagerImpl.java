...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.candidatecontainer.CandidateCandidateContainer;import com.doublechaintech.model.candidatecontainer.CandidateContainer;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class CandidateElementManagerImpl extends CustomModelCheckerManager implements CandidateElementManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws CandidateElementManagerException{
 	...
 	protected CandidateElement saveCandidateElement(ModelUserContext userContext, CandidateElement candidateElement, String [] tokensExpr) throws Exception{
 	...
 	protected CandidateElement saveCandidateElementDetail(ModelUserContext userContext, CandidateElement candidateElement) throws Exception{
 	...
 	public CandidateElement loadCandidateElement(ModelUserContext userContext, String candidateElementId, String [] tokensExpr) throws Exception{
 	 ...
 	 public CandidateElement searchCandidateElement(ModelUserContext userContext, String candidateElementId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected CandidateElement present(ModelUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens) throws Exception {
 	...
 	public CandidateElement loadCandidateElementDetail(ModelUserContext userContext, String candidateElementId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String candidateElementId) throws Exception{
		CandidateElement candidateElement = loadCandidateElement( userContext, candidateElementId, viewTokens());
 	...
 	protected CandidateElement saveCandidateElement(ModelUserContext userContext, CandidateElement candidateElement, Map<String,Object>tokens) throws Exception{
 	
 		return candidateElementDaoOf(userContext).save(candidateElement, tokens);
 	}
 	protected CandidateElement loadCandidateElement(ModelUserContext userContext, String candidateElementId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfCandidateElement(candidateElementId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, CandidateElement candidateElement, Map<String, Object> tokens){
  ...
  @Override
  public List<CandidateElement> searchCandidateElementList(ModelUserContext ctx, CandidateElementRequest pRequest){
  ...
  @Override
  public CandidateElement searchCandidateElement(ModelUserContext ctx, CandidateElementRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingCandidateElement(ModelUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public CandidateElement clone(ModelUserContext userContext, String fromCandidateElementId) throws Exception{
	...
	public CandidateElement internalSaveCandidateElement(ModelUserContext userContext, CandidateElement candidateElement, Map<String,Object> options) throws Exception
	{
	...
	public CandidateElement updateCandidateElementProperty(ModelUserContext userContext,String candidateElementId, int candidateElementVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCandidateElement(userContext, candidateElementId, candidateElementVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherContainer(ModelUserContext userContext, String candidateElementId, String anotherContainerId) throws Exception
 	{
	...
	public CandidateCandidateContainer requestCandidateContainer(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected CandidateContainer loadCandidateContainer(ModelUserContext userContext, String newContainerId, Map<String,Object> options) throws Exception
 	{
	...
	public CandidateElement forgetByAll(ModelUserContext userContext, String candidateElementId, int candidateElementVersion) throws Exception {
		return forgetByAllInternal(userContext, candidateElementId, candidateElementVersion);
	}
	protected CandidateElement forgetByAllInternal(ModelUserContext userContext,
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<CandidateElement> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<CandidateContainer> containerList = ModelBaseUtils.collectReferencedObjectWithType(userContext, list, CandidateContainer.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String candidateElementId) throws Exception{
