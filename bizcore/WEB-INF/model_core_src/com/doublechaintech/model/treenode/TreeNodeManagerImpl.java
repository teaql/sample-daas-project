...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class TreeNodeManagerImpl extends CustomModelCheckerManager implements TreeNodeManager, BusinessHandler{
	...
	@Override
	public TreeNodeDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws TreeNodeManagerException{
 	...
 	protected TreeNode saveTreeNode(ModelUserContext userContext, TreeNode treeNode, String [] tokensExpr) throws Exception{
 	...
 	protected TreeNode saveTreeNodeDetail(ModelUserContext userContext, TreeNode treeNode) throws Exception{
 	...
 	public TreeNode loadTreeNode(ModelUserContext userContext, String treeNodeId, String [] tokensExpr) throws Exception{
 	 ...
 	 public TreeNode searchTreeNode(ModelUserContext userContext, String treeNodeId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected TreeNode present(ModelUserContext userContext, TreeNode treeNode, Map<String, Object> tokens) throws Exception {
 	...
 	public TreeNode loadTreeNodeDetail(ModelUserContext userContext, String treeNodeId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String treeNodeId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String treeNodeId) throws Exception{
		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String treeNodeId) throws Exception{
		TreeNode treeNode = loadTreeNode( userContext, treeNodeId, analyzeTokens());
		markVisited(userContext, treeNode);
		return present(userContext,treeNode, analyzeTokens());

	}
 	protected TreeNode saveTreeNode(ModelUserContext userContext, TreeNode treeNode, Map<String,Object>tokens) throws Exception{
 	
 		return treeNodeDaoOf(userContext).save(treeNode, tokens);
 	}
 	protected TreeNode loadTreeNode(ModelUserContext userContext, String treeNodeId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, TreeNode treeNode, Map<String, Object> tokens){
  ...
  @Override
  public List<TreeNode> searchTreeNodeList(ModelUserContext ctx, TreeNodeRequest pRequest){
  ...
  @Override
  public TreeNode searchTreeNode(ModelUserContext ctx, TreeNodeRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingTreeNode(ModelUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public TreeNode clone(ModelUserContext userContext, String fromTreeNodeId) throws Exception{
	...
	public TreeNode internalSaveTreeNode(ModelUserContext userContext, TreeNode treeNode, Map<String,Object> options) throws Exception
	{
	...
	public TreeNode updateTreeNodeProperty(ModelUserContext userContext,String treeNodeId, int treeNodeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingTreeNode(userContext, treeNodeId, treeNodeVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public TreeNode forgetByAll(ModelUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
		return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
	}
	protected TreeNode forgetByAllInternal(ModelUserContext userContext,
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<TreeNode> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String treeNodeId) throws Exception{
