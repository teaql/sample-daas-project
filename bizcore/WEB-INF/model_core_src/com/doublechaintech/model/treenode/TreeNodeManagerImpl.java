...
public class TreeNodeManagerImpl extends CustomModelCheckerManager
  ...
  protected TreeNode saveTreeNode(
      ModelUserContext userContext, TreeNode treeNode, String[] tokensExpr) throws Exception {
  ...
  protected TreeNode saveTreeNodeDetail(ModelUserContext userContext, TreeNode treeNode)
      throws Exception {

    return saveTreeNode(userContext, treeNode, allTokens());
  }

  public TreeNode loadTreeNode(ModelUserContext userContext, String treeNodeId, String[] tokensExpr)
      throws Exception {
  ...
  public TreeNode searchTreeNode(
      ModelUserContext userContext, String treeNodeId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected TreeNode present(
      ModelUserContext userContext, TreeNode treeNode, Map<String, Object> tokens)
      throws Exception {
  ...
  public TreeNode loadTreeNodeDetail(ModelUserContext userContext, String treeNodeId)
      throws Exception {
  ...
  protected TreeNode loadTreeNode(
      ModelUserContext userContext, String treeNodeId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfTreeNode(treeNodeId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // TreeNode treeNode, Map<String, Object> tokens){
  ...
  public TreeNode createTreeNode(
      ModelUserContext userContext, String nodeId, String nodeType, int leftValue, int rightValue)
      throws Exception {
  ...
  public TreeNode internalSaveTreeNode(ModelUserContext userContext, TreeNode treeNode)
      throws Exception {
    return internalSaveTreeNode(userContext, treeNode, allTokens());
  }

  public TreeNode internalSaveTreeNode(
      ModelUserContext userContext, TreeNode treeNode, Map<String, Object> options)
      throws Exception {
  ...
  public TreeNode forgetByAll(ModelUserContext userContext, String treeNodeId, int treeNodeVersion)
      throws Exception {
    return forgetByAllInternal(userContext, treeNodeId, treeNodeVersion);
  }

  protected TreeNode forgetByAllInternal(
      ModelUserContext userContext, String treeNodeId, int treeNodeVersion) throws Exception {
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, TreeNode newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<TreeNode> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
