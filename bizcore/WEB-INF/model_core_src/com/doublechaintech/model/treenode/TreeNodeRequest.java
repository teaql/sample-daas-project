...
import static com.doublechaintech.model.treenode.TreeNode.*;

public class TreeNodeRequest extends BaseRequest<TreeNode> {
    public static TreeNodeRequest newInstance() {
        return new TreeNodeRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public TreeNodeRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public TreeNodeRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NODE_ID_PROPERTY,NODE_TYPE_PROPERTY,LEFT_VALUE_PROPERTY,RIGHT_VALUE_PROPERTY,VERSION_PROPERTY};
    ...
    public TreeNodeRequest whereLeftValueIsNotNull() {
      ...
      public TreeNodeRequest whereLeftValueBetween(Integer leftValueStart, Integer leftValueEnd) {
          if (ObjectUtil.isEmpty(leftValueStart)) {
               throw new IllegalArgumentException("Method whereLeftValueBetween, the parameter leftValueStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(leftValueEnd)) {
               throw new IllegalArgumentException("Method whereLeftValueBetween, the parameter leftValueEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getLeftValueSearchCriteria(QueryOperator.BETWEEN,  new Object[]{leftValueStart, leftValueEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public TreeNodeRequest whereLeftValueLessThan(Integer leftValue) {
          if (ObjectUtil.isEmpty(leftValue)) {
              throw new IllegalArgumentException("Method whereLeftValueLessThan, the parameter leftValue is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getLeftValueSearchCriteria(QueryOperator.LESS_THAN, new Object[]{leftValue});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public TreeNodeRequest whereLeftValueGreaterThan(int leftValue) {
          if (ObjectUtil.isEmpty(leftValue)) {
              throw new IllegalArgumentException("Method whereLeftValueGreaterThan, the parameter leftValue is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getLeftValueSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{leftValue});
          return addSearchCriteria(searchCriteria);
      }
    ...
    public TreeNodeRequest whereRightValueIsNotNull() {
      ...
      public TreeNodeRequest whereRightValueBetween(Integer rightValueStart, Integer rightValueEnd) {
          if (ObjectUtil.isEmpty(rightValueStart)) {
               throw new IllegalArgumentException("Method whereRightValueBetween, the parameter rightValueStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(rightValueEnd)) {
               throw new IllegalArgumentException("Method whereRightValueBetween, the parameter rightValueEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getRightValueSearchCriteria(QueryOperator.BETWEEN,  new Object[]{rightValueStart, rightValueEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public TreeNodeRequest whereRightValueLessThan(Integer rightValue) {
          if (ObjectUtil.isEmpty(rightValue)) {
              throw new IllegalArgumentException("Method whereRightValueLessThan, the parameter rightValue is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getRightValueSearchCriteria(QueryOperator.LESS_THAN, new Object[]{rightValue});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public TreeNodeRequest whereRightValueGreaterThan(int rightValue) {
          if (ObjectUtil.isEmpty(rightValue)) {
              throw new IllegalArgumentException("Method whereRightValueGreaterThan, the parameter rightValue is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getRightValueSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{rightValue});
          return addSearchCriteria(searchCriteria);
      }
