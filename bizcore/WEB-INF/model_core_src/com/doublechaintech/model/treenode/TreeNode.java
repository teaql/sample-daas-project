...
public void transferAllRelationshipsTo(TreeNode target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(LEFT_VALUE_PROPERTY, "left_value", "左值")
        .withType("int", "int"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(RIGHT_VALUE_PROPERTY, "right_value", "正确的价值")
        .withType("int", "int"));
...
return getId();
	...
	public TreeNode updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getNodeId();
	...
	public TreeNode updateNodeId(String nodeId){String oldNodeId = this.nodeId;String newNodeId = trimString(nodeId);if(!shouldReplaceBy(newNodeId, oldNodeId)){return this;}this.nodeId = newNodeId;if (cn.hutool.core.util.ObjectUtil.equals(newNodeId, oldNodeId)){
        return this;
      }addPropertyChange(NODE_ID_PROPERTY, oldNodeId, newNodeId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeNodeId(String nodeId){
		if(nodeId != null) { updateNodeId(nodeId);}
	}
...
return getNodeType();
	...
	public TreeNode updateNodeType(String nodeType){String oldNodeType = this.nodeType;String newNodeType = trimString(nodeType);if(!shouldReplaceBy(newNodeType, oldNodeType)){return this;}this.nodeType = newNodeType;if (cn.hutool.core.util.ObjectUtil.equals(newNodeType, oldNodeType)){
        return this;
      }addPropertyChange(NODE_TYPE_PROPERTY, oldNodeType, newNodeType);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeNodeType(String nodeType){
		if(nodeType != null) { updateNodeType(nodeType);}
	}
...
return getLeftValue();
	...
	public TreeNode updateLeftValue(int leftValue){int oldLeftValue = this.leftValue;int newLeftValue = leftValue;if(!shouldReplaceBy(newLeftValue, oldLeftValue)){return this;}this.leftValue = newLeftValue;if (cn.hutool.core.util.ObjectUtil.equals(newLeftValue, oldLeftValue)){
        return this;
      }addPropertyChange(LEFT_VALUE_PROPERTY, oldLeftValue, newLeftValue);this.changed = true;setChecked(false);return this;}
...
return getRightValue();
	...
	public TreeNode updateRightValue(int rightValue){int oldRightValue = this.rightValue;int newRightValue = rightValue;if(!shouldReplaceBy(newRightValue, oldRightValue)){return this;}this.rightValue = newRightValue;if (cn.hutool.core.util.ObjectUtil.equals(newRightValue, oldRightValue)){
        return this;
      }addPropertyChange(RIGHT_VALUE_PROPERTY, oldRightValue, newRightValue);this.changed = true;setChecked(false);return this;}
...
return getVersion();
	...
	public TreeNode updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
