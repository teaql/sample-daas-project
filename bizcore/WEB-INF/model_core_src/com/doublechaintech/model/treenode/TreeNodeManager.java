...
public interface TreeNodeManager extends BaseManager {
  ...
  public TreeNode internalSaveTreeNode(
      ModelUserContext userContext, TreeNode treeNode, Map<String, Object> option) throws Exception;

  public void onNewInstanceCreated(ModelUserContext userContext, TreeNode newCreated)
      throws Exception;

  public default void onUpdated(
      ModelUserContext userContext, TreeNode updated, Object actor, String methodName)
      throws Exception {};
