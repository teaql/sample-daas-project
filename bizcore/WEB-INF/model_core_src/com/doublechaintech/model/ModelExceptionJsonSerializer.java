...
public class ModelExceptionJsonSerializer extends JsonSerializer<ModelException> {
  ...
  @Override
  public void serialize(ModelException exception, JsonGenerator jgen, SerializerProvider provider)
  ...
  protected void writeExceptionMessage(
      String message, ModelException exception, JsonGenerator jgen, SerializerProvider provider)
      throws IOException {
  ...
  protected void writeStartObject(
      ModelException exception, JsonGenerator jgen, SerializerProvider provider)
      throws IOException, JsonProcessingException {
  ...
  protected void writeClassField(
      String fieldName, ModelException exception, JsonGenerator jgen, SerializerProvider provider)
      throws IOException, JsonProcessingException {
