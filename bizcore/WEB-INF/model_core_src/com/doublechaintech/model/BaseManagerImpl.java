...
public class BaseManagerImpl implements AccessControledService, BeanNameAware {
  ...
  public Optional<UserApp> findOutUserApp(ModelUserContext userContext, String userAppId)
      throws Exception {
  ...
  protected Object invokeWithOneString(
    ...
    Method method =
        target
            .getClass()
            .getMethod(
                methodName, (Class<?>[]) new Class<?>[] {ModelUserContext.class, String.class});
  ...
  public Object loginById4Debug(ModelUserContext userContext, String fullId) throws Exception {
  ...
  // 手机号+短信验证码 登录
  public Object loginByMobile(ModelUserContext userContext, String mobile, String verifyCode)
      throws Exception {
    LoginChannel loginChannel =
        LoginChannel.of(
            ModelBaseUtils.getRequestAppType(userContext), this.getBeanName(), "loginByMobile");
    LoginData loginData = new LoginData();
  ...
  // 账号+密码登录
  public Object loginByPassword(ModelUserContext userContext, String loginId, Password password)
      throws Exception {
    LoginChannel loginChannel =
        LoginChannel.of(
            ModelBaseUtils.getRequestAppType(userContext), this.getBeanName(), "loginByPassword");
    LoginData loginData = new LoginData();
  ...
  // 微信小程序登录
  public Object loginByWechatMiniProgram(ModelUserContext userContext, String code)
      throws Exception {
    LoginChannel loginChannel =
        LoginChannel.of(
  ...
  public Object loginByWechatMobile(
      ModelUserContext userContext, String code, String encryptedData, String iv) throws Exception {
    LoginChannel loginChannel =
        LoginChannel.of(
            ModelBaseUtils.getRequestAppType(userContext),
            this.getBeanName(),
  ...
  // 企业微信小程序登录
  public Object loginByWechatWorkMiniProgram(ModelUserContext userContext, String code)
      throws Exception {
    LoginChannel loginChannel =
        LoginChannel.of(
            ModelBaseUtils.getRequestAppType(userContext),
  ...
  // 调用登录处理
  protected Object processLoginRequest(ModelUserContext baseUserContext, LoginContext loginContext)
      throws Exception {
  ...
  protected boolean isMethodNeedLogin(
      ModelUserContext userContext, String methodName, Object[] parameters) {
  ...
  protected void afterSecUserAppLoadedWhenCheckAccess(
      ModelUserContext userContext, Map<String, Object> loginInfo, SecUser secUser, UserApp userApp)
      throws IllegalAccessException {}

  protected Object onLoginSuccess(ModelUserContext userContext, LoginResult loginResult)
      throws Exception {
