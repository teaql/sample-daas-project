...
public class WechatMiniappIdentityManagerImpl extends CustomModelCheckerManager implements WechatMiniappIdentityManager, BusinessHandler{
	...
	@Override
	public WechatMiniappIdentityDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws WechatMiniappIdentityManagerException{
 	...
 	protected WechatMiniappIdentity saveWechatMiniappIdentity(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, String [] tokensExpr) throws Exception{
 	...
 	protected WechatMiniappIdentity saveWechatMiniappIdentityDetail(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity) throws Exception{
 	...
 	public WechatMiniappIdentity loadWechatMiniappIdentity(ModelUserContext userContext, String wechatMiniappIdentityId, String [] tokensExpr) throws Exception{
 	 ...
 	 public WechatMiniappIdentity searchWechatMiniappIdentity(ModelUserContext userContext, String wechatMiniappIdentityId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected WechatMiniappIdentity present(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens) throws Exception {
		...
		List<BaseEntity> entityListToNaming = wechatMiniappIdentityToPresent.collectReferencesFromLists();
 	...
 	public WechatMiniappIdentity loadWechatMiniappIdentityDetail(ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception{
		WechatMiniappIdentity wechatMiniappIdentity = loadWechatMiniappIdentity( userContext, wechatMiniappIdentityId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception{
 	...
 	protected WechatMiniappIdentity saveWechatMiniappIdentity(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String,Object>tokens) throws Exception{
 	
 		return wechatMiniappIdentityDaoOf(userContext).save(wechatMiniappIdentity, tokens);
 	}
 	protected WechatMiniappIdentity loadWechatMiniappIdentity(ModelUserContext userContext, String wechatMiniappIdentityId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfWechatMiniappIdentity(wechatMiniappIdentityId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens){
  ...
  @Override
  public List<WechatMiniappIdentity> searchWechatMiniappIdentityList(ModelUserContext ctx, WechatMiniappIdentityRequest pRequest){
  ...
  @Override
  public WechatMiniappIdentity searchWechatMiniappIdentity(ModelUserContext ctx, WechatMiniappIdentityRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingWechatMiniappIdentity(ModelUserContext userContext,String wechatMiniappIdentityId, int wechatMiniappIdentityVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatMiniappIdentity clone(ModelUserContext userContext, String fromWechatMiniappIdentityId) throws Exception{
	...
	public WechatMiniappIdentity internalSaveWechatMiniappIdentity(ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity, Map<String,Object> options) throws Exception
	{
	...
	public WechatMiniappIdentity updateWechatMiniappIdentityProperty(ModelUserContext userContext,String wechatMiniappIdentityId, int wechatMiniappIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatMiniappIdentity(userContext, wechatMiniappIdentityId, wechatMiniappIdentityVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithLogin(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithEmail(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatMiniappIdentity transferToAnotherSecUserWithMobile(ModelUserContext userContext, String wechatMiniappIdentityId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public WechatMiniappIdentity forgetByAll(ModelUserContext userContext, String wechatMiniappIdentityId, int wechatMiniappIdentityVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatMiniappIdentityId, wechatMiniappIdentityVersion);
	}
	protected WechatMiniappIdentity forgetByAllInternal(ModelUserContext userContext,
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<WechatMiniappIdentity> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception{
