...
public class WechatMiniappIdentityManagerImpl extends CustomModelCheckerManager
  ...
  protected WechatMiniappIdentity saveWechatMiniappIdentityDetail(
      ModelUserContext userContext, WechatMiniappIdentity wechatMiniappIdentity) throws Exception {
  ...
  public WechatMiniappIdentity loadWechatMiniappIdentity(
      ModelUserContext userContext, String wechatMiniappIdentityId, String[] tokensExpr)
      throws Exception {
  ...
  public WechatMiniappIdentity loadWechatMiniappIdentityDetail(
      ModelUserContext userContext, String wechatMiniappIdentityId) throws Exception {
    WechatMiniappIdentity wechatMiniappIdentity =
  ...
  public Object view(ModelUserContext userContext, String wechatMiniappIdentityId)
      throws Exception {
    WechatMiniappIdentity wechatMiniappIdentity =
  ...
  public Object summaryView(ModelUserContext userContext, String wechatMiniappIdentityId)
      throws Exception {
    WechatMiniappIdentity wechatMiniappIdentity =
        loadWechatMiniappIdentity(userContext, wechatMiniappIdentityId, viewTokens());
  ...
  public Object analyze(ModelUserContext userContext, String wechatMiniappIdentityId)
      throws Exception {
    WechatMiniappIdentity wechatMiniappIdentity =
  ...
  protected WechatMiniappIdentity loadWechatMiniappIdentity(
      ModelUserContext userContext, String wechatMiniappIdentityId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfWechatMiniappIdentity(wechatMiniappIdentityId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // WechatMiniappIdentity wechatMiniappIdentity, Map<String, Object> tokens){

  @Override
  public List<WechatMiniappIdentity> searchWechatMiniappIdentityList(
      ModelUserContext ctx, WechatMiniappIdentityRequest pRequest) {
  ...
  public WechatMiniappIdentity clone(
      ModelUserContext userContext, String fromWechatMiniappIdentityId) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUser(
      ModelUserContext userContext, String wechatMiniappIdentityId, String anotherSecUserId)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithLogin(
      ModelUserContext userContext, String wechatMiniappIdentityId, String anotherLogin)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithEmail(
      ModelUserContext userContext, String wechatMiniappIdentityId, String anotherEmail)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherSecUserWithMobile(
      ModelUserContext userContext, String wechatMiniappIdentityId, String anotherMobile)
      throws Exception {
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, WechatMiniappIdentity newCreated)
      throws Exception {
  ...
  protected void enhanceForListOfView(
      ModelUserContext userContext, SmartList<WechatMiniappIdentity> list) throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
   ...
   * @throws Exception
   */
  public Object wxappview(ModelUserContext userContext, String wechatMiniappIdentityId)
      throws Exception {
