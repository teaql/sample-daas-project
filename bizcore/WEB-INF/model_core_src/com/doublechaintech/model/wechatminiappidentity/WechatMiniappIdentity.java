...
public void transferAllRelationshipsTo(WechatMiniappIdentity target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(OPEN_ID_PROPERTY, "open_id", "开放Id")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(APP_ID_PROPERTY, "app_id", "应用程序Id")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(UNION_ID_PROPERTY, "union_id", "联盟Id")
        .withType("string", String.class));
...
return getId();
	...
	public WechatMiniappIdentity updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getOpenId();
	...
	public WechatMiniappIdentity updateOpenId(String openId){String oldOpenId = this.openId;String newOpenId = trimString(openId);if(!shouldReplaceBy(newOpenId, oldOpenId)){return this;}this.openId = newOpenId;if (cn.hutool.core.util.ObjectUtil.equals(newOpenId, oldOpenId)){
        return this;
      }addPropertyChange(OPEN_ID_PROPERTY, oldOpenId, newOpenId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeOpenId(String openId){
		if(openId != null) { updateOpenId(openId);}
	}
...
return getAppId();
	...
	public WechatMiniappIdentity updateAppId(String appId){String oldAppId = this.appId;String newAppId = trimString(appId);if(!shouldReplaceBy(newAppId, oldAppId)){return this;}this.appId = newAppId;if (cn.hutool.core.util.ObjectUtil.equals(newAppId, oldAppId)){
        return this;
...
return getUnionId();
	...
	public WechatMiniappIdentity updateUnionId(String unionId){String oldUnionId = this.unionId;String newUnionId = trimString(unionId);if(!shouldReplaceBy(newUnionId, oldUnionId)){return this;}this.unionId = newUnionId;if (cn.hutool.core.util.ObjectUtil.equals(newUnionId, oldUnionId)){
        return this;
      }addPropertyChange(UNION_ID_PROPERTY, oldUnionId, newUnionId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeUnionId(String unionId){
		if(unionId != null) { updateUnionId(unionId);}
	}
...
return getSecUser();
	...
	public WechatMiniappIdentity updateSecUser(SecUser secUser){SecUser oldSecUser = this.secUser;SecUser newSecUser = secUser;if(!shouldReplaceBy(newSecUser, oldSecUser)){return this;}this.secUser = newSecUser;if (cn.hutool.core.util.ObjectUtil.equals(newSecUser, oldSecUser)){
        return this;
...
return this;
  ...
  public  WechatMiniappIdentity updateSecUserByReferenceId(String secUserId){ updateSecUser(SecUser.refById(secUserId)); return this;}
...
return getCreateTime();
	...
	public WechatMiniappIdentity updateCreateTime(DateTime createTime){DateTime oldCreateTime = this.createTime;DateTime newCreateTime = createTime;if(!shouldReplaceBy(newCreateTime, oldCreateTime)){return this;}this.createTime = newCreateTime;if (cn.hutool.core.util.ObjectUtil.equals(newCreateTime, oldCreateTime)){
        return this;
      }addPropertyChange(CREATE_TIME_PROPERTY, oldCreateTime, newCreateTime);this.changed = true;setChecked(false);return this;}
...
return getVersion();
	...
	public WechatMiniappIdentity updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
