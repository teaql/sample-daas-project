...
import com.doublechaintech.model.secuser.SecUserRequest;



import java.util.stream.Collectors;
import static com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentity.*;
...
public class WechatMiniappIdentityRequest extends BaseRequest<WechatMiniappIdentity> {
    public static WechatMiniappIdentityRequest newInstance() {
        return new WechatMiniappIdentityRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public WechatMiniappIdentityRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public WechatMiniappIdentityRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] DATE_OR_TIME_FIELDS={CREATE_TIME_PROPERTY,LAST_LOGIN_TIME_PROPERTY};
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,OPEN_ID_PROPERTY,APP_ID_PROPERTY,UNION_ID_PROPERTY,SEC_USER_PROPERTY,CREATE_TIME_PROPERTY,LAST_LOGIN_TIME_PROPERTY,VERSION_PROPERTY};
   ...
   public WechatMiniappIdentityRequest count(){
    ...
    public WechatMiniappIdentityRequest whereCreateTimeIsNotNull() {
      ...
      public WechatMiniappIdentityRequest whereCreateTimeBetween(Date createTimeStart, Date createTimeEnd) {
          if (ObjectUtil.isEmpty(createTimeStart)) {
               throw new IllegalArgumentException("Method whereCreateTimeBetween, the parameter createTimeStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(createTimeEnd)) {
               throw new IllegalArgumentException("Method whereCreateTimeBetween, the parameter createTimeEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getCreateTimeSearchCriteria(QueryOperator.BETWEEN,  new Object[]{createTimeStart, createTimeEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public WechatMiniappIdentityRequest whereCreateTimeBefore(Date createTime) {
          ...
          if (ObjectUtil.isEmpty(createTime)) {
               throw new IllegalArgumentException("Method whereCreateTimeBefore, the parameter createTime is not allowed  to be null.");
          }

          SearchCriteria searchCriteria = getCreateTimeSearchCriteria(QueryOperator.LESS_THAN, new Object[]{createTime});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public WechatMiniappIdentityRequest whereCreateTimeAfter(DateTime createTime) {
          if (ObjectUtil.isEmpty(createTime)) {
              throw new IllegalArgumentException("Method whereCreateTimeAfter, the parameter createTime is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getCreateTimeSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{createTime});
          return addSearchCriteria(searchCriteria);
      }
    ...
    public WechatMiniappIdentityRequest whereLastLoginTimeIsNotNull() {
      ...
      public WechatMiniappIdentityRequest whereLastLoginTimeBetween(Date lastLoginTimeStart, Date lastLoginTimeEnd) {
