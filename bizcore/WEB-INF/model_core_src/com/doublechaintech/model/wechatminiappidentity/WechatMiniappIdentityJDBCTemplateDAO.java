...
public class WechatMiniappIdentityJDBCTemplateDAO extends ModelBaseDAOImpl implements WechatMiniappIdentityDAO{
  ...
  public Stream<WechatMiniappIdentity> loadAllAsStream() {
	...
	protected List<Object[]> prepareWechatMiniappIdentityBatchRecoverArgs(List<WechatMiniappIdentity> wechatMiniappIdentityList){
	...
	protected List<Object[]> prepareWechatMiniappIdentityBatchRemoveArgs(List<WechatMiniappIdentity> wechatMiniappIdentityList){
	...
	protected void batchWechatMiniappIdentityRemove(List<WechatMiniappIdentity> wechatMiniappIdentityList){
  ...
  protected void batchWechatMiniappIdentityRecover(List<WechatMiniappIdentity> wechatMiniappIdentityList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitWechatMiniappIdentityList(List<WechatMiniappIdentity> wechatMiniappIdentityList){
		...
		List<WechatMiniappIdentity> wechatMiniappIdentityRemoveList=new ArrayList<WechatMiniappIdentity>();
		List<WechatMiniappIdentity> wechatMiniappIdentityRecoverList=new ArrayList<WechatMiniappIdentity>();
      ...
      if(wechatMiniappIdentity.isToRecover()){
		...
		return new Object[]{wechatMiniappIdentityCreateList,
    ...
    if(wechatMiniappIdentity.isToRecover() ){
 	...
 	protected Object[] prepareWechatMiniappIdentityRemoveParameters(WechatMiniappIdentity wechatMiniappIdentity){
