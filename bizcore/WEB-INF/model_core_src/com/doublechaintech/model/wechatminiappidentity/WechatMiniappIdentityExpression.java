...
public abstract class WechatMiniappIdentityExpression<T> implements Expression<T, WechatMiniappIdentity> {
    ...
    public Expression<T, String> getId() {
        return new Expression<T, String>(){
           ...
           public String eval(T wechatMiniappIdentity) {
              WechatMiniappIdentity parent = WechatMiniappIdentityExpression.this.eval(wechatMiniappIdentity);
