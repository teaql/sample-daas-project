...
import com.doublechaintech.model.secuser.SecUserCustomManagerImpl;
...
public class ModelUserContextImpl extends UserContextImpl implements ModelUserContext{
    ...
    static final String RESOURCE_PATH = "com.doublechaintech.model.ModelResources";
    static final String CUSTOM_RESOURCE_PATH = "com.doublechaintech.model.ModelCustomResources";
    ...
    /*
     * public static SecUser getSecUser(ModelUserContext
     ...
     * getSingleUserAppByObjectName(ModelUserContext
     ...
     */
    public static SmartList<UserApp> getUserAppByName(ModelUserContext userContext,SecUser secUser,String objectName) {
    ...
    public static UserApp getUserAppByBindedEntity(ModelUserContext userContext, BaseEntity userAppBindedObject) {
		    MultipleAccessKey key = new MultipleAccessKey();
    ...
    public static UserApp getUserAppByBoundCtx(ModelUserContext userContext, BaseEntity userAppBindedObject) {
    		    MultipleAccessKey key = new MultipleAccessKey();
