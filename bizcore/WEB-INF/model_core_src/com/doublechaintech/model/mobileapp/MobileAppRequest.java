...
import static com.doublechaintech.model.mobileapp.MobileApp.*;

public class MobileAppRequest extends BaseRequest<MobileApp> {
    public static MobileAppRequest newInstance() {
        return new MobileAppRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public MobileAppRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public MobileAppRequest selectAny() {return selectAll().selectPageList(Q.page().selectSelf()).selectPageTypeList(Q.pageType().selectSelf());
        }
   ...
   public MobileAppRequest count(){
    ...
    public MobileAppRequest hasPage(Page... page) {
       if (isEmptyParam(page)){
        ...
        return hasPage(Q.page().select(Page.MOBILE_APP_PROPERTY).filterById(QueryOperator.IN, (Object[])page));
    }
    ...
    public MobileAppRequest hasPage(PageRequest page) {
        return hasPage(page, $page -> java.util.Optional.of($page).map(Page::getMobileApp).map(MobileApp::getId).orElse(null));
    }
    ...
    public MobileAppRequest hasPage(
        PageRequest page, QueryOperator queryOperator, Object value) {
      return addSearchCriteria(
          new AggregationCriteria(
              page, Page.MOBILE_APP_PROPERTY, queryOperator, value));
    }
    ...
    public MobileAppRequest hasPageType(PageType... pageType) {
       if (isEmptyParam(pageType)){
        ...
        return hasPageType(Q.pageType().select(PageType.MOBILE_APP_PROPERTY).filterById(QueryOperator.IN, (Object[])pageType));
    }
    ...
    public MobileAppRequest hasPageType(PageTypeRequest pageType) {
        return hasPageType(pageType, $pageType -> java.util.Optional.of($pageType).map(PageType::getMobileApp).map(MobileApp::getId).orElse(null));
    }
    ...
    public MobileAppRequest hasPageType(
      ...
      return addSearchCriteria(
          new AggregationCriteria(
              pageType, PageType.MOBILE_APP_PROPERTY, queryOperator, value));
    }
