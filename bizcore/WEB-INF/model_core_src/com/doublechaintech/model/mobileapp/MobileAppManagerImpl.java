...
public class MobileAppManagerImpl extends CustomModelCheckerManager
  ...
  protected MobileApp saveMobileApp(
      ModelUserContext userContext, MobileApp mobileApp, String[] tokensExpr) throws Exception {
  ...
  protected MobileApp saveMobileAppDetail(ModelUserContext userContext, MobileApp mobileApp)
      throws Exception {
  ...
  public MobileApp searchMobileApp(
      ModelUserContext userContext, String mobileAppId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected MobileApp present(
      ModelUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens)
      throws Exception {
  ...
  public MobileApp loadMobileAppDetail(ModelUserContext userContext, String mobileAppId)
      throws Exception {
  ...
  protected MobileApp loadMobileApp(
      ModelUserContext userContext, String mobileAppId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // MobileApp mobileApp, Map<String, Object> tokens){
  ...
  public MobileApp internalSaveMobileApp(
      ModelUserContext userContext, MobileApp mobileApp, Map<String, Object> options)
      throws Exception {
  ...
  public MobileApp forgetByAll(
      ModelUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
  ...
  protected void checkParamsForRemovingPageList(
      ModelUserContext userContext, String mobileAppId, String pageIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected PageType createPageType(
      ModelUserContext userContext, String name, String code, boolean footerTab) throws Exception {
  ...
  protected void checkParamsForRemovingPageTypeList(
      ModelUserContext userContext, String mobileAppId, String pageTypeIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<MobileApp> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
