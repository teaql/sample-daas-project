...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.mobileapp.MobileApp;import com.doublechaintech.model.page.Page;import com.doublechaintech.model.pagetype.PageType;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class MobileAppManagerImpl extends CustomModelCheckerManager implements MobileAppManager, BusinessHandler{
	...
	@Override
	public MobileAppDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws MobileAppManagerException{
 	...
 	protected MobileApp saveMobileApp(ModelUserContext userContext, MobileApp mobileApp, String [] tokensExpr) throws Exception{
 	...
 	protected MobileApp saveMobileAppDetail(ModelUserContext userContext, MobileApp mobileApp) throws Exception{


 		return saveMobileApp(userContext, mobileApp, allTokens());
 	}

 	public MobileApp loadMobileApp(ModelUserContext userContext, String mobileAppId, String [] tokensExpr) throws Exception{
 	 ...
 	 public MobileApp searchMobileApp(ModelUserContext userContext, String mobileAppId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected MobileApp present(ModelUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens) throws Exception {
 	...
 	public MobileApp loadMobileAppDetail(ModelUserContext userContext, String mobileAppId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String mobileAppId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String mobileAppId) throws Exception{
		MobileApp mobileApp = loadMobileApp( userContext, mobileAppId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String mobileAppId) throws Exception{
 	...
 	protected MobileApp saveMobileApp(ModelUserContext userContext, MobileApp mobileApp, Map<String,Object>tokens) throws Exception{
 	
 		return mobileAppDaoOf(userContext).save(mobileApp, tokens);
 	}
 	protected MobileApp loadMobileApp(ModelUserContext userContext, String mobileAppId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfMobileApp(mobileAppId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, MobileApp mobileApp, Map<String, Object> tokens){
  ...
  @Override
  public List<MobileApp> searchMobileAppList(ModelUserContext ctx, MobileAppRequest pRequest){
  ...
  @Override
  public MobileApp searchMobileApp(ModelUserContext ctx, MobileAppRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingMobileApp(ModelUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public MobileApp clone(ModelUserContext userContext, String fromMobileAppId) throws Exception{

		return mobileAppDaoOf(userContext).clone(fromMobileAppId, this.allTokens());
	}

	public MobileApp internalSaveMobileApp(ModelUserContext userContext, MobileApp mobileApp) throws Exception
	{
		return internalSaveMobileApp(userContext, mobileApp, allTokens());

	}
	public MobileApp internalSaveMobileApp(ModelUserContext userContext, MobileApp mobileApp, Map<String,Object> options) throws Exception
	{
	...
	public MobileApp updateMobileApp(ModelUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
	...
	public MobileApp updateMobileAppProperty(ModelUserContext userContext,String mobileAppId, int mobileAppVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingMobileApp(userContext, mobileAppId, mobileAppVersion, property, newValueExpr, tokensExpr);
...
//--------------------------------------------------------------
	...
	public MobileApp forgetByAll(ModelUserContext userContext, String mobileAppId, int mobileAppVersion) throws Exception {
		return forgetByAllInternal(userContext, mobileAppId, mobileAppVersion);
	}
	protected MobileApp forgetByAllInternal(ModelUserContext userContext,
	...
	protected void checkParamsForAddingPage(ModelUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId, int displayOrder,String [] tokensExpr) throws Exception{
	...
	public  MobileApp addPage(ModelUserContext userContext, String mobileAppId, String pageTitle, String linkToUrl, String pageTypeId, int displayOrder, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingPageProperties(ModelUserContext userContext, String mobileAppId,String id,String pageTitle,String linkToUrl,int displayOrder,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageProperties(ModelUserContext userContext, String mobileAppId, String id,String pageTitle,String linkToUrl,int displayOrder, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdatePageProperties(ModelUserContext userContext, Page item, String mobileAppId, String id,String pageTitle,String linkToUrl,int displayOrder, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected Page createPage(ModelUserContext userContext, String pageTitle, String linkToUrl, String pageTypeId, int displayOrder) throws Exception{
	...
	protected void checkParamsForRemovingPageList(ModelUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageList(ModelUserContext userContext, String mobileAppId,
			String pageIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPage(ModelUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePage(ModelUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPage(ModelUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageFrom(ModelUserContext userContext, String mobileAppId,
		String pageId, int pageVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPage(ModelUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePage(ModelUserContext userContext, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	protected void beforeUpdatePage(ModelUserContext userContext, Page existed, String mobileAppId, String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
	...
	*/
	...
	protected void checkParamsForAddingPageType(ModelUserContext userContext, String mobileAppId, String name, String code, boolean footerTab,String [] tokensExpr) throws Exception{
	...
	public  MobileApp addPageType(ModelUserContext userContext, String mobileAppId, String name, String code, boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingPageTypeProperties(ModelUserContext userContext, String mobileAppId,String id,String name,String code,boolean footerTab,String [] tokensExpr) throws Exception {
	...
	public  MobileApp updatePageTypeProperties(ModelUserContext userContext, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdatePageTypeProperties(ModelUserContext userContext, PageType item, String mobileAppId, String id,String name,String code,boolean footerTab, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected PageType createPageType(ModelUserContext userContext, String name, String code, boolean footerTab) throws Exception{
	...
	protected void checkParamsForRemovingPageTypeList(ModelUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageTypeList(ModelUserContext userContext, String mobileAppId,
			String pageTypeIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingPageType(ModelUserContext userContext, String mobileAppId,
	...
	public  MobileApp removePageType(ModelUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingPageType(ModelUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	public  MobileApp copyPageTypeFrom(ModelUserContext userContext, String mobileAppId,
		String pageTypeId, int pageTypeVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingPageType(ModelUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  MobileApp updatePageType(ModelUserContext userContext, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	/** if you has something need to do before update data from DB, override this */
	protected void beforeUpdatePageType(ModelUserContext userContext, PageType existed, String mobileAppId, String pageTypeId, int pageTypeVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
	...
	*/
	...
	public void onNewInstanceCreated(ModelUserContext userContext, MobileApp newCreated) throws Exception{
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<MobileApp> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String mobileAppId) throws Exception{
