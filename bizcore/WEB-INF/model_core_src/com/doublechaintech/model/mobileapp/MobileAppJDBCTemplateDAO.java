...
public class MobileAppJDBCTemplateDAO extends ModelBaseDAOImpl implements MobileAppDAO{
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitMobileAppList(List<MobileApp> mobileAppList){
      ...
      if(mobileApp.isToRecover()){
		...
		return new Object[]{mobileAppCreateList,
      mobileAppUpdateList,
      mobileAppRemoveList,
      mobileAppRecoverList
    };
	}
   ...
   saveMobileApp(mobileApp);
    ...
    public SmartList<MobileApp> requestCandidateMobileAppForPage(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
    ...
    public SmartList<MobileApp> requestCandidateMobileAppForPageType(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
        // NOTE: by default, ignore owner info, just return all by filter key.
		// You need override this method if you have different candidate-logic
		return findAllCandidateByFilter(MobileAppTable.COLUMN_NAME, null, filterKey, pageNo, pageSize, getMobileAppMapper());
    }
