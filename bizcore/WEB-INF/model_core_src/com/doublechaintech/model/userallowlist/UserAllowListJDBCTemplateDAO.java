...
public class UserAllowListJDBCTemplateDAO extends ModelBaseDAOImpl implements UserAllowListDAO{
  ...
  public Stream<UserAllowList> loadAllAsStream() {
	...
	protected List<Object[]> prepareUserAllowListBatchRecoverArgs(List<UserAllowList> userAllowListList){
	...
	protected List<Object[]> prepareUserAllowListBatchRemoveArgs(List<UserAllowList> userAllowListList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitUserAllowListList(List<UserAllowList> userAllowListList){
      ...
      if(userAllowList.isToRecover()){
		...
		return new Object[]{userAllowListCreateList,
