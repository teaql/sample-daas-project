...
public void transferAllRelationshipsTo(UserAllowList target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(USER_IDENTITY_PROPERTY, "user_identity", "用户身份")
        .withType("string_china_mobile_phone", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(USER_SPECIAL_FUNCTIONS_PROPERTY, "user_special_functions", "用户特殊功能")
...
return getId();
	...
	public UserAllowList updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getUserIdentity();
	...
	public UserAllowList updateUserIdentity(String userIdentity){String oldUserIdentity = this.userIdentity;String newUserIdentity = trimString(userIdentity);if(!shouldReplaceBy(newUserIdentity, oldUserIdentity)){return this;}this.userIdentity = newUserIdentity;if (cn.hutool.core.util.ObjectUtil.equals(newUserIdentity, oldUserIdentity)){
        return this;
      }addPropertyChange(USER_IDENTITY_PROPERTY, oldUserIdentity, newUserIdentity);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeUserIdentity(String userIdentity){
		if(userIdentity != null) { updateUserIdentity(userIdentity);}
	}
...
return getUserSpecialFunctions();
	...
	public UserAllowList updateUserSpecialFunctions(String userSpecialFunctions){String oldUserSpecialFunctions = this.userSpecialFunctions;String newUserSpecialFunctions = trimString(userSpecialFunctions);if(!shouldReplaceBy(newUserSpecialFunctions, oldUserSpecialFunctions)){return this;}this.userSpecialFunctions = newUserSpecialFunctions;if (cn.hutool.core.util.ObjectUtil.equals(newUserSpecialFunctions, oldUserSpecialFunctions)){
        return this;
      }addPropertyChange(USER_SPECIAL_FUNCTIONS_PROPERTY, oldUserSpecialFunctions, newUserSpecialFunctions);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeUserSpecialFunctions(String userSpecialFunctions){
		if(userSpecialFunctions != null) { updateUserSpecialFunctions(userSpecialFunctions);}
	}
...
return getDomain();
	...
	public UserAllowList updateDomain(UserDomain domain){UserDomain oldDomain = this.domain;UserDomain newDomain = domain;if(!shouldReplaceBy(newDomain, oldDomain)){return this;}this.domain = newDomain;if (cn.hutool.core.util.ObjectUtil.equals(newDomain, oldDomain)){
        return this;
...
return this;
  ...
  public  UserAllowList updateDomainByReferenceId(String domainId){ updateDomain(UserDomain.refById(domainId)); return this;}
...
return getVersion();
	...
	public UserAllowList updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
