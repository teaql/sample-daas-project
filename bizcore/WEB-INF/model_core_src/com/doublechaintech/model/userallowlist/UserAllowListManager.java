...
public interface UserAllowListManager extends BaseManager {
  ...
  public UserAllowList internalSaveUserAllowList(
      ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, UserAllowList updated, Object actor, String methodName)
      throws Exception {};
