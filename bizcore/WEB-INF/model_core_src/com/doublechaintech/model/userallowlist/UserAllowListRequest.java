...
import static com.doublechaintech.model.userallowlist.UserAllowList.*;

public class UserAllowListRequest extends BaseRequest<UserAllowList> {
    public static UserAllowListRequest newInstance() {
        return new UserAllowListRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public UserAllowListRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public UserAllowListRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,USER_IDENTITY_PROPERTY,USER_SPECIAL_FUNCTIONS_PROPERTY,DOMAIN_PROPERTY,VERSION_PROPERTY};
