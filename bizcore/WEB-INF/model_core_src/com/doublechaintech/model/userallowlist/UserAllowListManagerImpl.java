...
public class UserAllowListManagerImpl extends CustomModelCheckerManager
  ...
  protected UserAllowList saveUserAllowList(
      ModelUserContext userContext, UserAllowList userAllowList, String[] tokensExpr)
      throws Exception {
  ...
  protected UserAllowList saveUserAllowListDetail(
      ModelUserContext userContext, UserAllowList userAllowList) throws Exception {

    return saveUserAllowList(userContext, userAllowList, allTokens());
  }

  public UserAllowList loadUserAllowList(
      ModelUserContext userContext, String userAllowListId, String[] tokensExpr) throws Exception {
  ...
  protected UserAllowList present(
      ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> tokens)
      throws Exception {
  ...
  public UserAllowList loadUserAllowListDetail(ModelUserContext userContext, String userAllowListId)
      throws Exception {
  ...
  protected UserAllowList loadUserAllowList(
      ModelUserContext userContext, String userAllowListId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfUserAllowList(userAllowListId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // UserAllowList userAllowList, Map<String, Object> tokens){

  @Override
  public List<UserAllowList> searchUserAllowListList(
      ModelUserContext ctx, UserAllowListRequest pRequest) {
  ...
  public UserAllowList clone(ModelUserContext userContext, String fromUserAllowListId)
      throws Exception {
  ...
  public UserAllowList internalSaveUserAllowList(
      ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> options)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherDomain(
      ModelUserContext userContext, String userAllowListId, String anotherDomainId)
      throws Exception {
  ...
  public UserAllowList forgetByAll(
      ModelUserContext userContext, String userAllowListId, int userAllowListVersion)
      throws Exception {
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, UserAllowList newCreated)
      throws Exception {
  ...
  public UserAllowList updateUserRole(
      ModelUserContext ctx, String userIdentity, String roleName, boolean add) throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<UserAllowList> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
