...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.userdomain.CandidateUserDomain;import com.doublechaintech.model.userdomain.UserDomain;import com.doublechaintech.model.utils.ModelAssurance;
...
public class UserAllowListManagerImpl extends CustomModelCheckerManager implements UserAllowListManager, BusinessHandler{
	...
	@Override
	public UserAllowListDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws UserAllowListManagerException{
 	...
 	protected UserAllowList saveUserAllowList(ModelUserContext userContext, UserAllowList userAllowList, String [] tokensExpr) throws Exception{
 	...
 	protected UserAllowList saveUserAllowListDetail(ModelUserContext userContext, UserAllowList userAllowList) throws Exception{
 	...
 	public UserAllowList loadUserAllowList(ModelUserContext userContext, String userAllowListId, String [] tokensExpr) throws Exception{
 	 ...
 	 public UserAllowList searchUserAllowList(ModelUserContext userContext, String userAllowListId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected UserAllowList present(ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> tokens) throws Exception {
 	...
 	public UserAllowList loadUserAllowListDetail(ModelUserContext userContext, String userAllowListId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String userAllowListId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String userAllowListId) throws Exception{
		UserAllowList userAllowList = loadUserAllowList( userContext, userAllowListId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String userAllowListId) throws Exception{
 	...
 	protected UserAllowList saveUserAllowList(ModelUserContext userContext, UserAllowList userAllowList, Map<String,Object>tokens) throws Exception{
 	
 		return userAllowListDaoOf(userContext).save(userAllowList, tokens);
 	}
 	protected UserAllowList loadUserAllowList(ModelUserContext userContext, String userAllowListId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfUserAllowList(userAllowListId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, UserAllowList userAllowList, Map<String, Object> tokens){
  ...
  @Override
  public List<UserAllowList> searchUserAllowListList(ModelUserContext ctx, UserAllowListRequest pRequest){
  ...
  @Override
  public UserAllowList searchUserAllowList(ModelUserContext ctx, UserAllowListRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingUserAllowList(ModelUserContext userContext,String userAllowListId, int userAllowListVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UserAllowList clone(ModelUserContext userContext, String fromUserAllowListId) throws Exception{
	...
	public UserAllowList internalSaveUserAllowList(ModelUserContext userContext, UserAllowList userAllowList, Map<String,Object> options) throws Exception
	{
	...
	public UserAllowList updateUserAllowListProperty(ModelUserContext userContext,String userAllowListId, int userAllowListVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUserAllowList(userContext, userAllowListId, userAllowListVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(ModelUserContext userContext, String userAllowListId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public UserAllowList forgetByAll(ModelUserContext userContext, String userAllowListId, int userAllowListVersion) throws Exception {
		return forgetByAllInternal(userContext, userAllowListId, userAllowListVersion);
	}
	protected UserAllowList forgetByAllInternal(ModelUserContext userContext,
  ...
  protected String getRootUserDomainId(ModelUserContext ctx) {
    return "UD000001";
  }
  ...
  public UserAllowList getByIdentity(ModelUserContext ctx, String userIdentity){
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<UserAllowList> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String userAllowListId) throws Exception{
