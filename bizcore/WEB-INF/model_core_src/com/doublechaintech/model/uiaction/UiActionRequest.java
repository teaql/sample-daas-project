...
import com.doublechaintech.model.page.PageRequest;



import java.util.stream.Collectors;
import static com.doublechaintech.model.uiaction.UiAction.*;

public class UiActionRequest extends BaseRequest<UiAction> {
    public static UiActionRequest newInstance() {
        return new UiActionRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public UiActionRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public UiActionRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,CODE_PROPERTY,ICON_PROPERTY,TITLE_PROPERTY,DISPLAY_ORDER_PROPERTY,BRIEF_PROPERTY,IMAGE_URL_PROPERTY,LINK_TO_URL_PROPERTY,EXTRA_DATA_PROPERTY,PAGE_PROPERTY,VERSION_PROPERTY};
   ...
   public UiActionRequest count(){
    ...
    public UiActionRequest whereDisplayOrderIsNotNull() {
      ...
      public UiActionRequest whereDisplayOrderBetween(Integer displayOrderStart, Integer displayOrderEnd) {
