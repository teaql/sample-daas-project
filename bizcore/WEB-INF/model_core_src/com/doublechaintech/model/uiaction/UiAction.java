...
public void transferAllRelationshipsTo(UiAction target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(CODE_PROPERTY, "code", "编码")
...
return getId();
	...
	public UiAction updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getCode();
	...
	public UiAction updateCode(String code){String oldCode = this.code;String newCode = trimString(code);if(!shouldReplaceBy(newCode, oldCode)){return this;}this.code = newCode;if (cn.hutool.core.util.ObjectUtil.equals(newCode, oldCode)){
        return this;
      }addPropertyChange(CODE_PROPERTY, oldCode, newCode);this.changed = true;setChecked(false);return this;}
...
return getIcon();
	...
	public UiAction updateIcon(String icon){String oldIcon = this.icon;String newIcon = trimString(icon);if(!shouldReplaceBy(newIcon, oldIcon)){return this;}this.icon = newIcon;if (cn.hutool.core.util.ObjectUtil.equals(newIcon, oldIcon)){
        return this;
      }addPropertyChange(ICON_PROPERTY, oldIcon, newIcon);this.changed = true;setChecked(false);return this;}
...
return getTitle();
	...
	public UiAction updateTitle(String title){String oldTitle = this.title;String newTitle = trimString(title);if(!shouldReplaceBy(newTitle, oldTitle)){return this;}this.title = newTitle;if (cn.hutool.core.util.ObjectUtil.equals(newTitle, oldTitle)){
        return this;
...
return getDisplayOrder();
	...
	public UiAction updateDisplayOrder(int displayOrder){int oldDisplayOrder = this.displayOrder;int newDisplayOrder = displayOrder;if(!shouldReplaceBy(newDisplayOrder, oldDisplayOrder)){return this;}this.displayOrder = newDisplayOrder;if (cn.hutool.core.util.ObjectUtil.equals(newDisplayOrder, oldDisplayOrder)){
        return this;
      }addPropertyChange(DISPLAY_ORDER_PROPERTY, oldDisplayOrder, newDisplayOrder);this.changed = true;setChecked(false);return this;}
...
return getBrief();
	...
	public UiAction updateBrief(String brief){String oldBrief = this.brief;String newBrief = trimString(brief);if(!shouldReplaceBy(newBrief, oldBrief)){return this;}this.brief = newBrief;if (cn.hutool.core.util.ObjectUtil.equals(newBrief, oldBrief)){
        return this;
      }addPropertyChange(BRIEF_PROPERTY, oldBrief, newBrief);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeBrief(String brief){
		if(brief != null) { updateBrief(brief);}
	}
...
return getImageUrl();
	...
	public UiAction updateImageUrl(String imageUrl){String oldImageUrl = this.imageUrl;String newImageUrl = trimString(encodeUrl(imageUrl));;if(!shouldReplaceBy(newImageUrl, oldImageUrl)){return this;}this.imageUrl = newImageUrl;if (cn.hutool.core.util.ObjectUtil.equals(newImageUrl, oldImageUrl)){
        return this;
      }addPropertyChange(IMAGE_URL_PROPERTY, oldImageUrl, newImageUrl);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeImageUrl(String imageUrl){
		if(imageUrl != null) { updateImageUrl(imageUrl);}
	}
...
return getLinkToUrl();
	...
	public UiAction updateLinkToUrl(String linkToUrl){String oldLinkToUrl = this.linkToUrl;String newLinkToUrl = trimString(linkToUrl);if(!shouldReplaceBy(newLinkToUrl, oldLinkToUrl)){return this;}this.linkToUrl = newLinkToUrl;if (cn.hutool.core.util.ObjectUtil.equals(newLinkToUrl, oldLinkToUrl)){
        return this;
      }addPropertyChange(LINK_TO_URL_PROPERTY, oldLinkToUrl, newLinkToUrl);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeLinkToUrl(String linkToUrl){
		if(linkToUrl != null) { updateLinkToUrl(linkToUrl);}
	}
...
return getExtraData();
	...
	public UiAction updateExtraData(String extraData){String oldExtraData = this.extraData;String newExtraData = extraData;if(!shouldReplaceBy(newExtraData, oldExtraData)){return this;}this.extraData = newExtraData;if (cn.hutool.core.util.ObjectUtil.equals(newExtraData, oldExtraData)){
        return this;
      }addPropertyChange(EXTRA_DATA_PROPERTY, oldExtraData, newExtraData);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeExtraData(String extraData){
		if(extraData != null) { updateExtraData(extraData);}
	}
...
return getPage();
	...
	public UiAction updatePage(Page page){Page oldPage = this.page;Page newPage = page;if(!shouldReplaceBy(newPage, oldPage)){return this;}this.page = newPage;if (cn.hutool.core.util.ObjectUtil.equals(newPage, oldPage)){
        return this;
      }addPropertyChange(PAGE_PROPERTY, oldPage, newPage);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergePage(Page page){
		if(page != null) { updatePage(page);}
	}

	
  public  UiAction updatePageByReferenceId(String pageId){ updatePage(Page.refById(pageId)); return this;}
...
return getVersion();
	...
	public UiAction updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
