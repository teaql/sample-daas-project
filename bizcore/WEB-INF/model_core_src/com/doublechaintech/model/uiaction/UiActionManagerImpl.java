...
public class UiActionManagerImpl extends CustomModelCheckerManager implements UiActionManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws UiActionManagerException{
 	...
 	protected UiAction saveUiAction(ModelUserContext userContext, UiAction uiAction, String [] tokensExpr) throws Exception{
 	...
 	protected UiAction saveUiActionDetail(ModelUserContext userContext, UiAction uiAction) throws Exception{


 		return saveUiAction(userContext, uiAction, allTokens());
 	}

 	public UiAction loadUiAction(ModelUserContext userContext, String uiActionId, String [] tokensExpr) throws Exception{
 	 ...
 	 public UiAction searchUiAction(ModelUserContext userContext, String uiActionId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected UiAction present(ModelUserContext userContext, UiAction uiAction, Map<String, Object> tokens) throws Exception {
 	...
 	public UiAction loadUiActionDetail(ModelUserContext userContext, String uiActionId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	protected UiAction saveUiAction(ModelUserContext userContext, UiAction uiAction, Map<String,Object>tokens) throws Exception{
 	
 		return uiActionDaoOf(userContext).save(uiAction, tokens);
 	}
 	protected UiAction loadUiAction(ModelUserContext userContext, String uiActionId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfUiAction(uiActionId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, UiAction uiAction, Map<String, Object> tokens){
  ...
  public UiAction searchUiAction(ModelUserContext ctx, UiActionRequest pRequest){
	...
	public UiAction createUiAction(ModelUserContext userContext, String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData,String pageId) throws Exception
	{
	...
	protected void checkParamsForUpdatingUiAction(ModelUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public UiAction internalSaveUiAction(ModelUserContext userContext, UiAction uiAction) throws Exception
	{
		return internalSaveUiAction(userContext, uiAction, allTokens());

	}
	public UiAction internalSaveUiAction(ModelUserContext userContext, UiAction uiAction, Map<String,Object> options) throws Exception
	{
	...
	public UiAction updateUiAction(ModelUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	public UiAction updateUiActionProperty(ModelUserContext userContext,String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingUiAction(userContext, uiActionId, uiActionVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPage(ModelUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
 	...
 	public UiAction transferToAnotherPage(ModelUserContext userContext, String uiActionId, String anotherPageId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public UiAction forgetByAll(ModelUserContext userContext, String uiActionId, int uiActionVersion) throws Exception {
		return forgetByAllInternal(userContext, uiActionId, uiActionVersion);
	}
	protected UiAction forgetByAllInternal(ModelUserContext userContext,
	...
	public void onNewInstanceCreated(ModelUserContext userContext, UiAction newCreated) throws Exception{
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<UiAction> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
