  ...
  static {
    ...
    internalLoaderMap.put(
        ...
        new BasicLoader() {
          ...
          @Override
          public SmartList<Community> queryList(DAOGroup daoGoup, String sql, Object... parmeters)
              throws Exception {
          ...
          public List<BaseEntity> wrapperList(DAOGroup daoGoup, List<String> ids) throws Exception {
            return ids.stream()
                .map(id -> (BaseEntity) Community.withId(id))
    ...
    internalLoaderMap.put(
        ...
        new BasicLoader() {
          ...
          @Override
          public SmartList<Family> queryList(DAOGroup daoGoup, String sql, Object... parmeters)
              throws Exception {
          ...
          public List<BaseEntity> wrapperList(DAOGroup daoGoup, List<String> ids) throws Exception {
            return ids.stream()
                .map(id -> (BaseEntity) Family.withId(id))
                .collect(Collectors.toList());
          }
        });
    ...
    internalLoaderMap.put(
        ...
        new BasicLoader() {
          ...
          @Override
          public SmartList<Kid> queryList(DAOGroup daoGoup, String sql, Object... parmeters)
              throws Exception {
