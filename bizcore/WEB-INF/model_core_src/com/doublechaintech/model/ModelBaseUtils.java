...
public class ModelBaseUtils {
  ...
  protected static BaseEntity loadCanCacheInLocal(
      ModelUserContext userContext, String type, String id) throws Exception {
  ...
  public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(
      ModelUserContext userContext, BaseEntity rootObject, Class<T> clazz) throws Exception {
  ...
  public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(
      ModelUserContext userContext, SmartList<? extends BaseEntity> rootObjectList, Class<T> clazz)
      throws Exception {
    return collectReferencedObjectWithType(userContext, (List<BaseEntity>) rootObjectList, clazz);
  }

  public static <T extends BaseEntity> List<T> collectReferencedObjectWithType(
      ModelUserContext userContext, List<? extends BaseEntity> rootObjectList, Class<T> clazz)
      throws Exception {
    List<T> referedObject = new LinkedList<>();
    Set<Object> checkedObject = new HashSet<>();
  ...
  public static <T> T loadBaseEntityById(ModelUserContext ctx, String type, String id)
      throws Exception {
    return loadBaseEntityById(ctx, type, id, null);
  }

  public static <T> T loadBaseEntityById(
      ModelUserContext ctx, String type, String id, Consumer<T> enhancer) throws Exception {
    String key = type + ":" + id;
  ...
  public static <T extends BaseEntity> void appendLinkToUrl(
      ModelUserContext ctx, List<T> list, Function<T, String> makeFunc) {
  ...
  public static <T extends BaseEntity> void appendLinkToUrl(
      ModelUserContext ctx, T obj, String url) {
    if (obj == null) {
      return;
    }
  ...
  public static ButtonViewComponent addAction(
      ModelUserContext ctx, BaseEntity obj, String title, String code, String linkToUrl) {
  ...
  public static void ensureTable(
    ...
    Map<String, Object> checkResult =
        DBChecker.verifyTable(
            "model", tableName, title, fieldInfo, indexSqls, constraintSqls, querier);
  ...
  public static <T extends BaseEntity> T reloadSelf(ModelUserContext ctx, T pItem)
      throws Exception {
