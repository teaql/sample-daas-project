...
public class ModelNamingServiceDAO extends CommonJDBCTemplateDAO {

  private static Map<String, String[]> namingTableMap;

  static {
    namingTableMap = new HashMap<String, String[]>();
    namingTableMap.put("Community", new String[] {"community_data", "name"});
    namingTableMap.put("Family", new String[] {"family_data", "name"});
    namingTableMap.put("Kid", new String[] {"kid_data", "name"});
