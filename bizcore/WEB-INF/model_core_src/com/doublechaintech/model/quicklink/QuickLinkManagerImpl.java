...
public class QuickLinkManagerImpl extends CustomModelCheckerManager
  ...
  protected QuickLink saveQuickLink(
      ModelUserContext userContext, QuickLink quickLink, String[] tokensExpr) throws Exception {
  ...
  protected QuickLink saveQuickLinkDetail(ModelUserContext userContext, QuickLink quickLink)
      throws Exception {
  ...
  public QuickLink searchQuickLink(
      ModelUserContext userContext, String quickLinkId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected QuickLink present(
      ModelUserContext userContext, QuickLink quickLink, Map<String, Object> tokens)
      throws Exception {
  ...
  public QuickLink loadQuickLinkDetail(ModelUserContext userContext, String quickLinkId)
      throws Exception {
  ...
  protected QuickLink loadQuickLink(
      ModelUserContext userContext, String quickLinkId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfQuickLink(quickLinkId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // QuickLink quickLink, Map<String, Object> tokens){
  ...
  public QuickLink internalSaveQuickLink(
      ModelUserContext userContext, QuickLink quickLink, Map<String, Object> options)
      throws Exception {
  ...
  public QuickLink forgetByAll(
      ModelUserContext userContext, String quickLinkId, int quickLinkVersion) throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<QuickLink> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
