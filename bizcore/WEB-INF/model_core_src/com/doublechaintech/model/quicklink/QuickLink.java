...
return getId();
	...
	public QuickLink updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public QuickLink updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getIcon();
	...
	public QuickLink updateIcon(String icon){String oldIcon = this.icon;String newIcon = trimString(icon);if(!shouldReplaceBy(newIcon, oldIcon)){return this;}this.icon = newIcon;if (cn.hutool.core.util.ObjectUtil.equals(newIcon, oldIcon)){
        return this;
...
return getImagePath();
	...
	public QuickLink updateImagePath(String imagePath){String oldImagePath = this.imagePath;String newImagePath = trimString(encodeUrl(imagePath));;if(!shouldReplaceBy(newImagePath, oldImagePath)){return this;}this.imagePath = newImagePath;if (cn.hutool.core.util.ObjectUtil.equals(newImagePath, oldImagePath)){
        return this;
...
return this;
	...
	public void mergeImagePath(String imagePath){
		if(imagePath != null) { updateImagePath(imagePath);}
	}
...
return getLinkTarget();
	...
	public QuickLink updateLinkTarget(String linkTarget){String oldLinkTarget = this.linkTarget;String newLinkTarget = trimString(linkTarget);if(!shouldReplaceBy(newLinkTarget, oldLinkTarget)){return this;}this.linkTarget = newLinkTarget;if (cn.hutool.core.util.ObjectUtil.equals(newLinkTarget, oldLinkTarget)){
        return this;
      }addPropertyChange(LINK_TARGET_PROPERTY, oldLinkTarget, newLinkTarget);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeLinkTarget(String linkTarget){
		if(linkTarget != null) { updateLinkTarget(linkTarget);}
	}
...
return getCreateTime();
	...
	public QuickLink updateCreateTime(DateTime createTime){DateTime oldCreateTime = this.createTime;DateTime newCreateTime = createTime;if(!shouldReplaceBy(newCreateTime, oldCreateTime)){return this;}this.createTime = newCreateTime;if (cn.hutool.core.util.ObjectUtil.equals(newCreateTime, oldCreateTime)){
        return this;
...
return getApp();
	...
	public QuickLink updateApp(UserApp app){UserApp oldApp = this.app;UserApp newApp = app;if(!shouldReplaceBy(newApp, oldApp)){return this;}this.app = newApp;if (cn.hutool.core.util.ObjectUtil.equals(newApp, oldApp)){
        return this;
...
return this;
  ...
  public  QuickLink updateAppByReferenceId(String appId){ updateApp(UserApp.refById(appId)); return this;}
...
return getVersion();
	...
	public QuickLink updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
