...
import static com.doublechaintech.model.quicklink.QuickLink.*;

public class QuickLinkRequest extends BaseRequest<QuickLink> {
    public static QuickLinkRequest newInstance() {
        return new QuickLinkRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public QuickLinkRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public QuickLinkRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NAME_PROPERTY,ICON_PROPERTY,IMAGE_PATH_PROPERTY,LINK_TARGET_PROPERTY,CREATE_TIME_PROPERTY,APP_PROPERTY,VERSION_PROPERTY};
