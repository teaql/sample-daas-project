...
public interface QuickLinkManager extends BaseManager{
  ...
  QuickLink searchQuickLink(ModelUserContext ctx, QuickLinkRequest pRequest);
	...
	public QuickLink internalSaveQuickLink(ModelUserContext userContext, QuickLink quickLink,Map<String,Object>option) throws Exception;
	...
	public default void onUpdated(ModelUserContext userContext, QuickLink updated, Object actor, String methodName) throws Exception {};
