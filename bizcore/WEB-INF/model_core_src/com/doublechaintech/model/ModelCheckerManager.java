...
public class ModelCheckerManager extends BaseManagerImpl {
  ...
  public Object queryCandidates(ModelUserContext userContext, CandidateQuery query)
      throws Exception {
    return new CandidatesUtil().queryCandidates(userContext, query);
  }

  public Object queryCandidatesForAssign(ModelUserContext userContext, CandidateQuery query)
      throws Exception {
    return new CandidatesUtil().queryCandidatesForAssign(userContext, query);
  }

  public Object queryCandidatesForSearch(ModelUserContext userContext, CandidateQuery query)
      throws Exception {
  ...
  public static void checkVerifyCode(ModelUserContext ctx, String inputVerifyCode, String mobile)
      throws Exception {
  ...
  public com.doublechaintech.model.community.CommunityManager communityManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getCommunityManager();
  }

  public com.doublechaintech.model.community.CommunityDAO communityDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getCommunityDAO();
  }

  public com.doublechaintech.model.family.FamilyManager familyManagerOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.mobileapp.MobileAppManager mobileAppManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getMobileAppManager();
  }

  public com.doublechaintech.model.mobileapp.MobileAppDAO mobileAppDaoOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.pagetype.PageTypeManager pageTypeManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getPageTypeManager();
  }

  public com.doublechaintech.model.pagetype.PageTypeDAO pageTypeDaoOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.uiaction.UiActionManager uiActionManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getUiActionManager();
  }

  public com.doublechaintech.model.uiaction.UiActionDAO uiActionDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getUiActionDAO();
  }

  public com.doublechaintech.model.section.SectionManager sectionManagerOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.userdomain.UserDomainManager userDomainManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getUserDomainManager();
  }

  public com.doublechaintech.model.userdomain.UserDomainDAO userDomainDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getUserDomainDAO();
  }

  public com.doublechaintech.model.userallowlist.UserAllowListManager userAllowListManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getUserAllowListManager();
  }

  public com.doublechaintech.model.userallowlist.UserAllowListDAO userAllowListDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getUserAllowListDAO();
  }

  public com.doublechaintech.model.secuser.SecUserManager secUserManagerOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.userapp.UserAppManager userAppManagerOf(
      ModelUserContext userContext) {
  ...
  public com.doublechaintech.model.quicklink.QuickLinkManager quickLinkManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getQuickLinkManager();
  }

  public com.doublechaintech.model.quicklink.QuickLinkDAO quickLinkDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getQuickLinkDAO();
  }

  public com.doublechaintech.model.listaccess.ListAccessManager listAccessManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getListAccessManager();
  }

  public com.doublechaintech.model.listaccess.ListAccessDAO listAccessDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getListAccessDAO();
  }

  public com.doublechaintech.model.loginhistory.LoginHistoryManager loginHistoryManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getLoginHistoryManager();
  }

  public com.doublechaintech.model.loginhistory.LoginHistoryDAO loginHistoryDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getLoginHistoryDAO();
  }

  public com.doublechaintech.model.candidatecontainer.CandidateContainerManager
      candidateContainerManagerOf(ModelUserContext userContext) {
    return userContext.getManagerGroup().getCandidateContainerManager();
  }

  public com.doublechaintech.model.candidatecontainer.CandidateContainerDAO candidateContainerDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getCandidateContainerDAO();
  }

  public com.doublechaintech.model.candidateelement.CandidateElementManager
      candidateElementManagerOf(ModelUserContext userContext) {
    return userContext.getManagerGroup().getCandidateElementManager();
  }

  public com.doublechaintech.model.candidateelement.CandidateElementDAO candidateElementDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getCandidateElementDAO();
  }

  public com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentityManager
      wechatWorkappIdentityManagerOf(ModelUserContext userContext) {
    return userContext.getManagerGroup().getWechatWorkappIdentityManager();
  }

  public com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentityDAO
      wechatWorkappIdentityDaoOf(ModelUserContext userContext) {
    return userContext.getDAOGroup().getWechatWorkappIdentityDAO();
  }

  public com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentityManager
      wechatMiniappIdentityManagerOf(ModelUserContext userContext) {
    return userContext.getManagerGroup().getWechatMiniappIdentityManager();
  }

  public com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentityDAO
      wechatMiniappIdentityDaoOf(ModelUserContext userContext) {
    return userContext.getDAOGroup().getWechatMiniappIdentityDAO();
  }

  public com.doublechaintech.model.keypairidentity.KeyPairIdentityManager keyPairIdentityManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getKeyPairIdentityManager();
  }

  public com.doublechaintech.model.keypairidentity.KeyPairIdentityDAO keyPairIdentityDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getKeyPairIdentityDAO();
  }

  public com.doublechaintech.model.publickeytype.PublicKeyTypeManager publicKeyTypeManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getPublicKeyTypeManager();
  }

  public com.doublechaintech.model.publickeytype.PublicKeyTypeDAO publicKeyTypeDaoOf(
      ModelUserContext userContext) {
    return userContext.getDAOGroup().getPublicKeyTypeDAO();
  }

  public com.doublechaintech.model.treenode.TreeNodeManager treeNodeManagerOf(
      ModelUserContext userContext) {
    return userContext.getManagerGroup().getTreeNodeManager();
  }

  public com.doublechaintech.model.treenode.TreeNodeDAO treeNodeDaoOf(
      ModelUserContext userContext) {
  ...
  protected void checkDateNow(
      Date likeTime, int i, Object now, String targetFieldName, ModelException exception) {}
