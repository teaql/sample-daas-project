...
public class ModelPropertyMapper {
  ...
  public static void registerCreator(
      Class beanClass, CreationScene scene, ModelBeanCreator creator) {
    registerCreator(beanClass, null, null, creator);
  }

  public static void registerCreator(
      Class beanClass, CreationScene scene, String propertyName, ModelBeanCreator creator) {
  ...
  public <T> ModelBeanCreator<T> findCustomCreator(
