...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.publickeytype.CandidatePublicKeyType;import com.doublechaintech.model.publickeytype.PublicKeyType;import com.doublechaintech.model.secuser.CandidateSecUser;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class KeyPairIdentityManagerImpl extends CustomModelCheckerManager implements KeyPairIdentityManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws KeyPairIdentityManagerException{
 	...
 	protected KeyPairIdentity saveKeyPairIdentity(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, String [] tokensExpr) throws Exception{
 	...
 	protected KeyPairIdentity saveKeyPairIdentityDetail(ModelUserContext userContext, KeyPairIdentity keyPairIdentity) throws Exception{


 		return saveKeyPairIdentity(userContext, keyPairIdentity, allTokens());
 	}

 	public KeyPairIdentity loadKeyPairIdentity(ModelUserContext userContext, String keyPairIdentityId, String [] tokensExpr) throws Exception{
 	 ...
 	 public KeyPairIdentity searchKeyPairIdentity(ModelUserContext userContext, String keyPairIdentityId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected KeyPairIdentity present(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String, Object> tokens) throws Exception {
 	...
 	public KeyPairIdentity loadKeyPairIdentityDetail(ModelUserContext userContext, String keyPairIdentityId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String keyPairIdentityId) throws Exception{
		KeyPairIdentity keyPairIdentity = loadKeyPairIdentity( userContext, keyPairIdentityId, viewTokens());
 	...
 	protected KeyPairIdentity saveKeyPairIdentity(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String,Object>tokens) throws Exception{
 	
 		return keyPairIdentityDaoOf(userContext).save(keyPairIdentity, tokens);
 	}
 	protected KeyPairIdentity loadKeyPairIdentity(ModelUserContext userContext, String keyPairIdentityId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfKeyPairIdentity(keyPairIdentityId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String, Object> tokens){
  ...
  @Override
  public List<KeyPairIdentity> searchKeyPairIdentityList(ModelUserContext ctx, KeyPairIdentityRequest pRequest){
  ...
  @Override
  public KeyPairIdentity searchKeyPairIdentity(ModelUserContext ctx, KeyPairIdentityRequest pRequest){
    pRequest.limit(0, 1);
	...
	public KeyPairIdentity createKeyPairIdentity(ModelUserContext userContext, String publicKey,String keyTypeId,String secUserId) throws Exception
	{
	...
	protected void checkParamsForUpdatingKeyPairIdentity(ModelUserContext userContext,String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public KeyPairIdentity clone(ModelUserContext userContext, String fromKeyPairIdentityId) throws Exception{

		return keyPairIdentityDaoOf(userContext).clone(fromKeyPairIdentityId, this.allTokens());
	}

	public KeyPairIdentity internalSaveKeyPairIdentity(ModelUserContext userContext, KeyPairIdentity keyPairIdentity) throws Exception
	{
		return internalSaveKeyPairIdentity(userContext, keyPairIdentity, allTokens());

	}
	public KeyPairIdentity internalSaveKeyPairIdentity(ModelUserContext userContext, KeyPairIdentity keyPairIdentity, Map<String,Object> options) throws Exception
	{
	...
	public KeyPairIdentity updateKeyPairIdentity(ModelUserContext userContext,String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKeyPairIdentity(userContext, keyPairIdentityId, keyPairIdentityVersion, property, newValueExpr, tokensExpr);
	...
	public KeyPairIdentity updateKeyPairIdentityProperty(ModelUserContext userContext,String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKeyPairIdentity(userContext, keyPairIdentityId, keyPairIdentityVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherKeyType(ModelUserContext userContext, String keyPairIdentityId, String anotherKeyTypeId) throws Exception
 	{
 	...
 	public KeyPairIdentity transferToAnotherKeyType(ModelUserContext userContext, String keyPairIdentityId, String anotherKeyTypeId) throws Exception
 	{
	...
	public CandidatePublicKeyType requestCandidateKeyType(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherSecUser(ModelUserContext userContext, String keyPairIdentityId, String anotherSecUserId) throws Exception
 	{
 	...
 	public KeyPairIdentity transferToAnotherSecUser(ModelUserContext userContext, String keyPairIdentityId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(ModelUserContext userContext, String keyPairIdentityId, String anotherLogin) throws Exception
 	{
 	...
 	public KeyPairIdentity transferToAnotherSecUserWithLogin(ModelUserContext userContext, String keyPairIdentityId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(ModelUserContext userContext, String keyPairIdentityId, String anotherEmail) throws Exception
 	{
 	...
 	public KeyPairIdentity transferToAnotherSecUserWithEmail(ModelUserContext userContext, String keyPairIdentityId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(ModelUserContext userContext, String keyPairIdentityId, String anotherMobile) throws Exception
 	{
 	...
 	public KeyPairIdentity transferToAnotherSecUserWithMobile(ModelUserContext userContext, String keyPairIdentityId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
 	...
 	protected PublicKeyType loadPublicKeyType(ModelUserContext userContext, String newKeyTypeId, Map<String,Object> options) throws Exception
 	{
	...
	public KeyPairIdentity forgetByAll(ModelUserContext userContext, String keyPairIdentityId, int keyPairIdentityVersion) throws Exception {
		return forgetByAllInternal(userContext, keyPairIdentityId, keyPairIdentityVersion);
	}
	protected KeyPairIdentity forgetByAllInternal(ModelUserContext userContext,
	...
	public void onNewInstanceCreated(ModelUserContext userContext, KeyPairIdentity newCreated) throws Exception{
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<KeyPairIdentity> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PublicKeyType> keyTypeList = ModelBaseUtils.collectReferencedObjectWithType(userContext, list, PublicKeyType.class);
	...
	public Object listPageByKeyType(ModelUserContext userContext,String keyTypeId, int start, int count) throws Exception {
