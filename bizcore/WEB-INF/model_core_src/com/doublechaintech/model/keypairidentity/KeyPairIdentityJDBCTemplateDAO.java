...
public class KeyPairIdentityJDBCTemplateDAO extends ModelBaseDAOImpl implements KeyPairIdentityDAO{
  ...
  public Stream<KeyPairIdentity> loadAllAsStream() {
	...
	protected List<Object[]> prepareKeyPairIdentityBatchRecoverArgs(List<KeyPairIdentity> keyPairIdentityList){
	...
	protected List<Object[]> prepareKeyPairIdentityBatchRemoveArgs(List<KeyPairIdentity> keyPairIdentityList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitKeyPairIdentityList(List<KeyPairIdentity> keyPairIdentityList){
      ...
      if(keyPairIdentity.isToRecover()){
		...
		return new Object[]{keyPairIdentityCreateList,
