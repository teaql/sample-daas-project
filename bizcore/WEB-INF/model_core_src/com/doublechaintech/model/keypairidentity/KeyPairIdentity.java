...
public void transferAllRelationshipsTo(KeyPairIdentity target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(KEY_TYPE_PROPERTY, "public_key_type", "密钥类型")
...
return getId();
	...
	public KeyPairIdentity updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getPublicKey();
	...
	public KeyPairIdentity updatePublicKey(String publicKey){String oldPublicKey = this.publicKey;String newPublicKey = publicKey;if(!shouldReplaceBy(newPublicKey, oldPublicKey)){return this;}this.publicKey = newPublicKey;if (cn.hutool.core.util.ObjectUtil.equals(newPublicKey, oldPublicKey)){
        return this;
      }addPropertyChange(PUBLIC_KEY_PROPERTY, oldPublicKey, newPublicKey);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergePublicKey(String publicKey){
		if(publicKey != null) { updatePublicKey(publicKey);}
	}
...
return getKeyType();
	...
	public KeyPairIdentity updateKeyType(PublicKeyType keyType){PublicKeyType oldKeyType = this.keyType;PublicKeyType newKeyType = keyType;if(!shouldReplaceBy(newKeyType, oldKeyType)){return this;}this.keyType = newKeyType;if (cn.hutool.core.util.ObjectUtil.equals(newKeyType, oldKeyType)){
        return this;
      }addPropertyChange(KEY_TYPE_PROPERTY, oldKeyType, newKeyType);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeKeyType(PublicKeyType keyType){
		if(keyType != null) { updateKeyType(keyType);}
	}

	
  public  KeyPairIdentity updateKeyTypeByReferenceId(String keyTypeId){ updateKeyType(PublicKeyType.refById(keyTypeId)); return this;}
...
return getSecUser();
	...
	public KeyPairIdentity updateSecUser(SecUser secUser){SecUser oldSecUser = this.secUser;SecUser newSecUser = secUser;if(!shouldReplaceBy(newSecUser, oldSecUser)){return this;}this.secUser = newSecUser;if (cn.hutool.core.util.ObjectUtil.equals(newSecUser, oldSecUser)){
        return this;
...
return this;
  ...
  public  KeyPairIdentity updateSecUserByReferenceId(String secUserId){ updateSecUser(SecUser.refById(secUserId)); return this;}
...
return getCreateTime();
	...
	public KeyPairIdentity updateCreateTime(DateTime createTime){DateTime oldCreateTime = this.createTime;DateTime newCreateTime = createTime;if(!shouldReplaceBy(newCreateTime, oldCreateTime)){return this;}this.createTime = newCreateTime;if (cn.hutool.core.util.ObjectUtil.equals(newCreateTime, oldCreateTime)){
        return this;
...
return getVersion();
	...
	public KeyPairIdentity updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
