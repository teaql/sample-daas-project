...
import static com.doublechaintech.model.keypairidentity.KeyPairIdentity.*;

public class KeyPairIdentityRequest extends BaseRequest<KeyPairIdentity> {
    public static KeyPairIdentityRequest newInstance() {
        return new KeyPairIdentityRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public KeyPairIdentityRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public KeyPairIdentityRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,PUBLIC_KEY_PROPERTY,KEY_TYPE_PROPERTY,SEC_USER_PROPERTY,CREATE_TIME_PROPERTY,VERSION_PROPERTY};
