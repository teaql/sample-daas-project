...
public void transferAllRelationshipsTo(Page target){
     ...
     target.addSlideList(this.getSlideList());target.addUiActionList(this.getUiActionList());target.addSectionList(this.getSectionList());
 }
...
return getId();
	...
	public Page updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getPageTitle();
	...
	public Page updatePageTitle(String pageTitle){String oldPageTitle = this.pageTitle;String newPageTitle = trimString(pageTitle);if(!shouldReplaceBy(newPageTitle, oldPageTitle)){return this;}this.pageTitle = newPageTitle;if (cn.hutool.core.util.ObjectUtil.equals(newPageTitle, oldPageTitle)){
        return this;
      }addPropertyChange(PAGE_TITLE_PROPERTY, oldPageTitle, newPageTitle);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergePageTitle(String pageTitle){
		if(pageTitle != null) { updatePageTitle(pageTitle);}
	}
...
return getLinkToUrl();
	...
	public Page updateLinkToUrl(String linkToUrl){String oldLinkToUrl = this.linkToUrl;String newLinkToUrl = trimString(linkToUrl);if(!shouldReplaceBy(newLinkToUrl, oldLinkToUrl)){return this;}this.linkToUrl = newLinkToUrl;if (cn.hutool.core.util.ObjectUtil.equals(newLinkToUrl, oldLinkToUrl)){
        return this;
...
return getPageType();
	...
	public Page updatePageType(PageType pageType){PageType oldPageType = this.pageType;PageType newPageType = pageType;if(!shouldReplaceBy(newPageType, oldPageType)){return this;}this.pageType = newPageType;if (cn.hutool.core.util.ObjectUtil.equals(newPageType, oldPageType)){
        return this;
      }addPropertyChange(PAGE_TYPE_PROPERTY, oldPageType, newPageType);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergePageType(PageType pageType){
		if(pageType != null) { updatePageType(pageType);}
	}

	
  public  Page updatePageTypeByReferenceId(String pageTypeId){ updatePageType(PageType.refById(pageTypeId)); return this;}
	...
	public Page updatePageTypeToHome(){return updatePageTypeByReferenceId(PageType.HOME);}
	
	public Page updatePageTypeToMe(){return updatePageTypeByReferenceId(PageType.ME);}
	
	public Page updatePageTypeToGenericPage(){return updatePageTypeByReferenceId(PageType.GENERIC_PAGE);}
	
	public Page updatePageTypeToListofPage(){return updatePageTypeByReferenceId(PageType.LISTOF_PAGE);}
	
	public Page updatePageTypeToServiceCenter(){return updatePageTypeByReferenceId(PageType.SERVICE_CENTER);}
	
	public Page updatePageTypeToSimple(){return updatePageTypeByReferenceId(PageType.SIMPLE);}

	public boolean  isPageTypeHome(){return baseEntityIdEquals(getPageType(),PageType.HOME);}
	
	public boolean  isPageTypeMe(){return baseEntityIdEquals(getPageType(),PageType.ME);}
	
	public boolean  isPageTypeGenericPage(){return baseEntityIdEquals(getPageType(),PageType.GENERIC_PAGE);}
	
	public boolean  isPageTypeListofPage(){return baseEntityIdEquals(getPageType(),PageType.LISTOF_PAGE);}
	
	public boolean  isPageTypeServiceCenter(){return baseEntityIdEquals(getPageType(),PageType.SERVICE_CENTER);}
	
	public boolean  isPageTypeSimple(){return baseEntityIdEquals(getPageType(),PageType.SIMPLE);}
...
return getDisplayOrder();
	...
	public Page updateDisplayOrder(int displayOrder){int oldDisplayOrder = this.displayOrder;int newDisplayOrder = displayOrder;if(!shouldReplaceBy(newDisplayOrder, oldDisplayOrder)){return this;}this.displayOrder = newDisplayOrder;if (cn.hutool.core.util.ObjectUtil.equals(newDisplayOrder, oldDisplayOrder)){
        return this;
...
return getMobileApp();
	...
	public Page updateMobileApp(MobileApp mobileApp){MobileApp oldMobileApp = this.mobileApp;MobileApp newMobileApp = mobileApp;if(!shouldReplaceBy(newMobileApp, oldMobileApp)){return this;}this.mobileApp = newMobileApp;if (cn.hutool.core.util.ObjectUtil.equals(newMobileApp, oldMobileApp)){
        return this;
      }addPropertyChange(MOBILE_APP_PROPERTY, oldMobileApp, newMobileApp);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeMobileApp(MobileApp mobileApp){
		if(mobileApp != null) { updateMobileApp(mobileApp);}
	}

	
  public  Page updateMobileAppByReferenceId(String mobileAppId){ updateMobileApp(MobileApp.refById(mobileAppId)); return this;}
...
return getVersion();
	...
	public Page updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
