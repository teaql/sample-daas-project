...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.mobileapp.CandidateMobileApp;import com.doublechaintech.model.mobileapp.MobileApp;import com.doublechaintech.model.page.Page;import com.doublechaintech.model.pagetype.CandidatePageType;import com.doublechaintech.model.pagetype.PageType;import com.doublechaintech.model.section.Section;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.slide.Slide;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.uiaction.UiAction;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class PageManagerImpl extends CustomModelCheckerManager implements PageManager, BusinessHandler{
	...
	@Override
	public PageDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PageManagerException{
 	...
 	protected Page savePage(ModelUserContext userContext, Page page, String [] tokensExpr) throws Exception{
 	...
 	protected Page savePageDetail(ModelUserContext userContext, Page page) throws Exception{
 	...
 	public Page loadPage(ModelUserContext userContext, String pageId, String [] tokensExpr) throws Exception{
 	 ...
 	 public Page searchPage(ModelUserContext userContext, String pageId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected Page present(ModelUserContext userContext, Page page, Map<String, Object> tokens) throws Exception {
 	...
 	public Page loadPageDetail(ModelUserContext userContext, String pageId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String pageId) throws Exception{
 		Page page = loadPage( userContext, pageId, viewTokens());
 		markVisited(userContext, page);
 		return present(userContext,page, viewTokens());

	 }
	 public Object summaryView(ModelUserContext userContext, String pageId) throws Exception{
		Page page = loadPage( userContext, pageId, viewTokens());
		page.summarySuffix();
		markVisited(userContext, page);
	 ...
	 public Object analyze(ModelUserContext userContext, String pageId) throws Exception{
		Page page = loadPage( userContext, pageId, analyzeTokens());
		markVisited(userContext, page);
		return present(userContext,page, analyzeTokens());

	}
 	protected Page savePage(ModelUserContext userContext, Page page, Map<String,Object>tokens) throws Exception{
 	
 		return pageDaoOf(userContext).save(page, tokens);
 	}
 	protected Page loadPage(ModelUserContext userContext, String pageId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfPage(pageId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Page page, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Page page, Map<String, Object> tokens){
  ...
  @Override
  public List<Page> searchPageList(ModelUserContext ctx, PageRequest pRequest){
  ...
  @Override
  public Page searchPage(ModelUserContext ctx, PageRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingPage(ModelUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Page clone(ModelUserContext userContext, String fromPageId) throws Exception{
	...
	public Page internalSavePage(ModelUserContext userContext, Page page, Map<String,Object> options) throws Exception
	{
	...
	public Page updatePageProperty(ModelUserContext userContext,String pageId, int pageVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPage(userContext, pageId, pageVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherPageType(ModelUserContext userContext, String pageId, String anotherPageTypeId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherPageTypeWithCode(ModelUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
 	...
 	public Page transferToAnotherPageTypeWithCode(ModelUserContext userContext, String pageId, String anotherCode) throws Exception
 	{
	...
	public CandidatePageType requestCandidatePageType(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 	...
 	protected void checkParamsForTransferingAnotherMobileApp(ModelUserContext userContext, String pageId, String anotherMobileAppId) throws Exception
 	{
	...
	public CandidateMobileApp requestCandidateMobileApp(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
 ...
 //--------------------------------------------------------------
 	...
 	protected PageType loadPageType(ModelUserContext userContext, String newPageTypeId, Map<String,Object> options) throws Exception
 	{
 	...
 	protected PageType loadPageTypeWithCode(ModelUserContext userContext, String newCode, Map<String,Object> options) throws Exception
 	{
 	...
 	protected MobileApp loadMobileApp(ModelUserContext userContext, String newMobileAppId, Map<String,Object> options) throws Exception
 	{
	...
	public Page forgetByAll(ModelUserContext userContext, String pageId, int pageVersion) throws Exception {
		return forgetByAllInternal(userContext, pageId, pageVersion);
	}
	protected Page forgetByAllInternal(ModelUserContext userContext,
	...
	protected void checkParamsForAddingSlide(ModelUserContext userContext, String pageId, String name, int displayOrder, String imageUrl, String videoUrl, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlideProperties(ModelUserContext userContext, String pageId,String id,String name,int displayOrder,String imageUrl,String videoUrl,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSlideProperties(ModelUserContext userContext, String pageId, String id,String name,int displayOrder,String imageUrl,String videoUrl,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdateSlideProperties(ModelUserContext userContext, Slide item, String pageId, String id,String name,int displayOrder,String imageUrl,String videoUrl,String linkToUrl, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected Slide createSlide(ModelUserContext userContext, String name, int displayOrder, String imageUrl, String videoUrl, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSlideList(ModelUserContext userContext, String pageId,
	...
	public  Page removeSlideList(ModelUserContext userContext, String pageId,
			String slideIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSlide(ModelUserContext userContext, String pageId,
	...
	public  Page removeSlide(ModelUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSlide(ModelUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySlideFrom(ModelUserContext userContext, String pageId,
		String slideId, int slideVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSlide(ModelUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSlide(ModelUserContext userContext, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	protected void beforeUpdateSlide(ModelUserContext userContext, Slide existed, String pageId, String slideId, int slideVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
	...
	*/
	...
	protected void checkParamsForAddingUiAction(ModelUserContext userContext, String pageId, String code, String icon, String title, int displayOrder, String brief, String imageUrl, String linkToUrl, String extraData,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiActionProperties(ModelUserContext userContext, String pageId,String id,String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData,String [] tokensExpr) throws Exception {
	...
	public  Page updateUiActionProperties(ModelUserContext userContext, String pageId, String id,String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdateUiActionProperties(ModelUserContext userContext, UiAction item, String pageId, String id,String code,String icon,String title,int displayOrder,String brief,String imageUrl,String linkToUrl,String extraData, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected UiAction createUiAction(ModelUserContext userContext, String code, String icon, String title, int displayOrder, String brief, String imageUrl, String linkToUrl, String extraData) throws Exception{
	...
	protected void checkParamsForRemovingUiActionList(ModelUserContext userContext, String pageId,
	...
	public  Page removeUiActionList(ModelUserContext userContext, String pageId,
			String uiActionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingUiAction(ModelUserContext userContext, String pageId,
	...
	public  Page removeUiAction(ModelUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingUiAction(ModelUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copyUiActionFrom(ModelUserContext userContext, String pageId,
		String uiActionId, int uiActionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingUiAction(ModelUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateUiAction(ModelUserContext userContext, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	/** if you has something need to do before update data from DB, override this */
	protected void beforeUpdateUiAction(ModelUserContext userContext, UiAction existed, String pageId, String uiActionId, int uiActionVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
	...
	*/
	...
	protected void checkParamsForAddingSection(ModelUserContext userContext, String pageId, String title, String brief, String icon, int displayOrder, String viewGroup, String linkToUrl,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSectionProperties(ModelUserContext userContext, String pageId,String id,String title,String brief,String icon,int displayOrder,String viewGroup,String linkToUrl,String [] tokensExpr) throws Exception {
	...
	public  Page updateSectionProperties(ModelUserContext userContext, String pageId, String id,String title,String brief,String icon,int displayOrder,String viewGroup,String linkToUrl, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdateSectionProperties(ModelUserContext userContext, Section item, String pageId, String id,String title,String brief,String icon,int displayOrder,String viewGroup,String linkToUrl, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected Section createSection(ModelUserContext userContext, String title, String brief, String icon, int displayOrder, String viewGroup, String linkToUrl) throws Exception{
	...
	protected void checkParamsForRemovingSectionList(ModelUserContext userContext, String pageId,
	...
	public  Page removeSectionList(ModelUserContext userContext, String pageId,
			String sectionIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingSection(ModelUserContext userContext, String pageId,
	...
	public  Page removeSection(ModelUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingSection(ModelUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	public  Page copySectionFrom(ModelUserContext userContext, String pageId,
		String sectionId, int sectionVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingSection(ModelUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Page updateSection(ModelUserContext userContext, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	/** if you has something need to do before update data from DB, override this */
	protected void beforeUpdateSection(ModelUserContext userContext, Section existed, String pageId, String sectionId, int sectionVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<Page> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<PageType> pageTypeList = ModelBaseUtils.collectReferencedObjectWithType(userContext, list, PageType.class);
		userContext.getDAOGroup().enhanceList(pageTypeList, PageType.class);
		List<MobileApp> mobileAppList = ModelBaseUtils.collectReferencedObjectWithType(userContext, list, MobileApp.class);
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String pageId) throws Exception{
