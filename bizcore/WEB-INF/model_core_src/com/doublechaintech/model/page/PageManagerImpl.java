...
import com.doublechaintech.model.mobileapp.CandidateMobileApp;
import com.doublechaintech.model.mobileapp.MobileApp;
import com.doublechaintech.model.page.Page;
import com.doublechaintech.model.pagetype.CandidatePageType;
...
public class PageManagerImpl extends CustomModelCheckerManager
  ...
  protected Page savePage(ModelUserContext userContext, Page page, String[] tokensExpr)
      throws Exception {
  ...
  public Page loadPage(ModelUserContext userContext, String pageId, String[] tokensExpr)
      throws Exception {
  ...
  public Page searchPage(
      ModelUserContext userContext, String pageId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected Page present(ModelUserContext userContext, Page page, Map<String, Object> tokens)
      throws Exception {
  ...
  protected Page savePage(ModelUserContext userContext, Page page, Map<String, Object> tokens)
      throws Exception {

    return pageDaoOf(userContext).save(page, tokens);
  }

  protected Page loadPage(ModelUserContext userContext, String pageId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfPage(pageId);
  ...
  protected <T extends BaseEntity> void addActions(
      ModelUserContext userContext, Page page, Map<String, Object> tokens) {
    ...
    // Page page, Map<String, Object> tokens){
  ...
  public Page internalSavePage(ModelUserContext userContext, Page page, Map<String, Object> options)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherPageType(
      ModelUserContext userContext, String pageId, String anotherPageTypeId) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherPageTypeWithCode(
      ModelUserContext userContext, String pageId, String anotherCode) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherMobileApp(
      ModelUserContext userContext, String pageId, String anotherMobileAppId) throws Exception {
  ...
  protected PageType loadPageType(
      ModelUserContext userContext, String newPageTypeId, Map<String, Object> options)
      throws Exception {
  ...
  protected PageType loadPageTypeWithCode(
      ModelUserContext userContext, String newCode, Map<String, Object> options) throws Exception {

    return pageTypeDaoOf(userContext).loadByCode(newCode, options);
  }

  protected MobileApp loadMobileApp(
      ModelUserContext userContext, String newMobileAppId, Map<String, Object> options)
      throws Exception {
  ...
  public Page forgetByAll(ModelUserContext userContext, String pageId, int pageVersion)
      throws Exception {
    return forgetByAllInternal(userContext, pageId, pageVersion);
  }

  protected Page forgetByAllInternal(ModelUserContext userContext, String pageId, int pageVersion)
      throws Exception {
  ...
  protected void checkParamsForRemovingSlideList(
      ModelUserContext userContext, String pageId, String slideIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected void checkParamsForRemovingUiActionList(
      ModelUserContext userContext, String pageId, String uiActionIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected void checkParamsForRemovingSectionList(
      ModelUserContext userContext, String pageId, String sectionIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<Page> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<PageType> pageTypeList =
        ModelBaseUtils.collectReferencedObjectWithType(userContext, list, PageType.class);
    userContext.getDAOGroup().enhanceList(pageTypeList, PageType.class);
    List<MobileApp> mobileAppList =
        ModelBaseUtils.collectReferencedObjectWithType(userContext, list, MobileApp.class);
  ...
  public Object listPageByPageType(
      ModelUserContext userContext, String pageTypeId, int start, int count) throws Exception {
    SmartList<Page> list =
