...
public interface TreeService {
    ...
    default Node loadAncestors(ModelUserContext ctx, String nodeId, Class nodeClass) throws Exception {
    ...
    default Node addChild(ModelUserContext ctx, Node tree, String childId, Class childType) throws Exception {
