...
public abstract class BaseViewPage extends HashMap<String, Object> {
  ...
  @JsonIgnore protected ModelUserContext userContext;
  ...
  public void assemblerContent(ModelUserContext userContext, String requestName) throws Exception {
    setPageTitle("尚未实现");
  }

  public Object doRender(ModelUserContext userContext) {
  ...
  protected void error(String format, Object... params) throws ModelException {
    error_on(1, format, params);
  }

  protected void error_on(int upLevel, String format, Object... params) throws ModelException {
    StackTraceElement st = new Throwable().getStackTrace()[upLevel + 1];
    if (format != null) {
      format = String.format("[%s:%d] %s", st.getFileName(), st.getLineNumber(), format);
