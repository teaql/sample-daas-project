...
public class BaseRelation {
  ...
  protected void prepareRelationIndex() {
    ...
    addRelationIndex("Family", familyRelatedObjectNames);

    String[] kidRelatedObjectNames = {"family:Family"};
    addRelationIndex("Kid", kidRelatedObjectNames);
  ...
  protected void prepareRelation() {
    addGenericRelation("Family", TRUST_CHAIN_READ, "community");
    addGenericRelation("Kid", TRUST_CHAIN_READ, "family");
