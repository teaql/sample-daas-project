...
public class CommunityTable{
	...
	public static final String []ALL_CLOUMNS = {COLUMN_ID,COLUMN_NAME,COLUMN_ADDRESS,COLUMN_VERSION};
	public static final String []NORMAL_CLOUMNS = {COLUMN_NAME,COLUMN_ADDRESS};
	  ...
	  public static void ensureTable(ModelUserContext userContext, Map<String, Object> result) throws Exception {
        ModelBaseUtils.ensureTable(userContext, result, "community_data", new String[][]{
