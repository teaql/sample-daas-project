...
public class CommunityTokens extends CommonTokens{
  ...
  private static void addToken(CommunityTokens pTokens, String pTokenName, String[] pGroupNames, String[] fieldGroups) {
	...
	public static CommunityTokens filterWithTokenViewGroups(String []viewGroups){
		...
		return start()
			.withFamilyListIfViewGroupInclude(viewGroups);
