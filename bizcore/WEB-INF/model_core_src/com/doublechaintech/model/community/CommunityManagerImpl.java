...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.community.Community;import com.doublechaintech.model.family.Family;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.utils.ModelAssurance;
...
public class CommunityManagerImpl extends CustomModelCheckerManager implements CommunityManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws CommunityManagerException{
 	...
 	protected Community saveCommunity(ModelUserContext userContext, Community community, String [] tokensExpr) throws Exception{
 	...
 	protected Community saveCommunityDetail(ModelUserContext userContext, Community community) throws Exception{


 		return saveCommunity(userContext, community, allTokens());
 	}

 	public Community loadCommunity(ModelUserContext userContext, String communityId, String [] tokensExpr) throws Exception{
 	 ...
 	 public Community searchCommunity(ModelUserContext userContext, String communityId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected Community present(ModelUserContext userContext, Community community, Map<String, Object> tokens) throws Exception {
 	...
 	public Community loadCommunityDetail(ModelUserContext userContext, String communityId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	protected Community saveCommunity(ModelUserContext userContext, Community community, Map<String,Object>tokens) throws Exception{
 	
 		return communityDaoOf(userContext).save(community, tokens);
 	}
 	protected Community loadCommunity(ModelUserContext userContext, String communityId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfCommunity(communityId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Community community, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Community community, Map<String, Object> tokens){
  ...
  public Community searchCommunity(ModelUserContext ctx, CommunityRequest pRequest){
	...
	public Community createCommunity(ModelUserContext userContext, String name,String address) throws Exception
	{
	...
	protected void checkParamsForUpdatingCommunity(ModelUserContext userContext,String communityId, int communityVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Community internalSaveCommunity(ModelUserContext userContext, Community community) throws Exception
	{
		return internalSaveCommunity(userContext, community, allTokens());

	}
	public Community internalSaveCommunity(ModelUserContext userContext, Community community, Map<String,Object> options) throws Exception
	{
		//checkParamsForUpdatingCommunity(userContext, communityId, communityVersion, property, newValueExpr, tokensExpr);
	...
	public Community updateCommunity(ModelUserContext userContext,String communityId, int communityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCommunity(userContext, communityId, communityVersion, property, newValueExpr, tokensExpr);
		...
		if(community.getVersion() != communityVersion){
			String message = "The target version("+community.getVersion()+") is not equals to version("+communityVersion+") provided";
	...
	public Community updateCommunityProperty(ModelUserContext userContext,String communityId, int communityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingCommunity(userContext, communityId, communityVersion, property, newValueExpr, tokensExpr);
	...
	protected Map<String,Object> viewTokens(){
		...
		.sortFamilyListWith(Family.ID_PROPERTY,sortDesc())
		.done();
...
//--------------------------------------------------------------
	...
	public Community forgetByAll(ModelUserContext userContext, String communityId, int communityVersion) throws Exception {
		return forgetByAllInternal(userContext, communityId, communityVersion);
	}
	protected Community forgetByAllInternal(ModelUserContext userContext,
			String communityId, int communityVersion) throws Exception{
	...
	protected void checkParamsForAddingFamily(ModelUserContext userContext, String communityId, String name,String [] tokensExpr) throws Exception{
	...
	public  Community addFamily(ModelUserContext userContext, String communityId, String name, String [] tokensExpr) throws Exception
	{
	...
	protected void checkParamsForUpdatingFamilyProperties(ModelUserContext userContext, String communityId,String id,String name,String [] tokensExpr) throws Exception {
	...
	public  Community updateFamilyProperties(ModelUserContext userContext, String communityId, String id,String name, String [] tokensExpr) throws Exception
	{
		...
		Map<String, Object> options = tokens()
				.allTokens()
				//.withFamilyListList()
				.searchFamilyListWith(Family.ID_PROPERTY, tokens().is(), id).done();
		...
		Community community = saveCommunity(userContext, communityToUpdate, tokens().withFamilyList().done());
		synchronized(community){
			return present(userContext,community, mergedAllTokens(tokensExpr));
		}
	}

	protected  void beforeUpdateFamilyProperties(ModelUserContext userContext, Family item, String communityId, String id,String name, String [] tokensExpr)
						throws Exception {
	...
	protected void checkParamsForRemovingFamilyList(ModelUserContext userContext, String communityId,
			String familyIds[],String [] tokensExpr) throws Exception {
	...
	public  Community removeFamilyList(ModelUserContext userContext, String communityId,
			String familyIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingFamily(ModelUserContext userContext, String communityId,
		String familyId, int familyVersion,String [] tokensExpr) throws Exception{
	...
	public  Community removeFamily(ModelUserContext userContext, String communityId,
		String familyId, int familyVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingFamily(ModelUserContext userContext, String communityId,
		String familyId, int familyVersion,String [] tokensExpr) throws Exception{
	...
	public  Community copyFamilyFrom(ModelUserContext userContext, String communityId,
		String familyId, int familyVersion,String [] tokensExpr) throws Exception{
		...
		synchronized(community){
			...
			familyManagerOf(userContext).onNewInstanceCreated(userContext, (Family)community.getFlexiableObjects().get(BaseEntity.COPIED_CHILD));
			return present(userContext,community, mergedAllTokens(tokensExpr));
		}

	}

	protected void checkParamsForUpdatingFamily(ModelUserContext userContext, String communityId, String familyId, int familyVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  Community updateFamily(ModelUserContext userContext, String communityId, String familyId, int familyVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{

		checkParamsForUpdatingFamily(userContext, communityId, familyId, familyVersion, property, newValueExpr,  tokensExpr);

		Map<String,Object> loadTokens = this.tokens().withFamilyList().searchFamilyListWith(Family.ID_PROPERTY, tokens().equals(), familyId).done();
		...
		synchronized(community){
			...
			beforeUpdateFamily(userContext, family, communityId, familyId, familyVersion, property, newValueExpr,  tokensExpr);
	...
	protected void beforeUpdateFamily(ModelUserContext userContext, Family existed, String communityId, String familyId, int familyVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
	...
	*/
	...
	public void onNewInstanceCreated(ModelUserContext userContext, Community newCreated) throws Exception{
  ...
  public void sendAllItems(ModelUserContext ctx) throws Exception{
    communityDaoOf(ctx).loadAllAsStream().forEach(
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<Community> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
    ...
    String pageTitle = "社区"+"详情";
		...
		Map familyListSection = ListofUtils.buildSection(
		    "familyListSection",
		    "家庭列表",
		    null,
		    "",
