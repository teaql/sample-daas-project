...
public class CommunityJDBCTemplateDAO extends ModelBaseDAOImpl implements CommunityDAO{
  ...
  public Stream<Community> loadAllAsStream() {
	...
	protected Community extractCommunity(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
		try{
	...
	protected Community loadInternalCommunity(AccessKey accessKey, Map<String,Object> loadOptions) throws Exception{
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitCommunityList(List<Community> communityList){
      ...
      if(community.isToRecover()){
		...
		return new Object[]{communityCreateList,
      communityUpdateList,
      communityRemoveList,
      communityRecoverList
    };
	}
   ...
   saveCommunity(community);
	...
	public Community planToRemoveFamilyList(Community community, String familyIds[], Map<String,Object> options)throws Exception{
		...
		SmartList<Family> externalFamilyList = getFamilyDAO().
				findFamilyWithKey(key, options);
	...
	//Using java8 feature to reduce the code significantly
 	protected Community presentFamilyList(
			Community community,
			Map<String, Object> options) {
    
		SmartList<Family> familyList = community.getFamilyList();
				SmartList<Family> newList= presentSubList(community.getId(),
				familyList,
				options,
    ...
    public SmartList<Community> requestCandidateCommunityForFamily(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo, int pageSize) throws Exception {
		...
		return findAllCandidateByFilter(CommunityTable.COLUMN_NAME, null, filterKey, pageNo, pageSize, getCommunityMapper());
    }
	...
	@Override
	public SmartList<Community> findCommunityWithKey(MultipleAccessKey key,
			Map<String, Object> options) {
	...
	@Override
	public int countCommunityWithKey(MultipleAccessKey key,
			Map<String, Object> options) {
