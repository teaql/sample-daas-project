...
public void transferAllRelationshipsTo(Community target){
  ...
  memberMetaInfoList.add(MemberMetaInfo.referBy(FAMILY_LIST, "community", "家庭列表")
  ...
  /*
	...
	public Object propertyOf(String property) {
		...
		if(FAMILY_LIST.equals(property)){
			List<BaseEntity> list = getFamilyList().stream().map(item->item).collect(Collectors.toList());
			return list;
		}
...
return getId();
	...
	public Community updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return createCriteria(ID_PROPERTY, operator, parameters);
	...
	public Community ignoreIdCriteria(){super.ignoreSearchProperty(ID_PROPERTY);
return this;
}
...
return getName();
	...
	public Community updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return createCriteria(NAME_PROPERTY, operator, parameters);
	...
	public Community ignoreNameCriteria(){super.ignoreSearchProperty(NAME_PROPERTY);
return this;
}
...
return getAddress();
	...
	public Community updateAddress(String address){String oldAddress = this.address;String newAddress = trimString(address);if(!shouldReplaceBy(newAddress, oldAddress)){return this;}this.address = newAddress;if (cn.hutool.core.util.ObjectUtil.equals(newAddress, oldAddress)){
        return this;
      }addPropertyChange(ADDRESS_PROPERTY, oldAddress, newAddress);this.changed = true;setChecked(false);return this;}
...
return createCriteria(ADDRESS_PROPERTY, operator, parameters);
	...
	public Community ignoreAddressCriteria(){super.ignoreSearchProperty(ADDRESS_PROPERTY);
return this;
}
...
return getVersion();
	...
	public Community updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
...
return createCriteria(VERSION_PROPERTY, operator, parameters);
	...
	public Community ignoreVersionCriteria(){super.ignoreSearchProperty(VERSION_PROPERTY);
return this;
}
...
return this;
  ...
  public  SmartList<Family> familyList(){
	...
	public  Family removeFamily(Family familyIndex){
        ...
        if(index < 0){
        	String message = "Family("+familyIndex.getId()+") with version='"+familyIndex.getVersion()+"' NOT found!";
	...
	public  Family findTheFamily(Family family){
		...
		if(index < 0){
 			String message = "Family("+family.getId()+") with version='"+family.getVersion()+"' NOT found!";
			throw new IllegalStateException(message);
		}
