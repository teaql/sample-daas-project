...
public class CommunityRequest extends BaseRequest<Community> {
  ...
  public CommunityRequest addDynamicProperty(
  ...
  public CommunityRequest selectAll() {
    return this.selectId().selectName().selectAddress().selectVersion();
  }

  public CommunityRequest selectAny() {
    return selectAll().selectFamilyList(Q.family().selectSelf());
  }
  ...
  protected static final String[] ALL_SELF_FIELDS = {
    ID_PROPERTY, NAME_PROPERTY, ADDRESS_PROPERTY, VERSION_PROPERTY
  };
  ...
  public CommunityRequest hasFamily(Family... family) {
    ...
    return hasFamily(
        Q.family()
            .select(Family.COMMUNITY_PROPERTY)
            .filterById(QueryOperator.IN, (Object[]) family));
  }
  ...
  public CommunityRequest hasFamily(FamilyRequest family) {
    return hasFamily(
        family,
        $family ->
            java.util.Optional.of($family)
                .map(Family::getCommunity)
                .map(Community::getId)
                .orElse(null));
  }
  ...
  public CommunityRequest hasFamily(
    ...
    return addSearchCriteria(
        new AggregationCriteria(family, Family.COMMUNITY_PROPERTY, queryOperator, value));
  }
