...
public class WechatMiniprogramHandler extends BaseIdentificationHandler {
	...
	protected boolean authenticateWithCode(ModelUserContext userContext, String code, LoginResult result) throws Exception{
		    String openId = null;
		    String unionId = null;
        String userSessionKey = null;
        boolean runSimLogin = false;
        if (!userContext.isProductEnvironment()){
          LoginParam loginParam = ((ModelBizUserContextImpl) userContext).getLoginParam();
	...
	@Override
	public void bindWithSecUser(ModelUserContext userContext, LoginContext loginContext) throws Exception {
	...
	protected SmartList<WechatMiniappIdentity> getIdentifyRecords(ModelUserContext userContext,
