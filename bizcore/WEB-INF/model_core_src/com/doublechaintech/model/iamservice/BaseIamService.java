...
public abstract class BaseIamService {
  ...
  public LoginResult doLogin(
      ModelUserContextImpl userContext, LoginContext loginContext, BusinessHandler bizHandler)
      throws Exception {
  ...
  public Object doLogout(ModelUserContextImpl userContext, BusinessHandler bizHandler)
      throws Exception {
    // 回调业务
  ...
  protected void onAuthenticateNewUserLogged(
      ModelUserContextImpl userContext,
  ...
  protected IdentificationHandler selectIdentificationHandler(
      ModelUserContextImpl userContext, LoginContext loginContext) {
    if (loginContext.getLoginMethod().equals(LoginMethod.ID_4_DEBUG)) {
      return new IdentificationHandler() {

        @Override
        public LoginResult authenticate(ModelUserContext userContext, LoginContext loginContext) {
          ...
          UserApp userApp =
              ModelUserContextImpl.getUserAppByBindedEntity(
  ...
  public void onCheckAccessWhenAnonymousFound(
      ModelUserContextImpl userContext, Map<String, Object> loginInfo) {
  ...
  public Object forceLoginAs(
      ModelUserContextImpl userContext, BaseEntity loginTarget, BusinessHandler bizHandler)
      throws Exception {
