...
public class WechatMobileHandler extends BaseIdentificationHandler {
  ...
  public static String getSessionKeyCacheKey(ModelUserContext ctx) {
    return ctx.tokenId() + "_session_key";
  }

  public Object wxlogin(ModelUserContext ctx, String code) throws Exception {
  ...
  private void autoCreateWechatMiniAppIfNeeded(ModelUserContext userContext, SecUser secUser, LoginContext loginContext) {
    if (secUser == null){
      return;
    }
