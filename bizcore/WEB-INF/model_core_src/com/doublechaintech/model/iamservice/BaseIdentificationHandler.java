...
public abstract class BaseIdentificationHandler implements IdentificationHandler{
	...
	protected String getVeriyCodeCacheKey(ModelUserContext userContext, String mobile) {
		return String.format("vcode:%s:%s", mobile, "login");
	}

	protected String getWehatSessionKeyCacheKey(ModelUserContext userContext, String appId, String openId) {
