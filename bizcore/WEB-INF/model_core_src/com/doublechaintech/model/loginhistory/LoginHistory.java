...
return getId();
	...
	public LoginHistory updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getLoginTime();
	...
	public LoginHistory updateLoginTime(DateTime loginTime){DateTime oldLoginTime = this.loginTime;DateTime newLoginTime = loginTime;if(!shouldReplaceBy(newLoginTime, oldLoginTime)){return this;}this.loginTime = newLoginTime;if (cn.hutool.core.util.ObjectUtil.equals(newLoginTime, oldLoginTime)){
        return this;
      }addPropertyChange(LOGIN_TIME_PROPERTY, oldLoginTime, newLoginTime);this.changed = true;setChecked(false);return this;}
...
return getFromIp();
	...
	public LoginHistory updateFromIp(String fromIp){String oldFromIp = this.fromIp;String newFromIp = trimString(fromIp);if(!shouldReplaceBy(newFromIp, oldFromIp)){return this;}this.fromIp = newFromIp;if (cn.hutool.core.util.ObjectUtil.equals(newFromIp, oldFromIp)){
        return this;
      }addPropertyChange(FROM_IP_PROPERTY, oldFromIp, newFromIp);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeFromIp(String fromIp){
		if(fromIp != null) { updateFromIp(fromIp);}
	}
...
return getDescription();
	...
	public LoginHistory updateDescription(String description){String oldDescription = this.description;String newDescription = trimString(description);if(!shouldReplaceBy(newDescription, oldDescription)){return this;}this.description = newDescription;if (cn.hutool.core.util.ObjectUtil.equals(newDescription, oldDescription)){
        return this;
      }addPropertyChange(DESCRIPTION_PROPERTY, oldDescription, newDescription);this.changed = true;setChecked(false);return this;}
...
return getSecUser();
	...
	public LoginHistory updateSecUser(SecUser secUser){SecUser oldSecUser = this.secUser;SecUser newSecUser = secUser;if(!shouldReplaceBy(newSecUser, oldSecUser)){return this;}this.secUser = newSecUser;if (cn.hutool.core.util.ObjectUtil.equals(newSecUser, oldSecUser)){
        return this;
...
return this;
  ...
  public  LoginHistory updateSecUserByReferenceId(String secUserId){ updateSecUser(SecUser.refById(secUserId)); return this;}
...
return getVersion();
	...
	public LoginHistory updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
