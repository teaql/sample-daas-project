...
public class ModelObjectChecker extends ModelChecker {
  ...
  public ModelChecker commonObjectElementCheck(
      BaseEntity target,
      String propertyName,
  ...
  public ModelObjectChecker checkAndFixCommunity(BaseEntity communityAsBaseEntity) {
    ...
    commonObjectPropertyCheck(
        communityAsBaseEntity, "familyList", this::checkFamilyListOfCommunity);
    return this;
  }
  ...
  public ModelObjectChecker checkAndFixKid(BaseEntity kidAsBaseEntity) {
    ...
    commonObjectPropertyCheck(kidAsBaseEntity, "age", this::checkAgeOfKid);
  ...
  public ModelObjectChecker checkAndFixCandidateContainer(
  ...
  public ModelObjectChecker checkAndFixWechatWorkappIdentity(
  ...
  public ModelObjectChecker checkAndFixWechatMiniappIdentity(
        ...
        .forEach(
            family ->
                commonObjectElementCheck(
                    family, wrapArrayIndex(index.getAndIncrement()), this::checkAndFixFamily));
    return this;
  }
  ...
  public ModelObjectChecker checkKidListOfFamily(List<BaseEntity> kidList) {
    ...
    kidList.stream()
        .forEach(
            kid ->
                commonObjectElementCheck(
                    kid, wrapArrayIndex(index.getAndIncrement()), this::checkAndFixKid));
    return this;
  }
  ...
  public ModelObjectChecker checkWechatWorkappIdentityListOfSecUser(
  ...
  public ModelObjectChecker checkWechatMiniappIdentityListOfSecUser(
  ...
  public ModelObjectChecker checkKeyPairIdentityListOfSecUser(
  ...
  public ModelObjectChecker checkCandidateElementListOfCandidateContainer(
  ...
  public ModelObjectChecker checkKeyPairIdentityListOfPublicKeyType(
      List<BaseEntity> keyPairIdentityList) {
    AtomicInteger index = new AtomicInteger();
    keyPairIdentityList.stream()
        .forEach(
