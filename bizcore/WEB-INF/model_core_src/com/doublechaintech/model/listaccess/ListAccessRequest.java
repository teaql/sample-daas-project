...
import static com.doublechaintech.model.listaccess.ListAccess.*;

public class ListAccessRequest extends BaseRequest<ListAccess> {
    public static ListAccessRequest newInstance() {
        return new ListAccessRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public ListAccessRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public ListAccessRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NAME_PROPERTY,INTERNAL_NAME_PROPERTY,READ_PERMISSION_PROPERTY,CREATE_PERMISSION_PROPERTY,DELETE_PERMISSION_PROPERTY,UPDATE_PERMISSION_PROPERTY,EXECUTION_PERMISSION_PROPERTY,APP_PROPERTY,VERSION_PROPERTY};
