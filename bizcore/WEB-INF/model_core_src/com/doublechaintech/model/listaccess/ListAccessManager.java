...
public interface ListAccessManager extends BaseManager {
  ...
  public ListAccess internalSaveListAccess(
      ModelUserContext userContext, ListAccess listAccess, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, ListAccess updated, Object actor, String methodName)
      throws Exception {};
