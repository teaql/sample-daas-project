...
public class ListAccessJDBCTemplateDAO extends ModelBaseDAOImpl implements ListAccessDAO{
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitListAccessList(List<ListAccess> listAccessList){
      ...
      if(listAccess.isToRecover()){
		...
		return new Object[]{listAccessCreateList,
      listAccessUpdateList,
      listAccessRemoveList,
      listAccessRecoverList
    };
	}
