...
public void transferAllRelationshipsTo(ListAccess target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(INTERNAL_NAME_PROPERTY, "internal_name", "内部名称")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(READ_PERMISSION_PROPERTY, "read_permission", "读权限")
        .withType("bool", "boolean"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(CREATE_PERMISSION_PROPERTY, "create_permission", "创建权限")
        .withType("bool", "boolean"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(DELETE_PERMISSION_PROPERTY, "delete_permission", "删除权限")
        .withType("bool", "boolean"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(UPDATE_PERMISSION_PROPERTY, "update_permission", "更新权限")
        .withType("bool", "boolean"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(EXECUTION_PERMISSION_PROPERTY, "execution_permission", "执行权限")
        .withType("bool", "boolean"));
...
return getId();
	...
	public ListAccess updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public ListAccess updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getInternalName();
	...
	public ListAccess updateInternalName(String internalName){String oldInternalName = this.internalName;String newInternalName = trimString(internalName);if(!shouldReplaceBy(newInternalName, oldInternalName)){return this;}this.internalName = newInternalName;if (cn.hutool.core.util.ObjectUtil.equals(newInternalName, oldInternalName)){
        return this;
      }addPropertyChange(INTERNAL_NAME_PROPERTY, oldInternalName, newInternalName);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeInternalName(String internalName){
		if(internalName != null) { updateInternalName(internalName);}
	}
...
return getDeletePermission();
	...
	public ListAccess updateDeletePermission(boolean deletePermission){boolean oldDeletePermission = this.deletePermission;boolean newDeletePermission = deletePermission;if(!shouldReplaceBy(newDeletePermission, oldDeletePermission)){return this;}this.deletePermission = newDeletePermission;if (cn.hutool.core.util.ObjectUtil.equals(newDeletePermission, oldDeletePermission)){
        return this;
      }addPropertyChange(DELETE_PERMISSION_PROPERTY, oldDeletePermission, newDeletePermission);this.changed = true;setChecked(false);return this;}
...
return getUpdatePermission();
	...
	public ListAccess updateUpdatePermission(boolean updatePermission){boolean oldUpdatePermission = this.updatePermission;boolean newUpdatePermission = updatePermission;if(!shouldReplaceBy(newUpdatePermission, oldUpdatePermission)){return this;}this.updatePermission = newUpdatePermission;if (cn.hutool.core.util.ObjectUtil.equals(newUpdatePermission, oldUpdatePermission)){
        return this;
      }addPropertyChange(UPDATE_PERMISSION_PROPERTY, oldUpdatePermission, newUpdatePermission);this.changed = true;setChecked(false);return this;}
...
return getApp();
	...
	public ListAccess updateApp(UserApp app){UserApp oldApp = this.app;UserApp newApp = app;if(!shouldReplaceBy(newApp, oldApp)){return this;}this.app = newApp;if (cn.hutool.core.util.ObjectUtil.equals(newApp, oldApp)){
        return this;
      }addPropertyChange(APP_PROPERTY, oldApp, newApp);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeApp(UserApp app){
		if(app != null) { updateApp(app);}
	}

	
  public  ListAccess updateAppByReferenceId(String appId){ updateApp(UserApp.refById(appId)); return this;}
...
return getVersion();
	...
	public ListAccess updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
