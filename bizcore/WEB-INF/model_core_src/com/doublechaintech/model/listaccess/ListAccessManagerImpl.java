...
import com.doublechaintech.model.userapp.CandidateUserApp;
...
public class ListAccessManagerImpl extends CustomModelCheckerManager
  ...
  protected ListAccess saveListAccess(
      ModelUserContext userContext, ListAccess listAccess, String[] tokensExpr) throws Exception {
  ...
  protected ListAccess saveListAccessDetail(ModelUserContext userContext, ListAccess listAccess)
      throws Exception {
  ...
  public ListAccess loadListAccess(
      ModelUserContext userContext, String listAccessId, String[] tokensExpr) throws Exception {
  ...
  public ListAccess searchListAccess(
      ModelUserContext userContext, String listAccessId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected ListAccess present(
      ModelUserContext userContext, ListAccess listAccess, Map<String, Object> tokens)
      throws Exception {
  ...
  public ListAccess loadListAccessDetail(ModelUserContext userContext, String listAccessId)
      throws Exception {
  ...
  protected ListAccess loadListAccess(
      ModelUserContext userContext, String listAccessId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfListAccess(listAccessId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // ListAccess listAccess, Map<String, Object> tokens){
  ...
  public ListAccess internalSaveListAccess(ModelUserContext userContext, ListAccess listAccess)
      throws Exception {
    return internalSaveListAccess(userContext, listAccess, allTokens());
  }

  public ListAccess internalSaveListAccess(
      ModelUserContext userContext, ListAccess listAccess, Map<String, Object> options)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherApp(
      ModelUserContext userContext, String listAccessId, String anotherAppId) throws Exception {
  ...
  protected UserApp loadUserApp(
      ModelUserContext userContext, String newAppId, Map<String, Object> options) throws Exception {
  ...
  public ListAccess forgetByAll(
      ModelUserContext userContext, String listAccessId, int listAccessVersion) throws Exception {
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, ListAccess newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<ListAccess> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<UserApp> appList =
        ModelBaseUtils.collectReferencedObjectWithType(userContext, list, UserApp.class);
