...
public abstract class SecUserExpression<T> implements Expression<T, SecUser> {
   ...
   public com.doublechaintech.model.loginhistory.LoginHistorySmartListExpression<T> getLoginHistoryList() {
   ...
   public com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentitySmartListExpression<T> getWechatWorkappIdentityList() {
       return new com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentitySmartListExpression<T>(){
   ...
   public com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentitySmartListExpression<T> getWechatMiniappIdentityList() {
       return new com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentitySmartListExpression<T>(){
   ...
   public com.doublechaintech.model.keypairidentity.KeyPairIdentitySmartListExpression<T> getKeyPairIdentityList() {
