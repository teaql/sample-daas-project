...
public void transferAllRelationshipsTo(SecUser target){
     ...
     target.addUserAppList(this.getUserAppList());target.addLoginHistoryList(this.getLoginHistoryList());target.addWechatWorkappIdentityList(this.getWechatWorkappIdentityList());target.addWechatMiniappIdentityList(this.getWechatMiniappIdentityList());target.addKeyPairIdentityList(this.getKeyPairIdentityList());
 }
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(LOGIN_PROPERTY, "login", "登录")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(MOBILE_PROPERTY, "mobile", "手机号码")
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(WEIXIN_OPENID_PROPERTY, "weixin_openid", "微信openid")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(WEIXIN_APPID_PROPERTY, "weixin_appid", "微信Appid")
        .withType("string", String.class));
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(VERIFICATION_CODE_PROPERTY, "verification_code", "验证码")
        .withType("int", "int"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(VERIFICATION_CODE_EXPIRE_PROPERTY, "verification_code_expire", "验证码过期")
...
return getId();
	...
	public SecUser updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getLogin();
	...
	public SecUser updateLogin(String login){String oldLogin = this.login;String newLogin = trimString(login);if(!shouldReplaceBy(newLogin, oldLogin)){return this;}this.login = newLogin;if (cn.hutool.core.util.ObjectUtil.equals(newLogin, oldLogin)){
        return this;
      }addPropertyChange(LOGIN_PROPERTY, oldLogin, newLogin);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeLogin(String login){
		if(login != null) { updateLogin(login);}
	}
...
return getMobile();
	...
	public SecUser updateMobile(String mobile){String oldMobile = this.mobile;String newMobile = trimString(mobile);if(!shouldReplaceBy(newMobile, oldMobile)){return this;}this.mobile = newMobile;if (cn.hutool.core.util.ObjectUtil.equals(newMobile, oldMobile)){
        return this;
      }addPropertyChange(MOBILE_PROPERTY, oldMobile, newMobile);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeMobile(String mobile){
		if(mobile != null) { updateMobile(mobile);}
	}
...
return getEmail();
	...
	public SecUser updateEmail(String email){String oldEmail = this.email;String newEmail = trimString(email);if(!shouldReplaceBy(newEmail, oldEmail)){return this;}this.email = newEmail;if (cn.hutool.core.util.ObjectUtil.equals(newEmail, oldEmail)){
        return this;
      }addPropertyChange(EMAIL_PROPERTY, oldEmail, newEmail);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeWeixinOpenid(String weixinOpenid){
		if(weixinOpenid != null) { updateWeixinOpenid(weixinOpenid);}
	}
...
return getWeixinAppid();
	...
	public SecUser updateWeixinAppid(String weixinAppid){String oldWeixinAppid = this.weixinAppid;String newWeixinAppid = trimString(weixinAppid);if(!shouldReplaceBy(newWeixinAppid, oldWeixinAppid)){return this;}this.weixinAppid = newWeixinAppid;if (cn.hutool.core.util.ObjectUtil.equals(newWeixinAppid, oldWeixinAppid)){
        return this;
      }addPropertyChange(WEIXIN_APPID_PROPERTY, oldWeixinAppid, newWeixinAppid);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeWeixinAppid(String weixinAppid){
		if(weixinAppid != null) { updateWeixinAppid(weixinAppid);}
	}
...
return getAccessToken();
	...
	public SecUser updateAccessToken(String accessToken){String oldAccessToken = this.accessToken;String newAccessToken = trimString(accessToken);if(!shouldReplaceBy(newAccessToken, oldAccessToken)){return this;}this.accessToken = newAccessToken;if (cn.hutool.core.util.ObjectUtil.equals(newAccessToken, oldAccessToken)){
        return this;
      }addPropertyChange(ACCESS_TOKEN_PROPERTY, oldAccessToken, newAccessToken);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeAccessToken(String accessToken){
		if(accessToken != null) { updateAccessToken(accessToken);}
	}
...
return getVerificationCode();
	...
	public SecUser updateVerificationCode(int verificationCode){int oldVerificationCode = this.verificationCode;int newVerificationCode = verificationCode;if(!shouldReplaceBy(newVerificationCode, oldVerificationCode)){return this;}this.verificationCode = newVerificationCode;if (cn.hutool.core.util.ObjectUtil.equals(newVerificationCode, oldVerificationCode)){
        return this;
      }addPropertyChange(VERIFICATION_CODE_PROPERTY, oldVerificationCode, newVerificationCode);this.changed = true;setChecked(false);return this;}
...
return getVerificationCodeExpire();
	...
	public SecUser updateVerificationCodeExpire(DateTime verificationCodeExpire){DateTime oldVerificationCodeExpire = this.verificationCodeExpire;DateTime newVerificationCodeExpire = verificationCodeExpire;if(!shouldReplaceBy(newVerificationCodeExpire, oldVerificationCodeExpire)){return this;}this.verificationCodeExpire = newVerificationCodeExpire;if (cn.hutool.core.util.ObjectUtil.equals(newVerificationCodeExpire, oldVerificationCodeExpire)){
        return this;
      }addPropertyChange(VERIFICATION_CODE_EXPIRE_PROPERTY, oldVerificationCodeExpire, newVerificationCodeExpire);this.changed = true;setChecked(false);return this;}
...
return getLastLoginTime();
	...
	public SecUser updateLastLoginTime(DateTime lastLoginTime){DateTime oldLastLoginTime = this.lastLoginTime;DateTime newLastLoginTime = lastLoginTime;if(!shouldReplaceBy(newLastLoginTime, oldLastLoginTime)){return this;}this.lastLoginTime = newLastLoginTime;if (cn.hutool.core.util.ObjectUtil.equals(newLastLoginTime, oldLastLoginTime)){
        return this;
      }addPropertyChange(LAST_LOGIN_TIME_PROPERTY, oldLastLoginTime, newLastLoginTime);this.changed = true;setChecked(false);return this;}
...
return getDomain();
	...
	public SecUser updateDomain(UserDomain domain){UserDomain oldDomain = this.domain;UserDomain newDomain = domain;if(!shouldReplaceBy(newDomain, oldDomain)){return this;}this.domain = newDomain;if (cn.hutool.core.util.ObjectUtil.equals(newDomain, oldDomain)){
        return this;
      }addPropertyChange(DOMAIN_PROPERTY, oldDomain, newDomain);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeDomain(UserDomain domain){
		if(domain != null) { updateDomain(domain);}
	}

	
  public  SecUser updateDomainByReferenceId(String domainId){ updateDomain(UserDomain.refById(domainId)); return this;}
...
return getVersion();
	...
	public SecUser updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
