...
import com.doublechaintech.model.keypairidentity.KeyPairIdentityRequest;
import com.doublechaintech.model.loginhistory.LoginHistoryRequest;
import com.doublechaintech.model.userapp.UserAppRequest;
import com.doublechaintech.model.userdomain.UserDomainRequest;
import com.doublechaintech.model.wechatminiappidentity.WechatMiniappIdentityRequest;
import com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentityRequest;



import java.util.stream.Collectors;
import static com.doublechaintech.model.secuser.SecUser.*;

public class SecUserRequest extends BaseRequest<SecUser> {
    public static SecUserRequest newInstance() {
        return new SecUserRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public SecUserRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public SecUserRequest selectAny() {return selectAll().selectUserAppList(Q.userApp().selectSelf()).selectLoginHistoryList(Q.loginHistory().selectSelf()).selectWechatWorkappIdentityList(Q.wechatWorkappIdentity().selectSelf()).selectWechatMiniappIdentityList(Q.wechatMiniappIdentity().selectSelf()).selectKeyPairIdentityList(Q.keyPairIdentity().selectSelf());
        }
    ...
    protected static final String[] DATE_OR_TIME_FIELDS={VERIFICATION_CODE_EXPIRE_PROPERTY,LAST_LOGIN_TIME_PROPERTY};
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,LOGIN_PROPERTY,MOBILE_PROPERTY,EMAIL_PROPERTY,PWD_PROPERTY,WEIXIN_OPENID_PROPERTY,WEIXIN_APPID_PROPERTY,ACCESS_TOKEN_PROPERTY,VERIFICATION_CODE_PROPERTY,VERIFICATION_CODE_EXPIRE_PROPERTY,LAST_LOGIN_TIME_PROPERTY,DOMAIN_PROPERTY,VERSION_PROPERTY};
   ...
   public SecUserRequest count(){
    ...
    public SecUserRequest whereVerificationCodeIsNotNull() {
      ...
      public SecUserRequest whereVerificationCodeBetween(Integer verificationCodeStart, Integer verificationCodeEnd) {
          if (ObjectUtil.isEmpty(verificationCodeStart)) {
               throw new IllegalArgumentException("Method whereVerificationCodeBetween, the parameter verificationCodeStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(verificationCodeEnd)) {
               throw new IllegalArgumentException("Method whereVerificationCodeBetween, the parameter verificationCodeEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getVerificationCodeSearchCriteria(QueryOperator.BETWEEN,  new Object[]{verificationCodeStart, verificationCodeEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereVerificationCodeLessThan(Integer verificationCode) {
          if (ObjectUtil.isEmpty(verificationCode)) {
              throw new IllegalArgumentException("Method whereVerificationCodeLessThan, the parameter verificationCode is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getVerificationCodeSearchCriteria(QueryOperator.LESS_THAN, new Object[]{verificationCode});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereVerificationCodeGreaterThan(int verificationCode) {
          if (ObjectUtil.isEmpty(verificationCode)) {
              throw new IllegalArgumentException("Method whereVerificationCodeGreaterThan, the parameter verificationCode is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getVerificationCodeSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{verificationCode});
          return addSearchCriteria(searchCriteria);
      }
    ...
    public SecUserRequest whereVerificationCodeExpireIsNotNull() {
      ...
      public SecUserRequest whereVerificationCodeExpireBetween(Date verificationCodeExpireStart, Date verificationCodeExpireEnd) {
          if (ObjectUtil.isEmpty(verificationCodeExpireStart)) {
               throw new IllegalArgumentException("Method whereVerificationCodeExpireBetween, the parameter verificationCodeExpireStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(verificationCodeExpireEnd)) {
               throw new IllegalArgumentException("Method whereVerificationCodeExpireBetween, the parameter verificationCodeExpireEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getVerificationCodeExpireSearchCriteria(QueryOperator.BETWEEN,  new Object[]{verificationCodeExpireStart, verificationCodeExpireEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereVerificationCodeExpireBefore(Date verificationCodeExpire) {
          ...
          if (ObjectUtil.isEmpty(verificationCodeExpire)) {
               throw new IllegalArgumentException("Method whereVerificationCodeExpireBefore, the parameter verificationCodeExpire is not allowed  to be null.");
          }

          SearchCriteria searchCriteria = getVerificationCodeExpireSearchCriteria(QueryOperator.LESS_THAN, new Object[]{verificationCodeExpire});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereVerificationCodeExpireAfter(DateTime verificationCodeExpire) {
          if (ObjectUtil.isEmpty(verificationCodeExpire)) {
              throw new IllegalArgumentException("Method whereVerificationCodeExpireAfter, the parameter verificationCodeExpire is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getVerificationCodeExpireSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{verificationCodeExpire});
          return addSearchCriteria(searchCriteria);
      }
    ...
    public SecUserRequest whereLastLoginTimeIsNotNull() {
      ...
      public SecUserRequest whereLastLoginTimeBetween(Date lastLoginTimeStart, Date lastLoginTimeEnd) {
          if (ObjectUtil.isEmpty(lastLoginTimeStart)) {
               throw new IllegalArgumentException("Method whereLastLoginTimeBetween, the parameter lastLoginTimeStart is not allowed  to be null.");
          }
          if (ObjectUtil.isEmpty(lastLoginTimeEnd)) {
               throw new IllegalArgumentException("Method whereLastLoginTimeBetween, the parameter lastLoginTimeEnd is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getLastLoginTimeSearchCriteria(QueryOperator.BETWEEN,  new Object[]{lastLoginTimeStart, lastLoginTimeEnd});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereLastLoginTimeBefore(Date lastLoginTime) {
          ...
          if (ObjectUtil.isEmpty(lastLoginTime)) {
               throw new IllegalArgumentException("Method whereLastLoginTimeBefore, the parameter lastLoginTime is not allowed  to be null.");
          }

          SearchCriteria searchCriteria = getLastLoginTimeSearchCriteria(QueryOperator.LESS_THAN, new Object[]{lastLoginTime});
          return addSearchCriteria(searchCriteria);
      }
      ...
      public SecUserRequest whereLastLoginTimeAfter(DateTime lastLoginTime) {
          if (ObjectUtil.isEmpty(lastLoginTime)) {
              throw new IllegalArgumentException("Method whereLastLoginTimeAfter, the parameter lastLoginTime is not allowed  to be null.");
          }
          SearchCriteria searchCriteria = getLastLoginTimeSearchCriteria(QueryOperator.GREATER_THAN, new Object[]{lastLoginTime});
          return addSearchCriteria(searchCriteria);
      }
    ...
    public SecUserRequest hasUserApp(UserApp... userApp) {
       if (isEmptyParam(userApp)){
        ...
        return hasUserApp(Q.userApp().select(UserApp.SEC_USER_PROPERTY).filterById(QueryOperator.IN, (Object[])userApp));
    }
    ...
    public SecUserRequest hasUserApp(UserAppRequest userApp) {
        return hasUserApp(userApp, $userApp -> java.util.Optional.of($userApp).map(UserApp::getSecUser).map(SecUser::getId).orElse(null));
    }
    ...
    public SecUserRequest hasUserApp(
      ...
      return addSearchCriteria(
          new AggregationCriteria(
              userApp, UserApp.SEC_USER_PROPERTY, queryOperator, value));
    }
    ...
    public SecUserRequest hasLoginHistory(LoginHistory... loginHistory) {
       if (isEmptyParam(loginHistory)){
        ...
        return hasLoginHistory(Q.loginHistory().select(LoginHistory.SEC_USER_PROPERTY).filterById(QueryOperator.IN, (Object[])loginHistory));
    }

    public SecUserRequest hasLoginHistory(String... loginHistory) {
        return hasLoginHistory(Q.loginHistory().select(LoginHistory.SEC_USER_PROPERTY).filterById(loginHistory));
    }

    public SecUserRequest hasLoginHistory(LoginHistoryRequest loginHistory) {
        return hasLoginHistory(loginHistory, $loginHistory -> java.util.Optional.of($loginHistory).map(LoginHistory::getSecUser).map(SecUser::getId).orElse(null));
    }
    ...
    public SearchCriteria createLoginHistoryCriteria(LoginHistoryRequest loginHistory, IDRefine<LoginHistory> idRefine){
       return new RefinedIdInCriteria(loginHistory, ID_PROPERTY, idRefine, LoginHistory.SEC_USER_PROPERTY);
    }
    ...
    public SecUserRequest hasWechatWorkappIdentity(WechatWorkappIdentity... wechatWorkappIdentity) {
       if (isEmptyParam(wechatWorkappIdentity)){
          throw new IllegalArgumentException("hasWechatWorkappIdentity(WechatWorkappIdentity... wechatWorkappIdentity)参数不能为空!");
        }
        return hasWechatWorkappIdentity(Q.wechatWorkappIdentity().select(WechatWorkappIdentity.SEC_USER_PROPERTY).filterById(QueryOperator.IN, (Object[])wechatWorkappIdentity));
    }

    public SecUserRequest hasWechatWorkappIdentity(String... wechatWorkappIdentity) {
        return hasWechatWorkappIdentity(Q.wechatWorkappIdentity().select(WechatWorkappIdentity.SEC_USER_PROPERTY).filterById(wechatWorkappIdentity));
    }

    public SecUserRequest hasWechatWorkappIdentity(WechatWorkappIdentityRequest wechatWorkappIdentity) {
        return hasWechatWorkappIdentity(wechatWorkappIdentity, $wechatWorkappIdentity -> java.util.Optional.of($wechatWorkappIdentity).map(WechatWorkappIdentity::getSecUser).map(SecUser::getId).orElse(null));
    }
    ...
    public SecUserRequest hasWechatWorkappIdentity(
        WechatWorkappIdentityRequest wechatWorkappIdentity, QueryOperator queryOperator, Object value) {
      return addSearchCriteria(
          new AggregationCriteria(
    ...
    public SearchCriteria createWechatWorkappIdentityCriteria(WechatWorkappIdentityRequest wechatWorkappIdentity, IDRefine<WechatWorkappIdentity> idRefine){
       return new RefinedIdInCriteria(wechatWorkappIdentity, ID_PROPERTY, idRefine, WechatWorkappIdentity.SEC_USER_PROPERTY);
    }
    ...
    public SecUserRequest hasWechatMiniappIdentity(WechatMiniappIdentity... wechatMiniappIdentity) {
       if (isEmptyParam(wechatMiniappIdentity)){
          throw new IllegalArgumentException("hasWechatMiniappIdentity(WechatMiniappIdentity... wechatMiniappIdentity)参数不能为空!");
        }
        return hasWechatMiniappIdentity(Q.wechatMiniappIdentity().select(WechatMiniappIdentity.SEC_USER_PROPERTY).filterById(QueryOperator.IN, (Object[])wechatMiniappIdentity));
    }

    public SecUserRequest hasWechatMiniappIdentity(String... wechatMiniappIdentity) {
        return hasWechatMiniappIdentity(Q.wechatMiniappIdentity().select(WechatMiniappIdentity.SEC_USER_PROPERTY).filterById(wechatMiniappIdentity));
    }

    public SecUserRequest hasWechatMiniappIdentity(WechatMiniappIdentityRequest wechatMiniappIdentity) {
        return hasWechatMiniappIdentity(wechatMiniappIdentity, $wechatMiniappIdentity -> java.util.Optional.of($wechatMiniappIdentity).map(WechatMiniappIdentity::getSecUser).map(SecUser::getId).orElse(null));
    }
    ...
    public SecUserRequest hasWechatMiniappIdentity(
        WechatMiniappIdentityRequest wechatMiniappIdentity, QueryOperator queryOperator, Object value) {
      return addSearchCriteria(
          new AggregationCriteria(
    ...
    public SearchCriteria createWechatMiniappIdentityCriteria(WechatMiniappIdentityRequest wechatMiniappIdentity, IDRefine<WechatMiniappIdentity> idRefine){
       return new RefinedIdInCriteria(wechatMiniappIdentity, ID_PROPERTY, idRefine, WechatMiniappIdentity.SEC_USER_PROPERTY);
    }
    ...
    public SecUserRequest hasKeyPairIdentity(KeyPairIdentity... keyPairIdentity) {
       if (isEmptyParam(keyPairIdentity)){
          throw new IllegalArgumentException("hasKeyPairIdentity(KeyPairIdentity... keyPairIdentity)参数不能为空!");
        }
        return hasKeyPairIdentity(Q.keyPairIdentity().select(KeyPairIdentity.SEC_USER_PROPERTY).filterById(QueryOperator.IN, (Object[])keyPairIdentity));
    }

    public SecUserRequest hasKeyPairIdentity(String... keyPairIdentity) {
        return hasKeyPairIdentity(Q.keyPairIdentity().select(KeyPairIdentity.SEC_USER_PROPERTY).filterById(keyPairIdentity));
    }

    public SecUserRequest hasKeyPairIdentity(KeyPairIdentityRequest keyPairIdentity) {
        return hasKeyPairIdentity(keyPairIdentity, $keyPairIdentity -> java.util.Optional.of($keyPairIdentity).map(KeyPairIdentity::getSecUser).map(SecUser::getId).orElse(null));
    }
    ...
    public SearchCriteria createKeyPairIdentityCriteria(KeyPairIdentityRequest keyPairIdentity, IDRefine<KeyPairIdentity> idRefine){
       return new RefinedIdInCriteria(keyPairIdentity, ID_PROPERTY, idRefine, KeyPairIdentity.SEC_USER_PROPERTY);
    }
  ...
  public SecUserRequest aggregateWechatWorkappIdentityList(WechatWorkappIdentityRequest wechatWorkappIdentity){
  ...
  public SecUserRequest countWechatWorkappIdentity(WechatWorkappIdentityRequest wechatWorkappIdentity) {
    return countWechatWorkappIdentity("wechatWorkappIdentityCount", wechatWorkappIdentity);
  }

  public SecUserRequest countWechatWorkappIdentity(String retName, WechatWorkappIdentityRequest wechatWorkappIdentity){
    wechatWorkappIdentity.count();
    return statsFromWechatWorkappIdentity(retName, wechatWorkappIdentity);
  }

  public SecUserRequest statsFromWechatWorkappIdentity(String retName, WechatWorkappIdentityRequest wechatWorkappIdentity){
    return addDynamicProperty(retName, wechatWorkappIdentity, WechatWorkappIdentity.SEC_USER_PROPERTY);
  }
  ...
  public SecUserRequest aggregateWechatMiniappIdentityList(WechatMiniappIdentityRequest wechatMiniappIdentity){
  ...
  public SecUserRequest countWechatMiniappIdentity(WechatMiniappIdentityRequest wechatMiniappIdentity) {
    return countWechatMiniappIdentity("wechatMiniappIdentityCount", wechatMiniappIdentity);
  }

  public SecUserRequest countWechatMiniappIdentity(String retName, WechatMiniappIdentityRequest wechatMiniappIdentity){
    wechatMiniappIdentity.count();
    return statsFromWechatMiniappIdentity(retName, wechatMiniappIdentity);
  }

  public SecUserRequest statsFromWechatMiniappIdentity(String retName, WechatMiniappIdentityRequest wechatMiniappIdentity){
    return addDynamicProperty(retName, wechatMiniappIdentity, WechatMiniappIdentity.SEC_USER_PROPERTY);
  }
  ...
  public SecUserRequest countKeyPairIdentity(String retName, KeyPairIdentityRequest keyPairIdentity){
    keyPairIdentity.count();
    return statsFromKeyPairIdentity(retName, keyPairIdentity);
  }

  public SecUserRequest statsFromKeyPairIdentity(String retName, KeyPairIdentityRequest keyPairIdentity){
