...
import com.doublechaintech.model.userdomain.CandidateUserDomain;
...
public class SecUserManagerImpl extends CustomModelCheckerManager
  ...
  protected SecUser saveSecUser(ModelUserContext userContext, SecUser secUser, String[] tokensExpr)
      throws Exception {
  ...
  protected SecUser saveSecUserDetail(ModelUserContext userContext, SecUser secUser)
      throws Exception {

    return saveSecUser(userContext, secUser, allTokens());
  }

  public SecUser loadSecUser(ModelUserContext userContext, String secUserId, String[] tokensExpr)
      throws Exception {
  ...
  public SecUser searchSecUser(
      ModelUserContext userContext, String secUserId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected SecUser present(
      ModelUserContext userContext, SecUser secUser, Map<String, Object> tokens) throws Exception {
  ...
  public SecUser loadSecUserDetail(ModelUserContext userContext, String secUserId)
      throws Exception {
  ...
  protected SecUser loadSecUser(
      ModelUserContext userContext, String secUserId, Map<String, Object> tokens) throws Exception {
    checkerOf(userContext).checkIdOfSecUser(secUserId);
  ...
  public SecUser loadSecUserWithLogin(
      ModelUserContext userContext, String login, Map<String, Object> tokens) throws Exception {
    return secUserDaoOf(userContext).loadByLogin(login, tokens);
  }

  public SecUser loadSecUserWithEmail(
      ModelUserContext userContext, String email, Map<String, Object> tokens) throws Exception {
    return secUserDaoOf(userContext).loadByEmail(email, tokens);
  }

  public SecUser loadSecUserWithMobile(
      ModelUserContext userContext, String mobile, Map<String, Object> tokens) throws Exception {
    return secUserDaoOf(userContext).loadByMobile(mobile, tokens);
  }

  protected <T extends BaseEntity> void addActions(
      ModelUserContext userContext, SecUser secUser, Map<String, Object> tokens) {
    ...
    // SecUser secUser, Map<String, Object> tokens){
  ...
  public SecUser internalSaveSecUser(ModelUserContext userContext, SecUser secUser)
      throws Exception {
    return internalSaveSecUser(userContext, secUser, allTokens());
  }

  public SecUser internalSaveSecUser(
      ModelUserContext userContext, SecUser secUser, Map<String, Object> options) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherDomain(
      ModelUserContext userContext, String secUserId, String anotherDomainId) throws Exception {
  ...
  protected UserDomain loadUserDomain(
      ModelUserContext userContext, String newDomainId, Map<String, Object> options)
      throws Exception {
  ...
  public SecUser forgetByAll(ModelUserContext userContext, String secUserId, int secUserVersion)
      throws Exception {
    return forgetByAllInternal(userContext, secUserId, secUserVersion);
  }

  protected SecUser forgetByAllInternal(
      ModelUserContext userContext, String secUserId, int secUserVersion) throws Exception {
  ...
  protected void checkParamsForRemovingUserAppList(
      ModelUserContext userContext, String secUserId, String userAppIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected LoginHistory createLoginHistory(
      ModelUserContext userContext, String fromIp, String description) throws Exception {
  ...
  protected void checkParamsForRemovingLoginHistoryList(
      ModelUserContext userContext, String secUserId, String loginHistoryIds[], String[] tokensExpr)
      throws Exception {
  ...
  */
  ...
  protected WechatWorkappIdentity createWechatWorkappIdentity(
      ModelUserContext userContext, String corpId, String userId, DateTime lastLoginTime)
      throws Exception {
  ...
  */
  ...
  protected KeyPairIdentity createKeyPairIdentity(
      ModelUserContext userContext, String publicKey, String keyTypeId) throws Exception {
  ...
  */
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, SecUser newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<SecUser> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
    List<UserDomain> domainList =
        ModelBaseUtils.collectReferencedObjectWithType(userContext, list, UserDomain.class);
  ...
  public Object listPageByDomain(
      ModelUserContext userContext, String domainId, int start, int count) throws Exception {
