...
public interface SecUserManager extends BaseManager {
  ...
  public SecUser internalSaveSecUser(
      ModelUserContext userContext, SecUser secUser, Map<String, Object> option) throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, SecUser updated, Object actor, String methodName)
      throws Exception {};

  /*======================================================DATA MAINTENANCE===========================================================*/

  // public  UserAppManager getUserAppManager(ModelUserContext userContext, String secUserId, String
  // title, String appIcon, boolean fullAccess, String permission, String appType, String appId,
  // String ctxType, String ctxId, String location ,String [] tokensExpr)  throws Exception;
  ...
  */
  ...
  // public  LoginHistoryManager getLoginHistoryManager(ModelUserContext userContext, String
  ...
  */
  ...
  // public  WechatWorkappIdentityManager getWechatWorkappIdentityManager(ModelUserContext
  ...
  */
  ...
  // public  WechatMiniappIdentityManager getWechatMiniappIdentityManager(ModelUserContext
  ...
  */
  ...
  // public  KeyPairIdentityManager getKeyPairIdentityManager(ModelUserContext userContext, String
  // secUserId, String publicKey, String keyTypeId ,String [] tokensExpr)  throws Exception;
