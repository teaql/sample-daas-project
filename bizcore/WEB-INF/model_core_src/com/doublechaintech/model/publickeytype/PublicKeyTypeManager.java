...
public interface PublicKeyTypeManager extends BaseManager {
  ...
  public PublicKeyType internalSavePublicKeyType(
      ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> option)
      throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, PublicKeyType updated, Object actor, String methodName)
      throws Exception {};

  /*======================================================DATA MAINTENANCE===========================================================*/

  // public  KeyPairIdentityManager getKeyPairIdentityManager(ModelUserContext userContext, String
  // publicKeyTypeId, String publicKey, String secUserId ,String [] tokensExpr)  throws Exception;
