...
public class PublicKeyTypeJDBCTemplateDAO extends ModelBaseDAOImpl implements PublicKeyTypeDAO{
  ...
  public Stream<PublicKeyType> loadAllAsStream() {
	...
	protected List<Object[]> preparePublicKeyTypeBatchRecoverArgs(List<PublicKeyType> publicKeyTypeList){
	...
	protected List<Object[]> preparePublicKeyTypeBatchRemoveArgs(List<PublicKeyType> publicKeyTypeList){
  ...
  static final int RECOVER_LIST_INDEX=3;
	...
	protected Object[] splitPublicKeyTypeList(List<PublicKeyType> publicKeyTypeList){
      ...
      if(publicKeyType.isToRecover()){
		...
		return new Object[]{publicKeyTypeCreateList,
