...
import com.doublechaintech.model.*;import com.doublechaintech.model.BaseViewPage;import com.doublechaintech.model.ModelUserContextImpl;import com.doublechaintech.model.iamservice.*;import com.doublechaintech.model.keypairidentity.KeyPairIdentity;import com.doublechaintech.model.publickeytype.PublicKeyType;import com.doublechaintech.model.secuser.SecUser;import com.doublechaintech.model.services.IamService;import com.doublechaintech.model.tree.*;import com.doublechaintech.model.treenode.*;import com.doublechaintech.model.userapp.UserApp;import com.doublechaintech.model.userdomain.CandidateUserDomain;import com.doublechaintech.model.userdomain.UserDomain;import com.doublechaintech.model.utils.ModelAssurance;
...
public class PublicKeyTypeManagerImpl extends CustomModelCheckerManager implements PublicKeyTypeManager, BusinessHandler{
	...
	@Override
	public PublicKeyTypeDAO daoOf(ModelUserContext userContext) {
	...
	protected void throwExceptionWithMessage(String value) throws PublicKeyTypeManagerException{
 	...
 	protected PublicKeyType savePublicKeyType(ModelUserContext userContext, PublicKeyType publicKeyType, String [] tokensExpr) throws Exception{
 	...
 	protected PublicKeyType savePublicKeyTypeDetail(ModelUserContext userContext, PublicKeyType publicKeyType) throws Exception{
 	...
 	public PublicKeyType loadPublicKeyType(ModelUserContext userContext, String publicKeyTypeId, String [] tokensExpr) throws Exception{
 	 ...
 	 public PublicKeyType searchPublicKeyType(ModelUserContext userContext, String publicKeyTypeId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected PublicKeyType present(ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens) throws Exception {
 	...
 	public PublicKeyType loadPublicKeyTypeDetail(ModelUserContext userContext, String publicKeyTypeId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String publicKeyTypeId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String publicKeyTypeId) throws Exception{
		PublicKeyType publicKeyType = loadPublicKeyType( userContext, publicKeyTypeId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String publicKeyTypeId) throws Exception{
 	...
 	protected PublicKeyType savePublicKeyType(ModelUserContext userContext, PublicKeyType publicKeyType, Map<String,Object>tokens) throws Exception{
 	
 		return publicKeyTypeDaoOf(userContext).save(publicKeyType, tokens);
 	}
 	protected PublicKeyType loadPublicKeyType(ModelUserContext userContext, String publicKeyTypeId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfPublicKeyType(publicKeyTypeId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens){
  ...
  @Override
  public List<PublicKeyType> searchPublicKeyTypeList(ModelUserContext ctx, PublicKeyTypeRequest pRequest){
  ...
  @Override
  public PublicKeyType searchPublicKeyType(ModelUserContext ctx, PublicKeyTypeRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingPublicKeyType(ModelUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public PublicKeyType clone(ModelUserContext userContext, String fromPublicKeyTypeId) throws Exception{
	...
	public PublicKeyType internalSavePublicKeyType(ModelUserContext userContext, PublicKeyType publicKeyType, Map<String,Object> options) throws Exception
	{
	...
	public PublicKeyType updatePublicKeyTypeProperty(ModelUserContext userContext,String publicKeyTypeId, int publicKeyTypeVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingPublicKeyType(userContext, publicKeyTypeId, publicKeyTypeVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherDomain(ModelUserContext userContext, String publicKeyTypeId, String anotherDomainId) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public PublicKeyType forgetByAll(ModelUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion) throws Exception {
		return forgetByAllInternal(userContext, publicKeyTypeId, publicKeyTypeVersion);
	}
	protected PublicKeyType forgetByAllInternal(ModelUserContext userContext,
	...
	protected void checkParamsForAddingKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId, String publicKey, String secUserId,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeyPairIdentityProperties(ModelUserContext userContext, String publicKeyTypeId,String id,String publicKey,String [] tokensExpr) throws Exception {
	...
	public  PublicKeyType updateKeyPairIdentityProperties(ModelUserContext userContext, String publicKeyTypeId, String id,String publicKey, String [] tokensExpr) throws Exception
	{
	...
	protected  void beforeUpdateKeyPairIdentityProperties(ModelUserContext userContext, KeyPairIdentity item, String publicKeyTypeId, String id,String publicKey, String [] tokensExpr)
						throws Exception {
			// by default, nothing to do
	}

	protected KeyPairIdentity createKeyPairIdentity(ModelUserContext userContext, String publicKey, String secUserId) throws Exception{
	...
	protected void checkParamsForRemovingKeyPairIdentityList(ModelUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeyPairIdentityList(ModelUserContext userContext, String publicKeyTypeId,
			String keyPairIdentityIds[],String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForRemovingKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId,
	...
	public  PublicKeyType removeKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId,
		String keyPairIdentityId, int keyPairIdentityVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForCopyingKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId,
		String keyPairIdentityId, int keyPairIdentityVersion,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType copyKeyPairIdentityFrom(ModelUserContext userContext, String publicKeyTypeId,
		String keyPairIdentityId, int keyPairIdentityVersion,String [] tokensExpr) throws Exception{
	...
	protected void checkParamsForUpdatingKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId, String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception{
	...
	public  PublicKeyType updateKeyPairIdentity(ModelUserContext userContext, String publicKeyTypeId, String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr)
			throws Exception{
	...
	protected void beforeUpdateKeyPairIdentity(ModelUserContext userContext, KeyPairIdentity existed, String publicKeyTypeId, String keyPairIdentityId, int keyPairIdentityVersion, String property, String newValueExpr,String [] tokensExpr)
  			throws Exception{
  }
	/*
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<PublicKeyType> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String publicKeyTypeId) throws Exception{
