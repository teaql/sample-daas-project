...
public class PublicKeyTypeManagerImpl extends CustomModelCheckerManager
  ...
  protected PublicKeyType savePublicKeyType(
      ModelUserContext userContext, PublicKeyType publicKeyType, String[] tokensExpr)
      throws Exception {
  ...
  protected PublicKeyType savePublicKeyTypeDetail(
      ModelUserContext userContext, PublicKeyType publicKeyType) throws Exception {

    return savePublicKeyType(userContext, publicKeyType, allTokens());
  }

  public PublicKeyType loadPublicKeyType(
      ModelUserContext userContext, String publicKeyTypeId, String[] tokensExpr) throws Exception {
  ...
  protected PublicKeyType present(
      ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> tokens)
      throws Exception {
  ...
  public PublicKeyType loadPublicKeyTypeDetail(ModelUserContext userContext, String publicKeyTypeId)
      throws Exception {
  ...
  protected PublicKeyType loadPublicKeyType(
      ModelUserContext userContext, String publicKeyTypeId, Map<String, Object> tokens)
      throws Exception {
    checkerOf(userContext).checkIdOfPublicKeyType(publicKeyTypeId);
  ...
  protected <T extends BaseEntity> void addActions(
    ...
    // PublicKeyType publicKeyType, Map<String, Object> tokens){

  @Override
  public List<PublicKeyType> searchPublicKeyTypeList(
      ModelUserContext ctx, PublicKeyTypeRequest pRequest) {
  ...
  public PublicKeyType createPublicKeyType(
      ModelUserContext userContext, String keyAlg, String signAlg, String domainId)
      throws Exception {
  ...
  public PublicKeyType clone(ModelUserContext userContext, String fromPublicKeyTypeId)
      throws Exception {
  ...
  public PublicKeyType internalSavePublicKeyType(
      ModelUserContext userContext, PublicKeyType publicKeyType, Map<String, Object> options)
      throws Exception {
  ...
  protected void checkParamsForTransferingAnotherDomain(
      ModelUserContext userContext, String publicKeyTypeId, String anotherDomainId)
      throws Exception {
  ...
  public PublicKeyType forgetByAll(
      ModelUserContext userContext, String publicKeyTypeId, int publicKeyTypeVersion)
      throws Exception {
  ...
  protected KeyPairIdentity createKeyPairIdentity(
      ModelUserContext userContext, String publicKey, String secUserId) throws Exception {
  ...
  */
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, PublicKeyType newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<PublicKeyType> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
