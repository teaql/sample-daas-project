...
public void transferAllRelationshipsTo(PublicKeyType target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(KEY_ALG_PROPERTY, "key_alg", "键 ALG")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(SIGN_ALG_PROPERTY, "sign_alg", "Alg迹象")
        .withType("string", String.class));
...
return getId();
	...
	public PublicKeyType updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getKeyAlg();
	...
	public PublicKeyType updateKeyAlg(String keyAlg){String oldKeyAlg = this.keyAlg;String newKeyAlg = trimString(keyAlg);if(!shouldReplaceBy(newKeyAlg, oldKeyAlg)){return this;}this.keyAlg = newKeyAlg;if (cn.hutool.core.util.ObjectUtil.equals(newKeyAlg, oldKeyAlg)){
        return this;
      }addPropertyChange(KEY_ALG_PROPERTY, oldKeyAlg, newKeyAlg);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeKeyAlg(String keyAlg){
		if(keyAlg != null) { updateKeyAlg(keyAlg);}
	}
...
return getSignAlg();
	...
	public PublicKeyType updateSignAlg(String signAlg){String oldSignAlg = this.signAlg;String newSignAlg = trimString(signAlg);if(!shouldReplaceBy(newSignAlg, oldSignAlg)){return this;}this.signAlg = newSignAlg;if (cn.hutool.core.util.ObjectUtil.equals(newSignAlg, oldSignAlg)){
        return this;
      }addPropertyChange(SIGN_ALG_PROPERTY, oldSignAlg, newSignAlg);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeSignAlg(String signAlg){
		if(signAlg != null) { updateSignAlg(signAlg);}
	}
...
return getDomain();
	...
	public PublicKeyType updateDomain(UserDomain domain){UserDomain oldDomain = this.domain;UserDomain newDomain = domain;if(!shouldReplaceBy(newDomain, oldDomain)){return this;}this.domain = newDomain;if (cn.hutool.core.util.ObjectUtil.equals(newDomain, oldDomain)){
        return this;
...
return this;
  ...
  public  PublicKeyType updateDomainByReferenceId(String domainId){ updateDomain(UserDomain.refById(domainId)); return this;}
...
return getVersion();
	...
	public PublicKeyType updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
