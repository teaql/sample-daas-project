...
import static com.doublechaintech.model.publickeytype.PublicKeyType.*;

public class PublicKeyTypeRequest extends BaseRequest<PublicKeyType> {
    public static PublicKeyTypeRequest newInstance() {
        return new PublicKeyTypeRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public PublicKeyTypeRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public PublicKeyTypeRequest selectAny() {return selectAll().selectKeyPairIdentityList(Q.keyPairIdentity().selectSelf());
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,KEY_ALG_PROPERTY,SIGN_ALG_PROPERTY,DOMAIN_PROPERTY,VERSION_PROPERTY};
   ...
   public PublicKeyTypeRequest count(){
    ...
    public PublicKeyTypeRequest hasKeyPairIdentity(KeyPairIdentity... keyPairIdentity) {
       if (isEmptyParam(keyPairIdentity)){
        ...
        return hasKeyPairIdentity(Q.keyPairIdentity().select(KeyPairIdentity.KEY_TYPE_PROPERTY).filterById(QueryOperator.IN, (Object[])keyPairIdentity));
    }

    public PublicKeyTypeRequest hasKeyPairIdentity(String... keyPairIdentity) {
        return hasKeyPairIdentity(Q.keyPairIdentity().select(KeyPairIdentity.KEY_TYPE_PROPERTY).filterById(keyPairIdentity));
    }

    public PublicKeyTypeRequest hasKeyPairIdentity(KeyPairIdentityRequest keyPairIdentity) {
        return hasKeyPairIdentity(keyPairIdentity, $keyPairIdentity -> java.util.Optional.of($keyPairIdentity).map(KeyPairIdentity::getKeyType).map(PublicKeyType::getId).orElse(null));
    }
    ...
    public SearchCriteria createKeyPairIdentityCriteria(KeyPairIdentityRequest keyPairIdentity, IDRefine<KeyPairIdentity> idRefine){
       return new RefinedIdInCriteria(keyPairIdentity, ID_PROPERTY, idRefine, KeyPairIdentity.KEY_TYPE_PROPERTY);
    }
  ...
  public PublicKeyTypeRequest countKeyPairIdentity(String retName, KeyPairIdentityRequest keyPairIdentity){
    keyPairIdentity.count();
    return statsFromKeyPairIdentity(retName, keyPairIdentity);
  }

  public PublicKeyTypeRequest statsFromKeyPairIdentity(String retName, KeyPairIdentityRequest keyPairIdentity){
