...
public class Kid extends BaseEntity implements java.io.Serializable {
  ...
  static {
    ...
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(AGE_PROPERTY, "age", "年龄").withType("int", "int"));
    memberMetaInfoList.add(
        MemberMetaInfo.defineBy(FAMILY_PROPERTY, "family", "家庭").withType("family", Family.class));
    memberMetaInfoList.add(
  ...
  public Kid updateName(String name) {
    String oldName = this.name;
    String newName = trimString(name);
  ...
  public Kid updateAge(int age) {
    int oldAge = this.age;
    int newAge = age;
    if (!shouldReplaceBy(newAge, oldAge)) {
      return this;
    }
    this.age = newAge;
    if (cn.hutool.core.util.ObjectUtil.equals(newAge, oldAge)) {
      return this;
    }
    addPropertyChange(AGE_PROPERTY, oldAge, newAge);
    this.changed = true;
    setChecked(false);
    return this;
  }

  public Kid orderByAge(boolean asc) {
    doAddOrderBy(AGE_PROPERTY, asc);
    return this;
  }

  public SearchCriteria createAgeCriteria(QueryOperator operator, Object... parameters) {
    return createCriteria(AGE_PROPERTY, operator, parameters);
  }

  public Kid ignoreAgeCriteria() {
    super.ignoreSearchProperty(AGE_PROPERTY);
    return this;
  }

  public Kid addAgeCriteria(QueryOperator operator, Object... parameters) {
    SearchCriteria criteria = createAgeCriteria(operator, parameters);
    doAddCriteria(criteria);
    return this;
  }
  ...
  public Kid updateFamily(Family family) {
    Family oldFamily = this.family;
    Family newFamily = family;
    if (!shouldReplaceBy(newFamily, oldFamily)) {
      return this;
    }
    this.family = newFamily;
    if (cn.hutool.core.util.ObjectUtil.equals(newFamily, oldFamily)) {
      return this;
    }
    addPropertyChange(FAMILY_PROPERTY, oldFamily, newFamily);
    this.changed = true;
    setChecked(false);
    return this;
  }
  ...
  public Kid ignoreFamilyCriteria() {
    super.ignoreSearchProperty(FAMILY_PROPERTY);
    return this;
  }
  ...
  public Kid updateFamilyByReferenceId(String familyId) {
    updateFamily(Family.refById(familyId));
    return this;
  }
  ...
  public Kid updateVersion(int version) {
    int oldVersion = this.version;
    int newVersion = version;
  ...
  public Kid ignoreVersionCriteria() {
  ...
  public Object[] toFlatArray() {
    return new Object[] {getId(), getName(), getAge(), getFamily(), getVersion()};
  }
  ...
  public void increaseAge(int incAge) {
    updateAge(this.age + incAge);
  }

  public void decreaseAge(int decAge) {
    updateAge(this.age - decAge);
  }
}
