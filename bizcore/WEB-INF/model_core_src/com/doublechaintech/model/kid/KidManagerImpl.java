...
public class KidManagerImpl extends CustomModelCheckerManager implements KidManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws KidManagerException{
 	...
 	protected Kid saveKid(ModelUserContext userContext, Kid kid, String [] tokensExpr) throws Exception{
 	...
 	public Kid loadKid(ModelUserContext userContext, String kidId, String [] tokensExpr) throws Exception{
 	 ...
 	 public Kid searchKid(ModelUserContext userContext, String kidId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected Kid present(ModelUserContext userContext, Kid kid, Map<String, Object> tokens) throws Exception {
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	protected Kid saveKid(ModelUserContext userContext, Kid kid, Map<String,Object>tokens) throws Exception{
 	
 		return kidDaoOf(userContext).save(kid, tokens);
 	}
 	protected Kid loadKid(ModelUserContext userContext, String kidId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfKid(kidId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Kid kid, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, Kid kid, Map<String, Object> tokens){
  ...
  public Kid searchKid(ModelUserContext ctx, KidRequest pRequest){
	...
	public Kid createKid(ModelUserContext userContext, String name,String familyId) throws Exception
	{
	...
	protected void checkParamsForUpdatingKid(ModelUserContext userContext,String kidId, int kidVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public Kid internalSaveKid(ModelUserContext userContext, Kid kid, Map<String,Object> options) throws Exception
	{
	...
	public Kid updateKid(ModelUserContext userContext,String kidId, int kidVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKid(userContext, kidId, kidVersion, property, newValueExpr, tokensExpr);
		...
		if(kid.getVersion() != kidVersion){
			String message = "The target version("+kid.getVersion()+") is not equals to version("+kidVersion+") provided";
	...
	public Kid updateKidProperty(ModelUserContext userContext,String kidId, int kidVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingKid(userContext, kidId, kidVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherFamily(ModelUserContext userContext, String kidId, String anotherFamilyId) throws Exception
 	{
 	...
 	public Kid transferToAnotherFamily(ModelUserContext userContext, String kidId, String anotherFamilyId) throws Exception
 	{
	...
	public CandidateFamily requestCandidateFamily(ModelUserContext userContext, String ownerClass, String id, String filterKey, int pageNo) throws Exception {
		...
		SmartList<Family> candidateList = familyDaoOf(userContext).requestCandidateFamilyForKid(userContext,ownerClass, id, filterKey, pageNo, pageSize);
 ...
 //--------------------------------------------------------------
 	...
 	protected Family loadFamily(ModelUserContext userContext, String newFamilyId, Map<String,Object> options) throws Exception
 	{
	...
	public Kid forgetByAll(ModelUserContext userContext, String kidId, int kidVersion) throws Exception {
		return forgetByAllInternal(userContext, kidId, kidVersion);
	}
	protected Kid forgetByAllInternal(ModelUserContext userContext,
			String kidId, int kidVersion) throws Exception{
  ...
  public void sendAllItems(ModelUserContext ctx) throws Exception{
    kidDaoOf(ctx).loadAllAsStream().forEach(
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<Kid> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
		List<Family> familyList = ModelBaseUtils.collectReferencedObjectWithType(userContext, list, Family.class);
	...
	public Object listPageByFamily(ModelUserContext userContext,String familyId, int start, int count) throws Exception {
		SmartList<Kid> list = kidDaoOf(userContext).findKidByFamily(familyId, start, count, new HashMap<>());
		...
		page.setLinkToUrl(TextUtil.encodeUrl(String.format("%s/listByFamily/%s/",  getBeanName(), familyId)));
