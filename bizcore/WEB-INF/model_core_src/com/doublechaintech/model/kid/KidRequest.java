...
public class KidRequest extends BaseRequest<Kid> {
  ...
  public KidRequest addDynamicProperty(
  ...
  public KidRequest selectAll() {
    return this.selectId().selectName().selectAge().selectFamily().selectVersion();
  }

  public KidRequest selectAny() {
    return selectAll();
  }
  ...
  protected static final String[] ALL_SELF_FIELDS = {
    ID_PROPERTY, NAME_PROPERTY, AGE_PROPERTY, FAMILY_PROPERTY, VERSION_PROPERTY
  };
  ...
  public KidRequest filterByAge(int age) {

    return filterByAge(QueryOperator.EQUAL, age);
  }

  public KidRequest whereAgeIsNull() {
    return where(AGE_PROPERTY, QueryOperator.IS_NULL);
  }

  public KidRequest whereAgeIsNotNull() {
    return where(AGE_PROPERTY, QueryOperator.IS_NOT_NULL);
  }

  public KidRequest whereAgeBetween(Integer ageStart, Integer ageEnd) {
    if (ObjectUtil.isEmpty(ageStart)) {
      throw new IllegalArgumentException(
          "Method whereAgeBetween, the parameter ageStart is not allowed  to be null.");
    }
    if (ObjectUtil.isEmpty(ageEnd)) {
      throw new IllegalArgumentException(
          "Method whereAgeBetween, the parameter ageEnd is not allowed  to be null.");
    }
    SearchCriteria searchCriteria =
        getAgeSearchCriteria(QueryOperator.BETWEEN, new Object[] {ageStart, ageEnd});
    return addSearchCriteria(searchCriteria);
  }

  public KidRequest whereAgeLessThan(Integer age) {
    if (ObjectUtil.isEmpty(age)) {
      throw new IllegalArgumentException(
          "Method whereAgeLessThan, the parameter age is not allowed  to be null.");
    }
    SearchCriteria searchCriteria =
        getAgeSearchCriteria(QueryOperator.LESS_THAN, new Object[] {age});
    return addSearchCriteria(searchCriteria);
  }

  public KidRequest whereAgeGreaterThan(int age) {
    if (ObjectUtil.isEmpty(age)) {
      throw new IllegalArgumentException(
          "Method whereAgeGreaterThan, the parameter age is not allowed  to be null.");
    }
    SearchCriteria searchCriteria =
        getAgeSearchCriteria(QueryOperator.GREATER_THAN, new Object[] {age});
    return addSearchCriteria(searchCriteria);
  }

  public KidRequest filterByAge(QueryOperator pQueryOperator, Object... parameters) {
    SearchCriteria searchCriteria = getAgeSearchCriteria(pQueryOperator, parameters);
    return addSearchCriteria(searchCriteria);
  }

  public KidRequest selectAge() {
    return select(AGE_PROPERTY);
  }

  public KidRequest unselectAge() {
    return unselect(AGE_PROPERTY);
  }

  public SearchCriteria getAgeSearchCriteria(QueryOperator pQueryOperator, Object[] parameters) {
    return new SimplePropertyCriteria(AGE_PROPERTY, pQueryOperator, parameters);
  }

  @Deprecated
  public KidRequest orderByAge(boolean asc) {
    addOrderBy(AGE_PROPERTY, asc);
    return this;
  }

  public KidRequest orderByAgeAscending() {
    addOrderBy(AGE_PROPERTY, true);
    return this;
  }

  public KidRequest orderByAgeDescending() {
    addOrderBy(AGE_PROPERTY, false);
    return this;
  }

  public KidRequest countAge() {
    return countAge("countAge");
  }

  public KidRequest countAge(String aggName) {
    return aggregate(aggName, AggFunc.COUNT, AGE_PROPERTY);
  }

  public KidRequest maxAge() {
    return maxAge("maxAge");
  }

  public KidRequest maxAge(String aggName) {
    return aggregate(aggName, AggFunc.MAX, AGE_PROPERTY);
  }

  public KidRequest minAge() {
    return minAge("minAge");
  }

  public KidRequest minAge(String aggName) {
    return aggregate(aggName, AggFunc.MIN, AGE_PROPERTY);
  }

  public KidRequest sumAge() {
    return sumAge("sumAge");
  }

  public KidRequest sumAge(String aggName) {
    return aggregate(aggName, AggFunc.SUM, AGE_PROPERTY);
  }

  public KidRequest groupByAge() {
    return groupByAge(AGE_PROPERTY);
  }

  public KidRequest groupByAge(String ret) {
    return groupBy(ret, AGE_PROPERTY);
  }

  public KidRequest groupByAge(SqlFunction func) {
    return groupByAge(AGE_PROPERTY, func);
  }

  public KidRequest groupByAge(String ret, SqlFunction func) {
    super.groupBy(ret, func, AGE_PROPERTY);
    return this;
  }
