...
public class KidTable {
  ...
  public static final String[] ALL_CLOUMNS = {
    COLUMN_ID, COLUMN_NAME, COLUMN_AGE, COLUMN_FAMILY, COLUMN_VERSION
  };
  public static final String[] NORMAL_CLOUMNS = {COLUMN_NAME, COLUMN_AGE, COLUMN_FAMILY};
  ...
  public static void ensureTable(ModelUserContext userContext, Map<String, Object> result)
    ...
    ModelBaseUtils.ensureTable(
        ...
        new String[] {
          ...
          "create  index idx4age_of_kid on kid_data (age);",
