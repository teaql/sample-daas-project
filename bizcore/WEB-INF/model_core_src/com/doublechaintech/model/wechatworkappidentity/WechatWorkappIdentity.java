...
public void transferAllRelationshipsTo(WechatWorkappIdentity target){
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(CORP_ID_PROPERTY, "corp_id", "公司标识")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(USER_ID_PROPERTY, "user_id", "用户Id")
        .withType("string", String.class));
...
return getId();
	...
	public WechatWorkappIdentity updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getCorpId();
	...
	public WechatWorkappIdentity updateCorpId(String corpId){String oldCorpId = this.corpId;String newCorpId = trimString(corpId);if(!shouldReplaceBy(newCorpId, oldCorpId)){return this;}this.corpId = newCorpId;if (cn.hutool.core.util.ObjectUtil.equals(newCorpId, oldCorpId)){
        return this;
      }addPropertyChange(CORP_ID_PROPERTY, oldCorpId, newCorpId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeCorpId(String corpId){
		if(corpId != null) { updateCorpId(corpId);}
	}
...
return getUserId();
	...
	public WechatWorkappIdentity updateUserId(String userId){String oldUserId = this.userId;String newUserId = trimString(userId);if(!shouldReplaceBy(newUserId, oldUserId)){return this;}this.userId = newUserId;if (cn.hutool.core.util.ObjectUtil.equals(newUserId, oldUserId)){
        return this;
      }addPropertyChange(USER_ID_PROPERTY, oldUserId, newUserId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeUserId(String userId){
		if(userId != null) { updateUserId(userId);}
	}
...
return getSecUser();
	...
	public WechatWorkappIdentity updateSecUser(SecUser secUser){SecUser oldSecUser = this.secUser;SecUser newSecUser = secUser;if(!shouldReplaceBy(newSecUser, oldSecUser)){return this;}this.secUser = newSecUser;if (cn.hutool.core.util.ObjectUtil.equals(newSecUser, oldSecUser)){
        return this;
...
return this;
  ...
  public  WechatWorkappIdentity updateSecUserByReferenceId(String secUserId){ updateSecUser(SecUser.refById(secUserId)); return this;}
...
return getCreateTime();
	...
	public WechatWorkappIdentity updateCreateTime(DateTime createTime){DateTime oldCreateTime = this.createTime;DateTime newCreateTime = createTime;if(!shouldReplaceBy(newCreateTime, oldCreateTime)){return this;}this.createTime = newCreateTime;if (cn.hutool.core.util.ObjectUtil.equals(newCreateTime, oldCreateTime)){
        return this;
...
return getVersion();
	...
	public WechatWorkappIdentity updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
