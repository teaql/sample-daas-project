...
public class WechatWorkappIdentityManagerImpl extends CustomModelCheckerManager implements WechatWorkappIdentityManager, BusinessHandler{
	...
	protected void throwExceptionWithMessage(String value) throws WechatWorkappIdentityManagerException{
 	...
 	protected WechatWorkappIdentity saveWechatWorkappIdentity(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, String [] tokensExpr) throws Exception{
 	...
 	protected WechatWorkappIdentity saveWechatWorkappIdentityDetail(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity) throws Exception{
 	...
 	public WechatWorkappIdentity loadWechatWorkappIdentity(ModelUserContext userContext, String wechatWorkappIdentityId, String [] tokensExpr) throws Exception{
 	 ...
 	 public WechatWorkappIdentity searchWechatWorkappIdentity(ModelUserContext userContext, String wechatWorkappIdentityId, String textToSearch,String [] tokensExpr) throws Exception{
 	...
 	protected WechatWorkappIdentity present(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String, Object> tokens) throws Exception {
		...
		List<BaseEntity> entityListToNaming = wechatWorkappIdentityToPresent.collectReferencesFromLists();
 	...
 	public WechatWorkappIdentity loadWechatWorkappIdentityDetail(ModelUserContext userContext, String wechatWorkappIdentityId) throws Exception{
	...
	public Object prepareContextForUserApp(BaseUserContext userContext,Object targetUserApp) throws Exception{
 	...
 	public Object view(ModelUserContext userContext, String wechatWorkappIdentityId) throws Exception{
	 ...
	 public Object summaryView(ModelUserContext userContext, String wechatWorkappIdentityId) throws Exception{
		WechatWorkappIdentity wechatWorkappIdentity = loadWechatWorkappIdentity( userContext, wechatWorkappIdentityId, viewTokens());
	 ...
	 public Object analyze(ModelUserContext userContext, String wechatWorkappIdentityId) throws Exception{
 	...
 	protected WechatWorkappIdentity saveWechatWorkappIdentity(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String,Object>tokens) throws Exception{
 	
 		return wechatWorkappIdentityDaoOf(userContext).save(wechatWorkappIdentity, tokens);
 	}
 	protected WechatWorkappIdentity loadWechatWorkappIdentity(ModelUserContext userContext, String wechatWorkappIdentityId, Map<String,Object>tokens) throws Exception{
		checkerOf(userContext).checkIdOfWechatWorkappIdentity(wechatWorkappIdentityId);
 	...
 	protected<T extends BaseEntity> void addActions(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String, Object> tokens){
	...
	}// end method of protected<T extends BaseEntity> void addActions(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String, Object> tokens){
  ...
  @Override
  public List<WechatWorkappIdentity> searchWechatWorkappIdentityList(ModelUserContext ctx, WechatWorkappIdentityRequest pRequest){
  ...
  @Override
  public WechatWorkappIdentity searchWechatWorkappIdentity(ModelUserContext ctx, WechatWorkappIdentityRequest pRequest){
    pRequest.limit(0, 1);
	...
	protected void checkParamsForUpdatingWechatWorkappIdentity(ModelUserContext userContext,String wechatWorkappIdentityId, int wechatWorkappIdentityVersion, String property, String newValueExpr,String [] tokensExpr)throws Exception
	{
	...
	public WechatWorkappIdentity clone(ModelUserContext userContext, String fromWechatWorkappIdentityId) throws Exception{
	...
	public WechatWorkappIdentity internalSaveWechatWorkappIdentity(ModelUserContext userContext, WechatWorkappIdentity wechatWorkappIdentity, Map<String,Object> options) throws Exception
	{
	...
	public WechatWorkappIdentity updateWechatWorkappIdentityProperty(ModelUserContext userContext,String wechatWorkappIdentityId, int wechatWorkappIdentityVersion, String property, String newValueExpr,String [] tokensExpr) throws Exception
	{
		checkParamsForUpdatingWechatWorkappIdentity(userContext, wechatWorkappIdentityId, wechatWorkappIdentityVersion, property, newValueExpr, tokensExpr);
	...
	protected void checkParamsForTransferingAnotherSecUser(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherSecUserId) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithLogin(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherLogin) throws Exception
 	{
 	...
 	public WechatWorkappIdentity transferToAnotherSecUserWithLogin(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherLogin) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithEmail(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherEmail) throws Exception
 	{
 	...
 	public WechatWorkappIdentity transferToAnotherSecUserWithEmail(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherEmail) throws Exception
 	{
	...
	protected void checkParamsForTransferingAnotherSecUserWithMobile(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherMobile) throws Exception
 	{
 	...
 	public WechatWorkappIdentity transferToAnotherSecUserWithMobile(ModelUserContext userContext, String wechatWorkappIdentityId, String anotherMobile) throws Exception
 	{
 ...
 //--------------------------------------------------------------
	...
	public WechatWorkappIdentity forgetByAll(ModelUserContext userContext, String wechatWorkappIdentityId, int wechatWorkappIdentityVersion) throws Exception {
		return forgetByAllInternal(userContext, wechatWorkappIdentityId, wechatWorkappIdentityVersion);
	}
	protected WechatWorkappIdentity forgetByAllInternal(ModelUserContext userContext,
  ...
  protected BusinessHandler getLoginProcessBizHandler(ModelUserContextImpl userContext) {
	...
	// -----------------------------------// list-of-view 处理 \\-----------------------------------
    protected void enhanceForListOfView(ModelUserContext userContext,SmartList<WechatWorkappIdentity> list) throws Exception {
    	if (list == null || list.isEmpty()){
    		return;
    	}
  ...
  // -----------------------------------\\ list-of-view 处理 //-----------------------------------v
	 ...
	 * @throws Exception
	 */
 	public Object wxappview(ModelUserContext userContext, String wechatWorkappIdentityId) throws Exception{
