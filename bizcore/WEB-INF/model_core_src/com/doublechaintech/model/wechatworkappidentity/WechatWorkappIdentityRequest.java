...
import static com.doublechaintech.model.wechatworkappidentity.WechatWorkappIdentity.*;
...
public class WechatWorkappIdentityRequest extends BaseRequest<WechatWorkappIdentity> {
    public static WechatWorkappIdentityRequest newInstance() {
        return new WechatWorkappIdentityRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public WechatWorkappIdentityRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public WechatWorkappIdentityRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,CORP_ID_PROPERTY,USER_ID_PROPERTY,SEC_USER_PROPERTY,CREATE_TIME_PROPERTY,LAST_LOGIN_TIME_PROPERTY,VERSION_PROPERTY};
   ...
   public WechatWorkappIdentityRequest count(){
    ...
    public WechatWorkappIdentityRequest whereCreateTimeIsNotNull() {
      ...
      public WechatWorkappIdentityRequest whereCreateTimeBetween(Date createTimeStart, Date createTimeEnd) {
    ...
    public WechatWorkappIdentityRequest whereLastLoginTimeIsNotNull() {
      ...
      public WechatWorkappIdentityRequest whereLastLoginTimeBetween(Date lastLoginTimeStart, Date lastLoginTimeEnd) {
