...
public void transferAllRelationshipsTo(UserApp target){
     ...
     target.addQuickLinkList(this.getQuickLinkList());target.addListAccessList(this.getListAccessList());
 }
  ...
  static{
    ...
    memberMetaInfoList.add(MemberMetaInfo.defineBy(SEC_USER_PROPERTY, "sec_user", "安全用户")
        .withType("sec_user", SecUser.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(APP_ICON_PROPERTY, "app_icon", "应用程序图标")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(FULL_ACCESS_PROPERTY, "full_access", "完全访问")
        .withType("bool", "boolean"));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(PERMISSION_PROPERTY, "permission", "许可")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(APP_TYPE_PROPERTY, "app_type", "应用程序类型")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(APP_ID_PROPERTY, "app_id", "应用程序Id")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(CTX_TYPE_PROPERTY, "ctx_type", "Ctx类型")
        .withType("string", String.class));
    memberMetaInfoList.add(MemberMetaInfo.defineBy(CTX_ID_PROPERTY, "ctx_id", "Ctx Id")
        .withType("string", String.class));
...
return getId();
	...
	public UserApp updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getTitle();
	...
	public UserApp updateTitle(String title){String oldTitle = this.title;String newTitle = trimString(title);if(!shouldReplaceBy(newTitle, oldTitle)){return this;}this.title = newTitle;if (cn.hutool.core.util.ObjectUtil.equals(newTitle, oldTitle)){
        return this;
      }addPropertyChange(TITLE_PROPERTY, oldTitle, newTitle);this.changed = true;setChecked(false);return this;}
...
return getSecUser();
	...
	public UserApp updateSecUser(SecUser secUser){SecUser oldSecUser = this.secUser;SecUser newSecUser = secUser;if(!shouldReplaceBy(newSecUser, oldSecUser)){return this;}this.secUser = newSecUser;if (cn.hutool.core.util.ObjectUtil.equals(newSecUser, oldSecUser)){
        return this;
      }addPropertyChange(SEC_USER_PROPERTY, oldSecUser, newSecUser);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeSecUser(SecUser secUser){
		if(secUser != null) { updateSecUser(secUser);}
	}

	
  public  UserApp updateSecUserByReferenceId(String secUserId){ updateSecUser(SecUser.refById(secUserId)); return this;}
...
return getAppIcon();
	...
	public UserApp updateAppIcon(String appIcon){String oldAppIcon = this.appIcon;String newAppIcon = trimString(appIcon);if(!shouldReplaceBy(newAppIcon, oldAppIcon)){return this;}this.appIcon = newAppIcon;if (cn.hutool.core.util.ObjectUtil.equals(newAppIcon, oldAppIcon)){
        return this;
      }addPropertyChange(APP_ICON_PROPERTY, oldAppIcon, newAppIcon);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeAppIcon(String appIcon){
		if(appIcon != null) { updateAppIcon(appIcon);}
	}
...
return getFullAccess();
	...
	public UserApp updateFullAccess(boolean fullAccess){boolean oldFullAccess = this.fullAccess;boolean newFullAccess = fullAccess;if(!shouldReplaceBy(newFullAccess, oldFullAccess)){return this;}this.fullAccess = newFullAccess;if (cn.hutool.core.util.ObjectUtil.equals(newFullAccess, oldFullAccess)){
        return this;
      }addPropertyChange(FULL_ACCESS_PROPERTY, oldFullAccess, newFullAccess);this.changed = true;setChecked(false);return this;}
...
return getPermission();
	...
	public UserApp updatePermission(String permission){String oldPermission = this.permission;String newPermission = trimString(permission);if(!shouldReplaceBy(newPermission, oldPermission)){return this;}this.permission = newPermission;if (cn.hutool.core.util.ObjectUtil.equals(newPermission, oldPermission)){
        return this;
      }addPropertyChange(PERMISSION_PROPERTY, oldPermission, newPermission);this.changed = true;setChecked(false);return this;}
...
return getAppType();
	...
	public UserApp updateAppType(String appType){String oldAppType = this.appType;String newAppType = trimString(appType);if(!shouldReplaceBy(newAppType, oldAppType)){return this;}this.appType = newAppType;if (cn.hutool.core.util.ObjectUtil.equals(newAppType, oldAppType)){
        return this;
      }addPropertyChange(APP_TYPE_PROPERTY, oldAppType, newAppType);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeAppType(String appType){
		if(appType != null) { updateAppType(appType);}
	}
...
return getAppId();
	...
	public UserApp updateAppId(String appId){String oldAppId = this.appId;String newAppId = trimString(appId);if(!shouldReplaceBy(newAppId, oldAppId)){return this;}this.appId = newAppId;if (cn.hutool.core.util.ObjectUtil.equals(newAppId, oldAppId)){
        return this;
      }addPropertyChange(APP_ID_PROPERTY, oldAppId, newAppId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeAppId(String appId){
		if(appId != null) { updateAppId(appId);}
	}
...
return getCtxType();
	...
	public UserApp updateCtxType(String ctxType){String oldCtxType = this.ctxType;String newCtxType = trimString(ctxType);if(!shouldReplaceBy(newCtxType, oldCtxType)){return this;}this.ctxType = newCtxType;if (cn.hutool.core.util.ObjectUtil.equals(newCtxType, oldCtxType)){
        return this;
      }addPropertyChange(CTX_TYPE_PROPERTY, oldCtxType, newCtxType);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeCtxType(String ctxType){
		if(ctxType != null) { updateCtxType(ctxType);}
	}
...
return getCtxId();
	...
	public UserApp updateCtxId(String ctxId){String oldCtxId = this.ctxId;String newCtxId = trimString(ctxId);if(!shouldReplaceBy(newCtxId, oldCtxId)){return this;}this.ctxId = newCtxId;if (cn.hutool.core.util.ObjectUtil.equals(newCtxId, oldCtxId)){
        return this;
      }addPropertyChange(CTX_ID_PROPERTY, oldCtxId, newCtxId);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeCtxId(String ctxId){
		if(ctxId != null) { updateCtxId(ctxId);}
	}
...
return getLocation();
	...
	public UserApp updateLocation(String location){String oldLocation = this.location;String newLocation = trimString(location);if(!shouldReplaceBy(newLocation, oldLocation)){return this;}this.location = newLocation;if (cn.hutool.core.util.ObjectUtil.equals(newLocation, oldLocation)){
        return this;
      }addPropertyChange(LOCATION_PROPERTY, oldLocation, newLocation);this.changed = true;setChecked(false);return this;}
...
return getVersion();
	...
	public UserApp updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
