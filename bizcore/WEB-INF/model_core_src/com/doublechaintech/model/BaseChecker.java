...
public class BaseChecker {
	...
	public void setUserContext(ModelUserContext ctx){
...
您输入的出生日期格式有误，该输入正确的的格式是像 2017-09-09的日期
    ...
    protected void checkBooleanRange(boolean valueToCheck, boolean pI, boolean pB, String pFullAccessOfUserApp) {
