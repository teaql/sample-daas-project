...
import static com.doublechaintech.model.slide.Slide.*;

public class SlideRequest extends BaseRequest<Slide> {
    public static SlideRequest newInstance() {
        return new SlideRequest().filterByVersion(QueryOperator.GREATER_THAN,0).selectId();
    }
    ...
    public SlideRequest addDynamicProperty(String propertyName, BaseRequest request, String parentPropertyName) {
    ...
    public SlideRequest selectAny() {return selectAll();
        }
    ...
    protected static final String[] ALL_SELF_FIELDS={ID_PROPERTY,NAME_PROPERTY,DISPLAY_ORDER_PROPERTY,IMAGE_URL_PROPERTY,VIDEO_URL_PROPERTY,LINK_TO_URL_PROPERTY,PAGE_PROPERTY,VERSION_PROPERTY};
