...
public interface SlideManager extends BaseManager {
  ...
  public Slide internalSaveSlide(
      ModelUserContext userContext, Slide slide, Map<String, Object> option) throws Exception;
  ...
  public default void onUpdated(
      ModelUserContext userContext, Slide updated, Object actor, String methodName)
      throws Exception {};
