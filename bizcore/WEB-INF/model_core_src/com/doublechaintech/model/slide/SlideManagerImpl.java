...
public class SlideManagerImpl extends CustomModelCheckerManager
  ...
  protected Slide saveSlide(ModelUserContext userContext, Slide slide, String[] tokensExpr)
      throws Exception {
  ...
  public Slide loadSlide(ModelUserContext userContext, String slideId, String[] tokensExpr)
      throws Exception {
  ...
  public Slide searchSlide(
      ModelUserContext userContext, String slideId, String textToSearch, String[] tokensExpr)
      throws Exception {
  ...
  protected Slide present(ModelUserContext userContext, Slide slide, Map<String, Object> tokens)
      throws Exception {
  ...
  protected Slide saveSlide(ModelUserContext userContext, Slide slide, Map<String, Object> tokens)
      throws Exception {
  ...
  protected Slide loadSlide(
      ModelUserContext userContext, String slideId, Map<String, Object> tokens) throws Exception {
    checkerOf(userContext).checkIdOfSlide(slideId);
  ...
  protected <T extends BaseEntity> void addActions(
      ModelUserContext userContext, Slide slide, Map<String, Object> tokens) {
    ...
    // Slide slide, Map<String, Object> tokens){
  ...
  public Slide internalSaveSlide(
      ModelUserContext userContext, Slide slide, Map<String, Object> options) throws Exception {
  ...
  protected void checkParamsForTransferingAnotherPage(
      ModelUserContext userContext, String slideId, String anotherPageId) throws Exception {
  ...
  public Slide forgetByAll(ModelUserContext userContext, String slideId, int slideVersion)
      throws Exception {
    return forgetByAllInternal(userContext, slideId, slideVersion);
  }

  protected Slide forgetByAllInternal(
      ModelUserContext userContext, String slideId, int slideVersion) throws Exception {
  ...
  public void onNewInstanceCreated(ModelUserContext userContext, Slide newCreated)
      throws Exception {
  ...
  // -----------------------------------// list-of-view 处理 \\-----------------------------------
  protected void enhanceForListOfView(ModelUserContext userContext, SmartList<Slide> list)
      throws Exception {
    if (list == null || list.isEmpty()) {
      return;
    }
