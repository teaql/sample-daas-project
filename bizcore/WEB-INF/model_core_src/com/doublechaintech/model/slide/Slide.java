...
return getId();
	...
	public Slide updateId(String id){String oldId = this.id;String newId = trimString(id);if(!shouldReplaceBy(newId, oldId)){return this;}this.id = newId;if (cn.hutool.core.util.ObjectUtil.equals(newId, oldId)){
        return this;
...
return getName();
	...
	public Slide updateName(String name){String oldName = this.name;String newName = trimString(name);if(!shouldReplaceBy(newName, oldName)){return this;}this.name = newName;if (cn.hutool.core.util.ObjectUtil.equals(newName, oldName)){
        return this;
...
return getDisplayOrder();
	...
	public Slide updateDisplayOrder(int displayOrder){int oldDisplayOrder = this.displayOrder;int newDisplayOrder = displayOrder;if(!shouldReplaceBy(newDisplayOrder, oldDisplayOrder)){return this;}this.displayOrder = newDisplayOrder;if (cn.hutool.core.util.ObjectUtil.equals(newDisplayOrder, oldDisplayOrder)){
        return this;
...
return getImageUrl();
	...
	public Slide updateImageUrl(String imageUrl){String oldImageUrl = this.imageUrl;String newImageUrl = trimString(encodeUrl(imageUrl));;if(!shouldReplaceBy(newImageUrl, oldImageUrl)){return this;}this.imageUrl = newImageUrl;if (cn.hutool.core.util.ObjectUtil.equals(newImageUrl, oldImageUrl)){
        return this;
...
return getVideoUrl();
	...
	public Slide updateVideoUrl(String videoUrl){String oldVideoUrl = this.videoUrl;String newVideoUrl = trimString(encodeUrl(videoUrl));;if(!shouldReplaceBy(newVideoUrl, oldVideoUrl)){return this;}this.videoUrl = newVideoUrl;if (cn.hutool.core.util.ObjectUtil.equals(newVideoUrl, oldVideoUrl)){
        return this;
      }addPropertyChange(VIDEO_URL_PROPERTY, oldVideoUrl, newVideoUrl);this.changed = true;setChecked(false);return this;}
...
return this;
	...
	public void mergeVideoUrl(String videoUrl){
		if(videoUrl != null) { updateVideoUrl(videoUrl);}
	}
...
return getLinkToUrl();
	...
	public Slide updateLinkToUrl(String linkToUrl){String oldLinkToUrl = this.linkToUrl;String newLinkToUrl = trimString(linkToUrl);if(!shouldReplaceBy(newLinkToUrl, oldLinkToUrl)){return this;}this.linkToUrl = newLinkToUrl;if (cn.hutool.core.util.ObjectUtil.equals(newLinkToUrl, oldLinkToUrl)){
        return this;
...
return getPage();
	...
	public Slide updatePage(Page page){Page oldPage = this.page;Page newPage = page;if(!shouldReplaceBy(newPage, oldPage)){return this;}this.page = newPage;if (cn.hutool.core.util.ObjectUtil.equals(newPage, oldPage)){
        return this;
...
return this;
  ...
  public  Slide updatePageByReferenceId(String pageId){ updatePage(Page.refById(pageId)); return this;}
...
return getVersion();
	...
	public Slide updateVersion(int version){int oldVersion = this.version;int newVersion = version;if(!shouldReplaceBy(newVersion, oldVersion)){return this;}this.version = newVersion;if (cn.hutool.core.util.ObjectUtil.equals(newVersion, oldVersion)){
        return this;
